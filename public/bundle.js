...
`,Cl=class extends le{constructor(){super(...arguments),this.hasStarted=!1,this.name="none",this.play=!1,this.delay=0,this.direction="normal",this.duration=1e3,this.easing="linear",this.endDelay=0,this.fill="auto",this.iterations=1/0,this.iterationStart=0,this.playbackRate=1,this.handleAnimationFinish=()=>{this.play=!1,this.hasStarted=!1,this.emit("sl-finish")},this.handleAnimationCancel=()=>{this.play=!1,this.hasStarted=!1,this.emit("sl-cancel")}}get currentTime(){var t,e;return null!=(e=null==(t=this.animation)?void 0:t.currentTime)?e:0}set currentTime(t){this.animation&&(this.animation.currentTime=t)}connectedCallback(){super.connectedCallback(),this.createAnimation()}disconnectedCallback(){super.disconnectedCallback(),this.destroyAnimation()}handleSlotChange(){this.destroyAnimation(),this.createAnimation()}async createAnimation(){var t,i;const s=null!=(t=xl[this.easing])?t:this.easing,o=null!=(i=this.keyframes)?i:e[this.name],r=(await this.defaultSlot).assignedElements()[0];return!(!r||!o||(this.destroyAnimation(),this.animation=r.animate(o,{delay:this.delay,direction:this.direction,duration:this.duration,easing:s,endDelay:this.endDelay,fill:this.fill,iterationStart:this.iterationStart,iterations:this.iterations}),this.animation.playbackRate=this.playbackRate,this.animation.addEventListener("cancel",this.handleAnimationCancel),this.animation.addEventListener("finish",this.handleAnimationFinish),this.play?(this.hasStarted=!0,this.emit("sl-start")):this.animation.pause(),0))}destroyAnimation(){this.animation&&(this.animation.cancel(),this.animation.removeEventListener("cancel",this.handleAnimationCancel),this.animation.removeEventListener("finish",this.handleAnimationFinish),this.hasStarted=!1)}handleAnimationChange(){this.hasUpdated&&this.createAnimation()}handlePlayChange(){return!!this.animation&&(this.play&&!this.hasStarted&&(this.hasStarted=!0,this.emit("sl-start")),this.play?this.animation.play():this.animation.pause(),!0)}handlePlaybackRateChange(){this.animation&&(this.animation.playbackRate=this.playbackRate)}cancel(){var t;null==(t=this.animation)||t.cancel()}finish(){var t;null==(t=this.animation)||t.finish()}render(){return gt` <slot @slotchange=${this.handleSlotChange}></slot> `}};Cl.styles=[Zt,kl],f([(t,e)=>re(t,e,{async get(){return await this.updateComplete,this.renderRoot?.querySelector("slot")??null}})],Cl.prototype,"defaultSlot",2),f([ie()],Cl.prototype,"name",2),f([ie({type:Boolean,reflect:!0})],Cl.prototype,"play",2),f([ie({type:Number})],Cl.prototype,"delay",2),f([ie()],Cl.prototype,"direction",2),f([ie({type:Number})],Cl.prototype,"duration",2),f([ie()],Cl.prototype,"easing",2),f([ie({attribute:"end-delay",type:Number})],Cl.prototype,"endDelay",2),f([ie()],Cl.prototype,"fill",2),f([ie({type:Number})],Cl.prototype,"iterations",2),f([ie({attribute:"iteration-start",type:Number})],Cl.prototype,"iterationStart",2),f([ie({attribute:!1})],Cl.prototype,"keyframes",2),f([ie({attribute:"playback-rate",type:Number})],Cl.prototype,"playbackRate",2),f([Xt(["name","delay","direction","duration","easing","endDelay","fill","iterations","iterationsStart","keyframes"])],Cl.prototype,"handleAnimationChange",1),f([Xt("play")],Cl.prototype,"handlePlayChange",1),f([Xt("playbackRate")],Cl.prototype,"handlePlaybackRateChange",1),Cl.define("sl-animation");const Sl=t=>t.replace(/-([a-z0-9])/g,(t,e)=>e.toUpperCase());function zl(t="",...e){const i=t.split(/([#.])/),s=i[0]||"div",o=document.createElement(s);for(let t=1;t<i.length;t+=2){const e=i[t],s=i[t+1];if(s)if("#"===e)o.id=s;else if("."===e)for(const t of s.split(/\s+/))t&&o.classList.add(t)}const r=document.createDocumentFragment();for(const t of e){if(t instanceof HTMLElement){r.appendChild(t);continue}if("string"==typeof t){const e=t.split("\n");for(let t=0;t<e.length;t++){t>0&&r.appendChild(document.createElement("br"));const i=e[t];i&&r.appendChild(document.createTextNode(i))}continue}if(!t)continue;const e=t;for(const t in e){if(!Object.prototype.hasOwnProperty.call(e,t))continue;const i=e[t];if(null!=i)if("style"!==t)if("dataset"!==t||"object"!=typeof i)if("id"!==t){if("class"===t||"className"===t){const t=String(i).split(/\s+/);for(const e of t)e&&o.classList.add(e);continue}if(t.startsWith("data-")){const e=Sl(t.slice(5));o.dataset[e]=String(i),o.setAttribute(t,String(i));continue}t.startsWith("aria-")?o.setAttribute(t,String(i)):t in o?o[t]=i:o.setAttribute(t,String(i))}else o.id=i;else for(const t in i){const e=i[t];null!=e&&(o.dataset[Sl(t)]=String(e))}else if("string"==typeof i){const t=i.trim();t&&(o.style.cssText.trim().length>0&&!t.startsWith(";")&&(o.style.cssText+=";"),o.style.cssText+=t)}else"object"==typeof i&&Object.assign(o.style,i)}}return o.appendChild(r),o}function $l(t){var e=t.width,i=t.height;if(e<0)throw new Error("Negative width is not allowed for Size");if(i<0)throw new Error("Negative height is not allowed for Size");return{width:e,height:i}}function El(t,e){return t.width===e.width&&t.height===e.height}var Ml=function(){function t(t){var e=this;this._resolutionListener=function(){return e._onResolutionChanged()},this._resolutionMediaQueryList=null,this._observers=[],this._window=t,this._installResolutionListener()}return t.prototype.dispose=function(){this._uninstallResolutionListener(),this._window=null},Object.defineProperty(t.prototype,"value",{get:function(){return this._window.devicePixelRatio},enumerable:!1,configurable:!0}),t.prototype.subscribe=function(t){var e=this,i={next:t};return this._observers.push(i),{unsubscribe:function(){e._observers=e._observers.filter(function(t){return t!==i})}}},t.prototype._installResolutionListener=function(){if(null!==this._resolutionMediaQueryList)throw new Error("Resolution listener is already installed");var t=this._window.devicePixelRatio;this._resolutionMediaQueryList=this._window.matchMedia("all and (resolution: ".concat(t,"dppx)")),this._resolutionMediaQueryList.addListener(this._resolutionListener)},t.prototype._uninstallResolutionListener=function(){null!==this._resolutionMediaQueryList&&(this._resolutionMediaQueryList.removeListener(this._resolutionListener),this._resolutionMediaQueryList=null)},t.prototype._reinstallResolutionListener=function(){this._uninstallResolutionListener(),this._installResolutionListener()},t.prototype._onResolutionChanged=function(){var t=this;this._observers.forEach(function(e){return e.next(t._window.devicePixelRatio)}),this._reinstallResolutionListener()},t}(),Pl=function(){function t(t,e,i){var s;this._canvasElement=null,this._bitmapSizeChangedListeners=[],this._suggestedBitmapSize=null,this._suggestedBitmapSizeChangedListeners=[],this._devicePixelRatioObservable=null,this._canvasElementResizeObserver=null,this._canvasElement=t,this._canvasElementClientSize=$l({width:this._canvasElement.clientWidth,height:this._canvasElement.clientHeight}),this._transformBitmapSize=null!=e?e:function(t){return t},this._allowResizeObserver=null===(s=null==i?void 0:i.allowResizeObserver)||void 0===s||s,this._chooseAndInitObserver()}return t.prototype.dispose=function(){var t,e;if(null===this._canvasElement)throw new Error("Object is disposed");null===(t=this._canvasElementResizeObserver)||void 0===t||t.disconnect(),this._canvasElementResizeObserver=null,null===(e=this._devicePixelRatioObservable)||void 0===e||e.dispose(),this._devicePixelRatioObservable=null,this._suggestedBitmapSizeChangedListeners.length=0,this._bitmapSizeChangedListeners.length=0,this._canvasElement=null},Object.defineProperty(t.prototype,"canvasElement",{get:function(){if(null===this._canvasElement)throw new Error("Object is disposed");return this._canvasElement},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"canvasElementClientSize",{get:function(){return this._canvasElementClientSize},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"bitmapSize",{get:function(){return $l({width:this.canvasElement.width,height:this.canvasElement.height})},enumerable:!1,configurable:!0}),t.prototype.resizeCanvasElement=function(t){this._canvasElementClientSize=$l(t),this.canvasElement.style.width="".concat(this._canvasElementClientSize.width,"px"),this.canvasElement.style.height="".concat(this._canvasElementClientSize.height,"px"),this._invalidateBitmapSize()},t.prototype.subscribeBitmapSizeChanged=function(t){this._bitmapSizeChangedListeners.push(t)},t.prototype.unsubscribeBitmapSizeChanged=function(t){this._bitmapSizeChangedListeners=this._bitmapSizeChangedListeners.filter(function(e){return e!==t})},Object.defineProperty(t.prototype,"suggestedBitmapSize",{get:function(){return this._suggestedBitmapSize},enumerable:!1,configurable:!0}),t.prototype.subscribeSuggestedBitmapSizeChanged=function(t){this._suggestedBitmapSizeChangedListeners.push(t)},t.prototype.unsubscribeSuggestedBitmapSizeChanged=function(t){this._suggestedBitmapSizeChangedListeners=this._suggestedBitmapSizeChangedListeners.filter(function(e){return e!==t})},t.prototype.applySuggestedBitmapSize=function(){if(null!==this._suggestedBitmapSize){var t=this._suggestedBitmapSize;this._suggestedBitmapSize=null,this._resizeBitmap(t),this._emitSuggestedBitmapSizeChanged(t,this._suggestedBitmapSize)}},t.prototype._resizeBitmap=function(t){var e=this.bitmapSize;El(e,t)||(this.canvasElement.width=t.width,this.canvasElement.height=t.height,this._emitBitmapSizeChanged(e,t))},t.prototype._emitBitmapSizeChanged=function(t,e){var i=this;this._bitmapSizeChangedListeners.forEach(function(s){return s.call(i,t,e)})},t.prototype._suggestNewBitmapSize=function(t){var e=this._suggestedBitmapSize,i=$l(this._transformBitmapSize(t,this._canvasElementClientSize)),s=El(this.bitmapSize,i)?null:i;null===e&&null===s||null!==e&&null!==s&&El(e,s)||(this._suggestedBitmapSize=s,this._emitSuggestedBitmapSizeChanged(e,s))},t.prototype._emitSuggestedBitmapSizeChanged=function(t,e){var i=this;this._suggestedBitmapSizeChangedListeners.forEach(function(s){return s.call(i,t,e)})},t.prototype._chooseAndInitObserver=function(){var t=this;this._allowResizeObserver?new Promise(function(t){var e=new ResizeObserver(function(i){t(i.every(function(t){return"devicePixelContentBoxSize"in t})),e.disconnect()});e.observe(document.body,{box:"device-pixel-content-box"})}).catch(function(){return!1}).then(function(e){return e?t._initResizeObserver():t._initDevicePixelRatioObservable()}):this._initDevicePixelRatioObservable()},t.prototype._initDevicePixelRatioObservable=function(){var t=this;if(null!==this._canvasElement){var e=Tl(this._canvasElement);if(null===e)throw new Error("No window is associated with the canvas");this._devicePixelRatioObservable=function(t){return new Ml(t)}(e),this._devicePixelRatioObservable.subscribe(function(){return t._invalidateBitmapSize()}),this._invalidateBitmapSize()}},t.prototype._invalidateBitmapSize=function(){var t,e;if(null!==this._canvasElement){var i=Tl(this._canvasElement);if(null!==i){var s=null!==(e=null===(t=this._devicePixelRatioObservable)||void 0===t?void 0:t.value)&&void 0!==e?e:i.devicePixelRatio,o=this._canvasElement.getClientRects(),r=void 0!==o[0]?function(t,e){return $l({width:Math.round(t.left*e+t.width*e)-Math.round(t.left*e),height:Math.round(t.top*e+t.height*e)-Math.round(t.top*e)})}(o[0],s):$l({width:this._canvasElementClientSize.width*s,height:this._canvasElementClientSize.height*s});this._suggestNewBitmapSize(r)}}},t.prototype._initResizeObserver=function(){var t=this;null!==this._canvasElement&&(this._canvasElementResizeObserver=new ResizeObserver(function(e){var i=e.find(function(e){return e.target===t._canvasElement});if(i&&i.devicePixelContentBoxSize&&i.devicePixelContentBoxSize[0]){var s=i.devicePixelContentBoxSize[0],o=$l({width:s.inlineSize,height:s.blockSize});t._suggestNewBitmapSize(o)}}),this._canvasElementResizeObserver.observe(this._canvasElement,{box:"device-pixel-content-box"}))},t}();function Tl(t){return t.ownerDocument.defaultView}var Al=function(){function t(t,e,i){if(0===e.width||0===e.height)throw new TypeError("Rendering target could only be created on a media with positive width and height");if(this._mediaSize=e,0===i.width||0===i.height)throw new TypeError("Rendering target could only be created using a bitmap with positive integer width and height");this._bitmapSize=i,this._context=t}return t.prototype.useMediaCoordinateSpace=function(t){try{return this._context.save(),this._context.setTransform(1,0,0,1,0,0),this._context.scale(this._horizontalPixelRatio,this._verticalPixelRatio),t({context:this._context,mediaSize:this._mediaSize})}finally{this._context.restore()}},t.prototype.useBitmapCoordinateSpace=function(t){try{return this._context.save(),this._context.setTransform(1,0,0,1,0,0),t({context:this._context,mediaSize:this._mediaSize,bitmapSize:this._bitmapSize,horizontalPixelRatio:this._horizontalPixelRatio,verticalPixelRatio:this._verticalPixelRatio})}finally{this._context.restore()}},Object.defineProperty(t.prototype,"_horizontalPixelRatio",{get:function(){return this._bitmapSize.width/this._mediaSize.width},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"_verticalPixelRatio",{get:function(){return this._bitmapSize.height/this._mediaSize.height},enumerable:!1,configurable:!0}),t}();function Ll(t,e){var i=t.canvasElementClientSize;if(0===i.width||0===i.height)return null;var s=t.bitmapSize;if(0===s.width||0===s.height)return null;var o=t.canvasElement.getContext("2d",e);return null===o?null:new Al(o,i,s)}const Dl={title:"",visible:!0,lastValueVisible:!0,priceLineVisible:!0,priceLineSource:0,priceLineWidth:1,priceLineColor:"",priceLineStyle:2,baseLineVisible:!0,baseLineWidth:1,baseLineColor:"#B2B5BE",baseLineStyle:0,priceFormat:{type:"price",precision:2,minMove:.01}};var Ol,Il;function Vl(t,e){const i={0:[],1:[t.lineWidth,t.lineWidth],2:[2*t.lineWidth,2*t.lineWidth],3:[6*t.lineWidth,6*t.lineWidth],4:[t.lineWidth,4*t.lineWidth]}[e];t.setLineDash(i)}function Fl(t,e,i,s){t.beginPath();const o=t.lineWidth%2?.5:0;t.moveTo(i,e+o),t.lineTo(s,e+o),t.stroke()}function Rl(t,e){if(!t)throw new Error("Assertion failed"+(e?": "+e:""))}function Nl(t){if(void 0===t)throw new Error("Value is undefined");return t}function Bl(t){if(null===t)throw new Error("Value is null");return t}function Hl(t){return Bl(Nl(t))}!function(t){t[t.Simple=0]="Simple",t[t.WithSteps=1]="WithSteps",t[t.Curved=2]="Curved"}(Ol||(Ol={})),function(t){t[t.Solid=0]="Solid",t[t.Dotted=1]="Dotted",t[t.Dashed=2]="Dashed",t[t.LargeDashed=3]="LargeDashed",t[t.SparseDotted=4]="SparseDotted"}(Il||(Il={}));class Ul{constructor(){this.t=[]}i(t,e,i){const s={h:t,l:e,o:!0===i};this.t.push(s)}_(t){const e=this.t.findIndex(e=>t===e.h);e>-1&&this.t.splice(e,1)}u(t){this.t=this.t.filter(e=>e.l!==t)}p(t,e,i){const s=[...this.t];this.t=this.t.filter(t=>!t.o),s.forEach(s=>s.h(t,e,i))}v(){return this.t.length>0}m(){this.t=[]}}function Wl(t,...e){for(const i of e)for(const e in i)void 0!==i[e]&&Object.prototype.hasOwnProperty.call(i,e)&&!["__proto__","constructor","prototype"].includes(e)&&("object"!=typeof i[e]||void 0===t[e]||Array.isArray(i[e])?t[e]=i[e]:Wl(t[e],i[e]));return t}function Yl(t){return"number"==typeof t&&isFinite(t)}function ql(t){return"number"==typeof t&&t%1==0}function jl(t){return"string"==typeof t}function Gl(t){return"boolean"==typeof t}function Kl(t){const e=t;if(!e||"object"!=typeof e)return e;let i,s,o;for(s in i=Array.isArray(e)?[]:{},e)e.hasOwnProperty(s)&&(o=e[s],i[s]=o&&"object"==typeof o?Kl(o):o);return i}function Ql(t){return null!==t}function Jl(t){return null===t?void 0:t}const Xl="-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif";function Zl(t,e,i){return void 0===e&&(e=Xl),`${i=void 0!==i?`${i} `:""}${t}px ${e}`}class th{constructor(t){this.M={S:1,C:5,P:NaN,k:"",T:"",R:"",D:"",V:0,B:0,I:0,A:0,L:0},this.O=t}N(){const t=this.M,e=this.F(),i=this.W();return t.P===e&&t.T===i||(t.P=e,t.T=i,t.k=Zl(e,i),t.A=2.5/12*e,t.V=t.A,t.B=e/12*t.C,t.I=e/12*t.C,t.L=0),t.R=this.H(),t.D=this.U(),this.M}H(){return this.O.N().layout.textColor}U(){return this.O.$()}F(){return this.O.N().layout.fontSize}W(){return this.O.N().layout.fontFamily}}function eh(t){return t<0?0:t>255?255:Math.round(t)||0}function ih(t){return.199*t[0]+.687*t[1]+.114*t[2]}class sh{constructor(t,e){this.q=new Map,this.Y=t,e&&(this.q=e)}j(t,e){if("transparent"===t)return t;const i=this.K(t),s=i[3];return`rgba(${i[0]}, ${i[1]}, ${i[2]}, ${e*s})`}X(t){const e=this.K(t);return{Z:`rgb(${e[0]}, ${e[1]}, ${e[2]})`,G:ih(e)>160?"black":"white"}}J(t){return ih(this.K(t))}tt(t,e,i){const[s,o,r,n]=this.K(t),[a,l,h,c]=this.K(e),d=[eh(s+i*(a-s)),eh(o+i*(l-o)),eh(r+i*(h-r)),(u=n+i*(c-n),u<=0||u>1?Math.min(Math.max(u,0),1):Math.round(1e4*u)/1e4)];var u;return`rgba(${d[0]}, ${d[1]}, ${d[2]}, ${d[3]})`}K(t){const e=this.q.get(t);if(e)return e;const i=function(t){const e=document.createElement("div");e.style.display="none",document.body.appendChild(e),e.style.color=t;const i=window.getComputedStyle(e).color;return document.body.removeChild(e),i}(t),s=i.match(/^rgba?\s*\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d*\.?\d+))?\)$/);if(!s){if(this.Y.length)for(const e of this.Y){const i=e(t);if(i)return this.q.set(t,i),i}throw new Error(`Failed to parse color: ${t}`)}const o=[parseInt(s[1],10),parseInt(s[2],10),parseInt(s[3],10),s[4]?parseFloat(s[4]):1];return this.q.set(t,o),o}}class oh{constructor(){this.it=[]}st(t){this.it=t}nt(t,e,i){this.it.forEach(s=>{s.nt(t,e,i)})}}class rh{nt(t,e,i){t.useBitmapCoordinateSpace(t=>this.et(t,e,i))}}class nh extends rh{constructor(){super(...arguments),this.rt=null}ht(t){this.rt=t}et({context:t,horizontalPixelRatio:e,verticalPixelRatio:i}){if(null===this.rt||null===this.rt.lt)return;const s=this.rt.lt,o=this.rt,r=Math.max(1,Math.floor(e))%2/2,n=n=>{t.beginPath();for(let a=s.to-1;a>=s.from;--a){const s=o.ot[a],l=Math.round(s._t*e)+r,h=s.ut*i,c=n*i+r;t.moveTo(l,h),t.arc(l,h,c,0,2*Math.PI)}t.fill()};o.ct>0&&(t.fillStyle=o.dt,n(o.ft+o.ct)),t.fillStyle=o.vt,n(o.ft)}}function ah(){return{ot:[{_t:0,ut:0,wt:0,gt:0}],vt:"",dt:"",ft:0,ct:0,lt:null}}const lh={from:0,to:1};class hh{constructor(t,e,i){this.Mt=new oh,this.bt=[],this.St=[],this.xt=!0,this.O=t,this.Ct=e,this.Pt=i,this.Mt.st(this.bt)}yt(t){this.kt(),this.xt=!0}Tt(){return this.xt&&(this.Rt(),this.xt=!1),this.Mt}kt(){const t=this.Pt.Dt();t.length!==this.bt.length&&(this.St=t.map(ah),this.bt=this.St.map(t=>{const e=new nh;return e.ht(t),e}),this.Mt.st(this.bt))}Rt(){const t=2===this.Ct.N().mode||!this.Ct.Vt(),e=this.Pt.Bt(),i=this.Ct.It(),s=this.O.Et();this.kt(),e.forEach((e,o)=>{const r=this.St[o],n=e.At(i),a=e.zt();!t&&null!==n&&e.Vt()&&null!==a?(r.vt=n.Lt,r.ft=n.ft,r.ct=n.Ot,r.ot[0].gt=n.gt,r.ot[0].ut=e.Ft().Nt(n.gt,a.Wt),r.dt=n.Ht??this.O.Ut(r.ot[0].ut/e.Ft().$t()),r.ot[0].wt=i,r.ot[0]._t=s.qt(i),r.lt=lh):r.lt=null})}}class ch extends rh{constructor(t){super(),this.Yt=t}et({context:t,bitmapSize:e,horizontalPixelRatio:i,verticalPixelRatio:s}){if(null===this.Yt)return;const o=this.Yt.jt.Vt,r=this.Yt.Kt.Vt;if(!o&&!r)return;const n=Math.round(this.Yt._t*i),a=Math.round(this.Yt.ut*s);t.lineCap="butt",o&&n>=0&&(t.lineWidth=Math.floor(this.Yt.jt.ct*i),t.strokeStyle=this.Yt.jt.R,t.fillStyle=this.Yt.jt.R,Vl(t,this.Yt.jt.Xt),function(t,e,i,s){t.beginPath();const o=t.lineWidth%2?.5:0;t.moveTo(e+o,0),t.lineTo(e+o,s),t.stroke()}(t,n,0,e.height)),r&&a>=0&&(t.lineWidth=Math.floor(this.Yt.Kt.ct*s),t.strokeStyle=this.Yt.Kt.R,t.fillStyle=this.Yt.Kt.R,Vl(t,this.Yt.Kt.Xt),Fl(t,a,0,e.width))}}class dh{constructor(t,e){this.xt=!0,this.Zt={jt:{ct:1,Xt:0,R:"",Vt:!1},Kt:{ct:1,Xt:0,R:"",Vt:!1},_t:0,ut:0},this.Gt=new ch(this.Zt),this.Jt=t,this.Pt=e}yt(){this.xt=!0}Tt(t){return this.xt&&(this.Rt(),this.xt=!1),this.Gt}Rt(){const t=this.Jt.Vt(),e=this.Pt.Qt().N().crosshair,i=this.Zt;if(2===e.mode)return i.Kt.Vt=!1,void(i.jt.Vt=!1);i.Kt.Vt=t&&this.Jt.ti(this.Pt),i.jt.Vt=t&&this.Jt.ii(),i.Kt.ct=e.horzLine.width,i.Kt.Xt=e.horzLine.style,i.Kt.R=e.horzLine.color,i.jt.ct=e.vertLine.width,i.jt.Xt=e.vertLine.style,i.jt.R=e.vertLine.color,i._t=this.Jt.si(),i.ut=this.Jt.ni()}}function uh(t,e,i,s,o,r){t.save(),t.globalCompositeOperation="copy",t.fillStyle=r,t.fillRect(e,i,s,o),t.restore()}function ph(t,e,i,s,o,r){t.beginPath(),t.roundRect?t.roundRect(e,i,s,o,r):(t.lineTo(e+s-r[1],i),0!==r[1]&&t.arcTo(e+s,i,e+s,i+r[1],r[1]),t.lineTo(e+s,i+o-r[2]),0!==r[2]&&t.arcTo(e+s,i+o,e+s-r[2],i+o,r[2]),t.lineTo(e+r[3],i+o),0!==r[3]&&t.arcTo(e,i+o,e,i+o-r[3],r[3]),t.lineTo(e,i+r[0]),0!==r[0]&&t.arcTo(e,i,e+r[0],i,r[0]))}function fh(t,e,i,s,o,r,n=0,a=[0,0,0,0],l=""){if(t.save(),!n||!l||l===r)return ph(t,e,i,s,o,a),t.fillStyle=r,t.fill(),void t.restore();const h=n/2;var c;ph(t,e+h,i+h,s-n,o-n,(c=-h,a.map(t=>0===t?t:t+c))),"transparent"!==r&&(t.fillStyle=r,t.fill()),"transparent"!==l&&(t.lineWidth=n,t.strokeStyle=l,t.closePath(),t.stroke()),t.restore()}function mh(t,e,i,s,o,r,n){t.save(),t.globalCompositeOperation="copy";const a=t.createLinearGradient(0,0,0,o);a.addColorStop(0,r),a.addColorStop(1,n),t.fillStyle=a,t.fillRect(e,i,s,o),t.restore()}class gh{constructor(t,e){this.ht(t,e)}ht(t,e){this.Yt=t,this.ei=e}$t(t,e){return this.Yt.Vt?t.P+t.A+t.V:0}nt(t,e,i,s){if(!this.Yt.Vt||0===this.Yt.ri.length)return;const o=this.Yt.R,r=this.ei.Z,n=t.useBitmapCoordinateSpace(t=>{const n=t.context;n.font=e.k;const a=this.hi(t,e,i,s),l=a.ai;return a.li?fh(n,l.oi,l._i,l.ui,l.ci,r,l.di,[l.ft,0,0,l.ft],r):fh(n,l.fi,l._i,l.ui,l.ci,r,l.di,[0,l.ft,l.ft,0],r),this.Yt.pi&&(n.fillStyle=o,n.fillRect(l.fi,l.mi,l.wi-l.fi,l.gi)),this.Yt.Mi&&(n.fillStyle=e.D,n.fillRect(a.li?l.bi-l.di:0,l._i,l.di,l.Si-l._i)),a});t.useMediaCoordinateSpace(({context:t})=>{const i=n.xi;t.font=e.k,t.textAlign=n.li?"right":"left",t.textBaseline="middle",t.fillStyle=o,t.fillText(this.Yt.ri,i.Ci,(i._i+i.Si)/2+i.Pi)})}hi(t,e,i,s){const{context:o,bitmapSize:r,mediaSize:n,horizontalPixelRatio:a,verticalPixelRatio:l}=t,h=this.Yt.pi||!this.Yt.yi?e.C:0,c=this.Yt.ki?e.S:0,d=e.A+this.ei.Ti,u=e.V+this.ei.Ri,p=e.B,f=e.I,m=this.Yt.ri,g=e.P,b=i.Di(o,m),v=Math.ceil(i.Vi(o,m)),y=g+d+u,w=e.S+p+f+v+h,_=Math.max(1,Math.floor(l));let x=Math.round(y*l);x%2!=_%2&&(x+=1);const k=c>0?Math.max(1,Math.floor(c*a)):0,C=Math.round(w*a),S=Math.round(h*a),z=this.ei.Bi??this.ei.Ii,$=Math.round(z*l)-Math.floor(.5*l),E=Math.floor($+_/2-x/2),M=E+x,P="right"===s,T=P?n.width-c:c,A=P?r.width-k:k;let L,D,O;return P?(L=A-C,D=A-S,O=T-h-p-c):(L=A+C,D=A+S,O=T+h+p),{li:P,ai:{_i:E,mi:$,Si:M,ui:C,ci:x,ft:2*a,di:k,oi:L,fi:A,wi:D,gi:_,bi:r.width},xi:{_i:E/l,Si:M/l,Ci:O,Pi:b}}}}class bh{constructor(t){this.Ei={Ii:0,Z:"#000",Ri:0,Ti:0},this.Ai={ri:"",Vt:!1,pi:!0,yi:!1,Ht:"",R:"#FFF",Mi:!1,ki:!1},this.zi={ri:"",Vt:!1,pi:!1,yi:!0,Ht:"",R:"#FFF",Mi:!0,ki:!0},this.xt=!0,this.Li=new(t||gh)(this.Ai,this.Ei),this.Oi=new(t||gh)(this.zi,this.Ei)}ri(){return this.Ni(),this.Ai.ri}Ii(){return this.Ni(),this.Ei.Ii}yt(){this.xt=!0}$t(t,e=!1){return Math.max(this.Li.$t(t,e),this.Oi.$t(t,e))}Fi(){return this.Ei.Bi||0}Wi(t){this.Ei.Bi=t}Hi(){return this.Ni(),this.Ai.Vt||this.zi.Vt}Ui(){return this.Ni(),this.Ai.Vt}Tt(t){return this.Ni(),this.Ai.pi=this.Ai.pi&&t.N().ticksVisible,this.zi.pi=this.zi.pi&&t.N().ticksVisible,this.Li.ht(this.Ai,this.Ei),this.Oi.ht(this.zi,this.Ei),this.Li}$i(){return this.Ni(),this.Li.ht(this.Ai,this.Ei),this.Oi.ht(this.zi,this.Ei),this.Oi}Ni(){this.xt&&(this.Ai.pi=!0,this.zi.pi=!1,this.qi(this.Ai,this.zi,this.Ei))}}class vh extends bh{constructor(t,e,i){super(),this.Jt=t,this.Yi=e,this.ji=i}qi(t,e,i){if(t.Vt=!1,2===this.Jt.N().mode)return;const s=this.Jt.N().horzLine;if(!s.labelVisible)return;const o=this.Yi.zt();if(!this.Jt.Vt()||this.Yi.Ki()||null===o)return;const r=this.Yi.Xi().X(s.labelBackgroundColor);i.Z=r.Z,t.R=r.G;const n=2/12*this.Yi.P();i.Ti=n,i.Ri=n;const a=this.ji(this.Yi);i.Ii=a.Ii,t.ri=this.Yi.Zi(a.gt,o),t.Vt=!0}}const yh=/[1-9]/g;class wh{constructor(){this.Yt=null}ht(t){this.Yt=t}nt(t,e){if(null===this.Yt||!1===this.Yt.Vt||0===this.Yt.ri.length)return;const i=t.useMediaCoordinateSpace(({context:t})=>(t.font=e.k,Math.round(e.Gi.Vi(t,Bl(this.Yt).ri,yh))));if(i<=0)return;const s=e.Ji,o=i+2*s,r=o/2,n=this.Yt.Qi;let a=this.Yt.Ii,l=Math.floor(a-r)+.5;l<0?(a+=Math.abs(0-l),l=Math.floor(a-r)+.5):l+o>n&&(a-=Math.abs(n-(l+o)),l=Math.floor(a-r)+.5);const h=l+o,c=Math.ceil(0+e.S+e.C+e.A+e.P+e.V);t.useBitmapCoordinateSpace(({context:t,horizontalPixelRatio:i,verticalPixelRatio:s})=>{const o=Bl(this.Yt);t.fillStyle=o.Z;const r=Math.round(l*i),n=Math.round(0*s),a=Math.round(h*i),d=Math.round(c*s),u=Math.round(2*i);if(t.beginPath(),t.moveTo(r,n),t.lineTo(r,d-u),t.arcTo(r,d,r+u,d,u),t.lineTo(a-u,d),t.arcTo(a,d,a,d-u,u),t.lineTo(a,n),t.fill(),o.pi){const r=Math.round(o.Ii*i),a=n,l=Math.round((a+e.C)*s);t.fillStyle=o.R;const h=Math.max(1,Math.floor(i)),c=Math.floor(.5*i);t.fillRect(r-c,a,h,l-a)}}),t.useMediaCoordinateSpace(({context:t})=>{const i=Bl(this.Yt),o=0+e.S+e.C+e.A+e.P/2;t.font=e.k,t.textAlign="left",t.textBaseline="middle",t.fillStyle=i.R;const r=e.Gi.Di(t,"Apr0");t.translate(l+s,o+r),t.fillText(i.ri,0,0)})}}class _h{constructor(t,e,i){this.xt=!0,this.Gt=new wh,this.Zt={Vt:!1,Z:"#4c525e",R:"white",ri:"",Qi:0,Ii:NaN,pi:!0},this.Ct=t,this.ts=e,this.ji=i}yt(){this.xt=!0}Tt(){return this.xt&&(this.Rt(),this.xt=!1),this.Gt.ht(this.Zt),this.Gt}Rt(){const t=this.Zt;if(t.Vt=!1,2===this.Ct.N().mode)return;const e=this.Ct.N().vertLine;if(!e.labelVisible)return;const i=this.ts.Et();if(i.Ki())return;t.Qi=i.Qi();const s=this.ji();if(null===s)return;t.Ii=s.Ii;const o=i.ss(this.Ct.It());t.ri=i.ns(Bl(o)),t.Vt=!0;const r=this.ts.Xi().X(e.labelBackgroundColor);t.Z=r.Z,t.R=r.G,t.pi=i.N().ticksVisible}}class xh{constructor(){this.es=null,this.rs=0}hs(){return this.rs}ls(t){this.rs=t}Ft(){return this.es}_s(t){this.es=t}us(t){return[]}cs(){return[]}Vt(){return!0}}var kh;!function(t){t[t.Normal=0]="Normal",t[t.Magnet=1]="Magnet",t[t.Hidden=2]="Hidden",t[t.MagnetOHLC=3]="MagnetOHLC"}(kh||(kh={}));class Ch extends xh{constructor(t,e){super(),this.Pt=null,this.ds=NaN,this.fs=0,this.ps=!1,this.vs=new Map,this.ws=!1,this.gs=new WeakMap,this.Ms=new WeakMap,this.bs=NaN,this.Ss=NaN,this.xs=NaN,this.Cs=NaN,this.ts=t,this.Ps=e,this.ys=((t,e)=>i=>{const s=e(),o=t();if(i===Bl(this.Pt).ks())return{gt:o,Ii:s};{const t=Bl(i.zt());return{gt:i.Ts(s,t),Ii:s}}})(()=>this.ds,()=>this.Ss);const i=((t,e)=>()=>{const i=this.ts.Et().Rs(t()),s=e();return i&&Number.isFinite(s)?{wt:i,Ii:s}:null})(()=>this.fs,()=>this.si());this.Ds=new _h(this,t,i)}N(){return this.Ps}Vs(t,e){this.xs=t,this.Cs=e}Bs(){this.xs=NaN,this.Cs=NaN}Is(){return this.xs}Es(){return this.Cs}As(t,e,i){this.ws||(this.ws=!0),this.ps=!0,this.zs(t,e,i)}It(){return this.fs}si(){return this.bs}ni(){return this.Ss}Vt(){return this.ps}Ls(){this.ps=!1,this.Os(),this.ds=NaN,this.bs=NaN,this.Ss=NaN,this.Pt=null,this.Bs(),this.Ns()}Fs(t){let e=this.gs.get(t);e||(e=new dh(this,t),this.gs.set(t,e));let i=this.Ms.get(t);return i||(i=new hh(this.ts,this,t),this.Ms.set(t,i)),[e,i]}ti(t){return t===this.Pt&&this.Ps.horzLine.visible}ii(){return this.Ps.vertLine.visible}Ws(t,e){this.ps&&this.Pt===t||this.vs.clear();const i=[];return this.Pt===t&&i.push(this.Hs(this.vs,e,this.ys)),i}cs(){return this.ps?[this.Ds]:[]}Us(){return this.Pt}Ns(){this.ts.$s().forEach(t=>{this.gs.get(t)?.yt(),this.Ms.get(t)?.yt()}),this.vs.forEach(t=>t.yt()),this.Ds.yt()}qs(t){return t&&!t.ks().Ki()?t.ks():null}zs(t,e,i){this.Ys(t,e,i)&&this.Ns()}Ys(t,e,i){const s=this.bs,o=this.Ss,r=this.ds,n=this.fs,a=this.Pt,l=this.qs(i);this.fs=t,this.bs=isNaN(t)?NaN:this.ts.Et().qt(t),this.Pt=i;const h=null!==l?l.zt():null;return null!==l&&null!==h?(this.ds=e,this.Ss=l.Nt(e,h)):(this.ds=NaN,this.Ss=NaN),s!==this.bs||o!==this.Ss||n!==this.fs||r!==this.ds||a!==this.Pt}Os(){const t=this.ts.js().map(t=>t.Xs().Ks()).filter(Ql),e=0===t.length?null:Math.max(...t);this.fs=null!==e?e:NaN}Hs(t,e,i){let s=t.get(e);return void 0===s&&(s=new vh(this,e,i),t.set(e,s)),s}}function Sh(t){return"left"===t||"right"===t}class zh{constructor(t){this.Zs=new Map,this.Gs=[],this.Js=t}Qs(t,e){const i=function(t,e){return void 0===t?e:{tn:Math.max(t.tn,e.tn),sn:t.sn||e.sn}}(this.Zs.get(t),e);this.Zs.set(t,i)}nn(){return this.Js}en(t){const e=this.Zs.get(t);return void 0===e?{tn:this.Js}:{tn:Math.max(this.Js,e.tn),sn:e.sn}}rn(){this.hn(),this.Gs=[{an:0}]}ln(t){this.hn(),this.Gs=[{an:1,Wt:t}]}_n(t){this.un(),this.Gs.push({an:5,Wt:t})}hn(){this.un(),this.Gs.push({an:6})}cn(){this.hn(),this.Gs=[{an:4}]}dn(t){this.hn(),this.Gs.push({an:2,Wt:t})}fn(t){this.hn(),this.Gs.push({an:3,Wt:t})}pn(){return this.Gs}vn(t){for(const e of t.Gs)this.mn(e);this.Js=Math.max(this.Js,t.Js),t.Zs.forEach((t,e)=>{this.Qs(e,t)})}static wn(){return new zh(2)}static gn(){return new zh(3)}mn(t){switch(t.an){case 0:this.rn();break;case 1:this.ln(t.Wt);break;case 2:this.dn(t.Wt);break;case 3:this.fn(t.Wt);break;case 4:this.cn();break;case 5:this._n(t.Wt);break;case 6:this.un()}}un(){const t=this.Gs.findIndex(t=>5===t.an);-1!==t&&this.Gs.splice(t,1)}}class $h{formatTickmarks(t){return t.map(t=>this.format(t))}}function Eh(t,e){if(!Yl(t))return"n/a";if(!ql(e))throw new TypeError("invalid length");if(e<0||e>16)throw new TypeError("invalid length");return 0===e?t.toString():("0000000000000000"+t.toString()).slice(-e)}class Mh extends $h{constructor(t,e){if(super(),e||(e=1),Yl(t)&&ql(t)||(t=100),t<0)throw new TypeError("invalid base");this.Yi=t,this.Mn=e,this.bn()}format(t){const e=t<0?"−":"";return t=Math.abs(t),e+this.Sn(t)}bn(){if(this.xn=0,this.Yi>0&&this.Mn>0){let t=this.Yi;for(;t>1;)t/=10,this.xn++}}Sn(t){const e=this.Yi/this.Mn;let i=Math.floor(t),s="";const o=void 0!==this.xn?this.xn:NaN;if(e>1){let r=+(Math.round(t*e)-i*e).toFixed(this.xn);r>=e&&(r-=e,i+=1),s="."+Eh(+r.toFixed(this.xn)*this.Mn,o)}else i=Math.round(i*e)/e,o>0&&(s="."+Eh(0,o));return i.toFixed(0)+s}}class Ph extends Mh{constructor(t=100){super(t)}format(t){return`${super.format(t)}%`}}class Th extends $h{constructor(t){super(),this.Cn=t}format(t){let e="";return t<0&&(e="-",t=-t),t<995?e+this.Pn(t):t<999995?e+this.Pn(t/1e3)+"K":t<999999995?(t=1e3*Math.round(t/1e3),e+this.Pn(t/1e6)+"M"):(t=1e6*Math.round(t/1e6),e+this.Pn(t/1e9)+"B")}Pn(t){let e;const i=Math.pow(10,this.Cn);return e=(t=Math.round(t*i)/i)>=1e-15&&t<1?t.toFixed(this.Cn).replace(/\.?0+$/,""):String(t),e.replace(/(\.[1-9]*)0+$/,(t,e)=>e)}}const Ah=/[2-9]/g;class Lh{constructor(t=50){this.yn=0,this.kn=1,this.Tn=1,this.Rn={},this.Dn=new Map,this.Vn=t}Bn(){this.yn=0,this.Dn.clear(),this.kn=1,this.Tn=1,this.Rn={}}Vi(t,e,i){return this.In(t,e,i).width}Di(t,e,i){const s=this.In(t,e,i);return((s.actualBoundingBoxAscent||0)-(s.actualBoundingBoxDescent||0))/2}In(t,e,i){const s=i||Ah,o=String(e).replace(s,"0");if(this.Dn.has(o))return Nl(this.Dn.get(o)).En;if(this.yn===this.Vn){const t=this.Rn[this.Tn];delete this.Rn[this.Tn],this.Dn.delete(t),this.Tn++,this.yn--}t.save(),t.textBaseline="middle";const r=t.measureText(o);return t.restore(),0===r.width&&e.length||(this.Dn.set(o,{En:r,An:this.kn}),this.Rn[this.kn]=o,this.yn++,this.kn++),r}}class Dh{constructor(t){this.zn=null,this.M=null,this.Ln="right",this.On=t}Nn(t,e,i){this.zn=t,this.M=e,this.Ln=i}nt(t){null!==this.M&&null!==this.zn&&this.zn.nt(t,this.M,this.On,this.Ln)}}class Oh{constructor(t,e,i){this.Fn=t,this.On=new Lh(50),this.Wn=e,this.O=i,this.F=-1,this.Gt=new Dh(this.On)}Tt(){const t=this.O.Hn(this.Wn);if(null===t)return null;const e=t.Un(this.Wn)?t.$n():this.Wn.Ft();if(null===e)return null;const i=t.qn(e);if("overlay"===i)return null;const s=this.O.Yn();return s.P!==this.F&&(this.F=s.P,this.On.Bn()),this.Gt.Nn(this.Fn.$i(),s,i),this.Gt}}class Ih extends rh{constructor(){super(...arguments),this.Yt=null}ht(t){this.Yt=t}jn(t,e){if(!this.Yt?.Vt)return null;const{ut:i,ct:s,Kn:o}=this.Yt;return e>=i-s-7&&e<=i+s+7?{Xn:this.Yt,Kn:o}:null}et({context:t,bitmapSize:e,horizontalPixelRatio:i,verticalPixelRatio:s}){if(null===this.Yt)return;if(!1===this.Yt.Vt)return;const o=Math.round(this.Yt.ut*s);o<0||o>e.height||(t.lineCap="butt",t.strokeStyle=this.Yt.R,t.lineWidth=Math.floor(this.Yt.ct*i),Vl(t,this.Yt.Xt),Fl(t,o,0,e.width))}}class Vh{constructor(t){this.Zn={ut:0,R:"rgba(0, 0, 0, 0)",ct:1,Xt:0,Vt:!1},this.Gn=new Ih,this.xt=!0,this.Jn=t,this.Qn=t.Qt(),this.Gn.ht(this.Zn)}yt(){this.xt=!0}Tt(){return this.Jn.Vt()?(this.xt&&(this.te(),this.xt=!1),this.Gn):null}}class Fh extends Vh{constructor(t){super(t)}te(){this.Zn.Vt=!1;const t=this.Jn.Ft(),e=t.ie().ie;if(2!==e&&3!==e)return;const i=this.Jn.N();if(!i.baseLineVisible||!this.Jn.Vt())return;const s=this.Jn.zt();null!==s&&(this.Zn.Vt=!0,this.Zn.ut=t.Nt(s.Wt,s.Wt),this.Zn.R=i.baseLineColor,this.Zn.ct=i.baseLineWidth,this.Zn.Xt=i.baseLineStyle)}}class Rh extends rh{constructor(){super(...arguments),this.Yt=null}ht(t){this.Yt=t}se(){return this.Yt}et({context:t,horizontalPixelRatio:e,verticalPixelRatio:i}){const s=this.Yt;if(null===s)return;const o=Math.max(1,Math.floor(e)),r=o%2/2,n=Math.round(s.ne.x*e)+r,a=s.ne.y*i;t.fillStyle=s.ee,t.beginPath();const l=Math.max(2,1.5*s.re)*e;t.arc(n,a,l,0,2*Math.PI,!1),t.fill(),t.fillStyle=s.he,t.beginPath(),t.arc(n,a,s.ft*e,0,2*Math.PI,!1),t.fill(),t.lineWidth=o,t.strokeStyle=s.ae,t.beginPath(),t.arc(n,a,s.ft*e+o/2,0,2*Math.PI,!1),t.stroke()}}const Nh=[{le:0,oe:.25,_e:4,ue:10,ce:.25,de:0,fe:.4,pe:.8},{le:.25,oe:.525,_e:10,ue:14,ce:0,de:0,fe:.8,pe:0},{le:.525,oe:1,_e:14,ue:14,ce:0,de:0,fe:0,pe:0}];class Bh{constructor(t){this.Gt=new Rh,this.xt=!0,this.ve=!0,this.me=performance.now(),this.we=this.me-1,this.ge=t}Me(){this.we=this.me-1,this.yt()}be(){if(this.yt(),2===this.ge.N().lastPriceAnimation){const t=performance.now(),e=this.we-t;if(e>0)return void(e<650&&(this.we+=2600));this.me=t,this.we=t+2600}}yt(){this.xt=!0}Se(){this.ve=!0}Vt(){return 0!==this.ge.N().lastPriceAnimation}xe(){switch(this.ge.N().lastPriceAnimation){case 0:return!1;case 1:return!0;case 2:return performance.now()<=this.we}}Tt(){return this.xt?(this.Rt(),this.xt=!1,this.ve=!1):this.ve&&(this.Ce(),this.ve=!1),this.Gt}Rt(){this.Gt.ht(null);const t=this.ge.Qt().Et(),e=t.Pe(),i=this.ge.zt();if(null===e||null===i)return;const s=this.ge.ye(!0);if(s.ke||!e.Te(s.Re))return;const o={x:t.qt(s.Re),y:this.ge.Ft().Nt(s.gt,i.Wt)},r=s.R,n=this.ge.N().lineWidth,a=this.De(this.Ve(),r);this.Gt.ht({ee:r,re:n,he:a.he,ae:a.ae,ft:a.ft,ne:o})}Ce(){const t=this.Gt.se();if(null!==t){const e=this.De(this.Ve(),t.ee);t.he=e.he,t.ae=e.ae,t.ft=e.ft}}Ve(){return this.xe()?performance.now()-this.me:2599}Be(t,e,i,s){const o=i+(s-i)*e;return this.ge.Qt().Xi().j(t,o)}De(t,e){const i=t%2600/2600;let s;for(const t of Nh)if(i>=t.le&&i<=t.oe){s=t;break}Rl(void 0!==s,"Last price animation internal logic error");const o=(i-s.le)/(s.oe-s.le);return{he:this.Be(e,o,s.ce,s.de),ae:this.Be(e,o,s.fe,s.pe),ft:(r=o,n=s._e,a=s.ue,n+(a-n)*r)};var r,n,a}}class Hh extends Vh{constructor(t){super(t)}te(){const t=this.Zn;t.Vt=!1;const e=this.Jn.N();if(!e.priceLineVisible||!this.Jn.Vt())return;const i=this.Jn.ye(0===e.priceLineSource);i.ke||(t.Vt=!0,t.ut=i.Ii,t.R=this.Jn.Ie(i.R),t.ct=e.priceLineWidth,t.Xt=e.priceLineStyle)}}class Uh extends bh{constructor(t){super(),this.Jt=t}qi(t,e,i){t.Vt=!1,e.Vt=!1;const s=this.Jt;if(!s.Vt())return;const o=s.N(),r=o.lastValueVisible,n=""!==s.Ee(),a=0===o.seriesLastValueMode,l=s.ye(!1);if(l.ke)return;r&&(t.ri=this.Ae(l,r,a),t.Vt=0!==t.ri.length),(n||a)&&(e.ri=this.ze(l,r,n,a),e.Vt=e.ri.length>0);const h=s.Ie(l.R),c=this.Jt.Qt().Xi().X(h);i.Z=c.Z,i.Ii=l.Ii,e.Ht=s.Qt().Ut(l.Ii/s.Ft().$t()),t.Ht=h,t.R=c.G,e.R=c.G}ze(t,e,i,s){let o="";const r=this.Jt.Ee();return i&&0!==r.length&&(o+=`${r} `),e&&s&&(o+=this.Jt.Ft().Le()?t.Oe:t.Ne),o.trim()}Ae(t,e,i){return e?i?this.Jt.Ft().Le()?t.Ne:t.Oe:t.ri:""}}function Wh(t,e,i,s){const o=Number.isFinite(e),r=Number.isFinite(i);return o&&r?t(e,i):o||r?o?e:i:s}class Yh{constructor(t,e){this.Fe=t,this.We=e}He(t){return null!==t&&this.Fe===t.Fe&&this.We===t.We}Ue(){return new Yh(this.Fe,this.We)}$e(){return this.Fe}qe(){return this.We}Ye(){return this.We-this.Fe}Ki(){return this.We===this.Fe||Number.isNaN(this.We)||Number.isNaN(this.Fe)}vn(t){return null===t?this:new Yh(Wh(Math.min,this.$e(),t.$e(),-1/0),Wh(Math.max,this.qe(),t.qe(),1/0))}je(t){if(!Yl(t))return;if(0===this.We-this.Fe)return;const e=.5*(this.We+this.Fe);let i=this.We-e,s=this.Fe-e;i*=t,s*=t,this.We=e+i,this.Fe=e+s}Ke(t){Yl(t)&&(this.We+=t,this.Fe+=t)}Xe(){return{minValue:this.Fe,maxValue:this.We}}static Ze(t){return null===t?null:new Yh(t.minValue,t.maxValue)}}class qh{constructor(t,e){this.Ge=t,this.Je=e||null}Qe(){return this.Ge}tr(){return this.Je}Xe(){return{priceRange:null===this.Ge?null:this.Ge.Xe(),margins:this.Je||void 0}}static Ze(t){return null===t?null:new qh(Yh.Ze(t.priceRange),t.margins)}}class jh extends Vh{constructor(t,e){super(t),this.ir=e}te(){const t=this.Zn;t.Vt=!1;const e=this.ir.N();if(!this.Jn.Vt()||!e.lineVisible)return;const i=this.ir.sr();null!==i&&(t.Vt=!0,t.ut=i,t.R=e.color,t.ct=e.lineWidth,t.Xt=e.lineStyle,t.Kn=this.ir.N().id)}}class Gh extends bh{constructor(t,e){super(),this.ge=t,this.ir=e}qi(t,e,i){t.Vt=!1,e.Vt=!1;const s=this.ir.N(),o=s.axisLabelVisible,r=""!==s.title,n=this.ge;if(!o||!n.Vt())return;const a=this.ir.sr();if(null===a)return;r&&(e.ri=s.title,e.Vt=!0),e.Ht=n.Qt().Ut(a/n.Ft().$t()),t.ri=this.nr(s.price),t.Vt=!0;const l=this.ge.Qt().Xi().X(s.axisLabelColor||s.color);i.Z=l.Z;const h=s.axisLabelTextColor||l.G;t.R=h,e.R=h,i.Ii=a}nr(t){const e=this.ge.zt();return null===e?"":this.ge.Ft().Zi(t,e.Wt)}}class Kh{constructor(t,e){this.ge=t,this.Ps=e,this.er=new jh(t,this),this.Fn=new Gh(t,this),this.rr=new Oh(this.Fn,t,t.Qt())}hr(t){Wl(this.Ps,t),this.yt(),this.ge.Qt().ar()}N(){return this.Ps}lr(){return this.er}_r(){return this.rr}ur(){return this.Fn}yt(){this.er.yt(),this.Fn.yt()}sr(){const t=this.ge,e=t.Ft();if(t.Qt().Et().Ki()||e.Ki())return null;const i=t.zt();return null===i?null:e.Nt(this.Ps.price,i.Wt)}}class Qh extends xh{constructor(t){super(),this.ts=t}Qt(){return this.ts}}const Jh={Bar:(t,e,i,s)=>{const o=e.upColor,r=e.downColor,n=Bl(t(i,s)),a=Hl(n.Wt[0])<=Hl(n.Wt[3]);return{cr:n.R??(a?o:r)}},Candlestick:(t,e,i,s)=>{const o=e.upColor,r=e.downColor,n=e.borderUpColor,a=e.borderDownColor,l=e.wickUpColor,h=e.wickDownColor,c=Bl(t(i,s)),d=Hl(c.Wt[0])<=Hl(c.Wt[3]);return{cr:c.R??(d?o:r),dr:c.Ht??(d?n:a),pr:c.vr??(d?l:h)}},Custom:(t,e,i,s)=>({cr:Bl(t(i,s)).R??e.color}),Area:(t,e,i,s)=>{const o=Bl(t(i,s));return{cr:o.vt??e.lineColor,vt:o.vt??e.lineColor,mr:o.mr??e.topColor,wr:o.wr??e.bottomColor}},Baseline:(t,e,i,s)=>{const o=Bl(t(i,s));return{cr:o.Wt[3]>=e.baseValue.price?e.topLineColor:e.bottomLineColor,gr:o.gr??e.topLineColor,Mr:o.Mr??e.bottomLineColor,br:o.br??e.topFillColor1,Sr:o.Sr??e.topFillColor2,Cr:o.Cr??e.bottomFillColor1,Pr:o.Pr??e.bottomFillColor2}},Line:(t,e,i,s)=>{const o=Bl(t(i,s));return{cr:o.R??e.color,vt:o.R??e.color}},Histogram:(t,e,i,s)=>({cr:Bl(t(i,s)).R??e.color})};class Xh{constructor(t){this.yr=(t,e)=>void 0!==e?e.Wt:this.ge.Xs().kr(t),this.ge=t,this.Tr=Jh[t.Rr()]}Dr(t,e){return this.Tr(this.yr,this.ge.N(),t,e)}}function Zh(t,e,i,s,o=0,r=e.length){let n=r-o;for(;0<n;){const r=n>>1,a=o+r;s(e[a],i)===t?(o=a+1,n-=r+1):n=r}return o}const tc=Zh.bind(null,!0),ec=Zh.bind(null,!1);var ic;!function(t){t[t.NearestLeft=-1]="NearestLeft",t[t.None=0]="None",t[t.NearestRight=1]="NearestRight"}(ic||(ic={}));const sc=30;class oc{constructor(){this.Vr=[],this.Br=new Map,this.Ir=new Map,this.Er=[]}Ar(){return this.zr()>0?this.Vr[this.Vr.length-1]:null}Lr(){return this.zr()>0?this.Or(0):null}Ks(){return this.zr()>0?this.Or(this.Vr.length-1):null}zr(){return this.Vr.length}Ki(){return 0===this.zr()}Te(t){return null!==this.Nr(t,0)}kr(t){return this.Fr(t)}Fr(t,e=0){const i=this.Nr(t,e);return null===i?null:{...this.Wr(i),Re:this.Or(i)}}Hr(){return this.Vr}Ur(t,e,i){if(this.Ki())return null;let s=null;for(const o of i)s=rc(s,this.$r(t,e,o));return s}ht(t){this.Ir.clear(),this.Br.clear(),this.Vr=t,this.Er=t.map(t=>t.Re)}qr(){return this.Er}Or(t){return this.Vr[t].Re}Wr(t){return this.Vr[t]}Nr(t,e){const i=this.Yr(t);if(null===i&&0!==e)switch(e){case-1:return this.jr(t);case 1:return this.Kr(t);default:throw new TypeError("Unknown search mode")}return i}jr(t){let e=this.Xr(t);return e>0&&(e-=1),e!==this.Vr.length&&this.Or(e)<t?e:null}Kr(t){const e=this.Zr(t);return e!==this.Vr.length&&t<this.Or(e)?e:null}Yr(t){const e=this.Xr(t);return e===this.Vr.length||t<this.Vr[e].Re?null:e}Xr(t){return tc(this.Vr,t,(t,e)=>t.Re<e)}Zr(t){return ec(this.Vr,t,(t,e)=>t.Re>e)}Gr(t,e,i){let s=null;for(let o=t;o<e;o++){const t=this.Vr[o].Wt[i];Number.isNaN(t)||(null===s?s={Jr:t,Qr:t}:(t<s.Jr&&(s.Jr=t),t>s.Qr&&(s.Qr=t)))}return s}$r(t,e,i){if(this.Ki())return null;let s=null;const o=Bl(this.Lr()),r=Bl(this.Ks()),n=Math.max(t,o),a=Math.min(e,r),l=Math.ceil(n/sc)*sc,h=Math.max(l,Math.floor(a/sc)*sc);{const t=this.Xr(n),o=this.Zr(Math.min(a,l,e));s=rc(s,this.Gr(t,o,i))}let c=this.Br.get(i);void 0===c&&(c=new Map,this.Br.set(i,c));for(let t=Math.max(l+1,n);t<h;t+=sc){const e=Math.floor(t/sc);let o=c.get(e);if(void 0===o){const t=this.Xr(e*sc),s=this.Zr((e+1)*sc-1);o=this.Gr(t,s,i),c.set(e,o)}s=rc(s,o)}{const t=this.Xr(h),e=this.Zr(a);s=rc(s,this.Gr(t,e,i))}return s}}function rc(t,e){return null===t?e:null===e?t:{Jr:Math.min(t.Jr,e.Jr),Qr:Math.max(t.Qr,e.Qr)}}const nc={setLineStyle:Vl};class ac{constructor(t){this.th=t}nt(t,e,i){this.th.draw(t,nc)}ih(t,e,i){this.th.drawBackground?.(t,nc)}}class lc{constructor(t){this.Dn=null,this.sh=t}Tt(){const t=this.sh.renderer();if(null===t)return null;if(this.Dn?.nh===t)return this.Dn.eh;const e=new ac(t);return this.Dn={nh:t,eh:e},e}rh(){return this.sh.zOrder?.()??"normal"}}class hc{constructor(t){this.hh=null,this.ah=t}oh(){return this.ah}Ns(){this.ah.updateAllViews?.()}Fs(){const t=this.ah.paneViews?.()??[];if(this.hh?.nh===t)return this.hh.eh;const e=t.map(t=>new lc(t));return this.hh={nh:t,eh:e},e}jn(t,e){return this.ah.hitTest?.(t,e)??null}}let cc=class extends hc{us(){return[]}};class dc{constructor(t){this.th=t}nt(t,e,i){this.th.draw(t,nc)}ih(t,e,i){this.th.drawBackground?.(t,nc)}}class uc{constructor(t){this.Dn=null,this.sh=t}Tt(){const t=this.sh.renderer();if(null===t)return null;if(this.Dn?.nh===t)return this.Dn.eh;const e=new dc(t);return this.Dn={nh:t,eh:e},e}rh(){return this.sh.zOrder?.()??"normal"}}function pc(t){return{ri:t.text(),Ii:t.coordinate(),Bi:t.fixedCoordinate?.(),R:t.textColor(),Z:t.backColor(),Vt:t.visible?.()??!0,pi:t.tickVisible?.()??!0}}class fc{constructor(t,e){this.Gt=new wh,this._h=t,this.uh=e}Tt(){return this.Gt.ht({Qi:this.uh.Qi(),...pc(this._h)}),this.Gt}}class mc extends bh{constructor(t,e){super(),this._h=t,this.Yi=e}qi(t,e,i){const s=pc(this._h);i.Z=s.Z,t.R=s.R;const o=2/12*this.Yi.P();i.Ti=o,i.Ri=o,i.Ii=s.Ii,i.Bi=s.Bi,t.ri=s.ri,t.Vt=s.Vt,t.pi=s.pi}}class gc extends hc{constructor(t,e){super(t),this.dh=null,this.fh=null,this.ph=null,this.mh=null,this.ge=e}cs(){const t=this.ah.timeAxisViews?.()??[];if(this.dh?.nh===t)return this.dh.eh;const e=this.ge.Qt().Et(),i=t.map(t=>new fc(t,e));return this.dh={nh:t,eh:i},i}Ws(){const t=this.ah.priceAxisViews?.()??[];if(this.fh?.nh===t)return this.fh.eh;const e=this.ge.Ft(),i=t.map(t=>new mc(t,e));return this.fh={nh:t,eh:i},i}wh(){const t=this.ah.priceAxisPaneViews?.()??[];if(this.ph?.nh===t)return this.ph.eh;const e=t.map(t=>new uc(t));return this.ph={nh:t,eh:e},e}gh(){const t=this.ah.timeAxisPaneViews?.()??[];if(this.mh?.nh===t)return this.mh.eh;const e=t.map(t=>new uc(t));return this.mh={nh:t,eh:e},e}Mh(t,e){return this.ah.autoscaleInfo?.(t,e)??null}}function bc(t,e,i,s){t.forEach(t=>{e(t).forEach(t=>{t.rh()===i&&s.push(t)})})}function vc(t){return t.Fs()}function yc(t){return t.wh()}function wc(t){return t.gh()}const _c=["Area","Line","Baseline"];class xc extends Qh{constructor(t,e,i,s,o){super(t),this.Yt=new oc,this.er=new Hh(this),this.bh=[],this.Sh=new Fh(this),this.xh=null,this.Ch=null,this.Ph=null,this.yh=[],this.Ps=i,this.kh=e;const r=new Uh(this);this.vs=[r],this.rr=new Oh(r,this,t),_c.includes(this.kh)&&(this.xh=new Bh(this)),this.Th(),this.sh=s(this,this.Qt(),o)}m(){null!==this.Ph&&clearTimeout(this.Ph)}Ie(t){return this.Ps.priceLineColor||t}ye(t){const e={ke:!0},i=this.Ft();if(this.Qt().Et().Ki()||i.Ki()||this.Yt.Ki())return e;const s=this.Qt().Et().Pe(),o=this.zt();if(null===s||null===o)return e;let r,n;if(t){const t=this.Yt.Ar();if(null===t)return e;r=t,n=t.Re}else{const t=this.Yt.Fr(s.bi(),-1);if(null===t)return e;if(r=this.Yt.kr(t.Re),null===r)return e;n=t.Re}const a=r.Wt[3],l=this.Rh().Dr(n,{Wt:r}),h=i.Nt(a,o.Wt);return{ke:!1,gt:a,ri:i.Zi(a,o.Wt),Oe:i.Dh(a),Ne:i.Vh(a,o.Wt),R:l.cr,Ii:h,Re:n}}Rh(){return null!==this.Ch||(this.Ch=new Xh(this)),this.Ch}N(){return this.Ps}hr(t){const e=t.priceScaleId;void 0!==e&&e!==this.Ps.priceScaleId&&this.Qt().Bh(this,e),Wl(this.Ps,t),void 0!==t.priceFormat&&(this.Th(),this.Qt().Ih()),this.Qt().Eh(this),this.Qt().Ah(),this.sh.yt("options")}ht(t,e){this.Yt.ht(t),this.sh.yt("data"),null!==this.xh&&(e&&e.zh?this.xh.be():0===t.length&&this.xh.Me());const i=this.Qt().Hn(this);this.Qt().Lh(i),this.Qt().Eh(this),this.Qt().Ah(),this.Qt().ar()}Oh(t){const e=new Kh(this,t);return this.bh.push(e),this.Qt().Eh(this),e}Nh(t){const e=this.bh.indexOf(t);-1!==e&&this.bh.splice(e,1),this.Qt().Eh(this)}Fh(){return this.bh}Rr(){return this.kh}zt(){const t=this.Wh();return null===t?null:{Wt:t.Wt[3],Hh:t.wt}}Wh(){const t=this.Qt().Et().Pe();if(null===t)return null;const e=t.Uh();return this.Yt.Fr(e,1)}Xs(){return this.Yt}$h(t){const e=this.Yt.kr(t);return null===e?null:"Bar"===this.kh||"Candlestick"===this.kh||"Custom"===this.kh?{qh:e.Wt[0],Yh:e.Wt[1],jh:e.Wt[2],Kh:e.Wt[3]}:e.Wt[3]}Xh(t){const e=[];bc(this.yh,vc,"top",e);const i=this.xh;return null!==i&&i.Vt()?(null===this.Ph&&i.xe()&&(this.Ph=setTimeout(()=>{this.Ph=null,this.Qt().Zh()},0)),i.Se(),e.unshift(i),e):e}Fs(){const t=[];this.Gh()||t.push(this.Sh),t.push(this.sh,this.er);const e=this.bh.map(t=>t.lr());return t.push(...e),bc(this.yh,vc,"normal",t),t}Jh(){return this.Qh(vc,"bottom")}ta(t){return this.Qh(yc,t)}ia(t){return this.Qh(wc,t)}sa(t,e){return this.yh.map(i=>i.jn(t,e)).filter(t=>null!==t)}us(){return[this.rr,...this.bh.map(t=>t._r())]}Ws(t,e){if(e!==this.es&&!this.Gh())return[];const i=[...this.vs];for(const t of this.bh)i.push(t.ur());return this.yh.forEach(t=>{i.push(...t.Ws())}),i}cs(){const t=[];return this.yh.forEach(e=>{t.push(...e.cs())}),t}Mh(t,e){if(void 0!==this.Ps.autoscaleInfoProvider){const i=this.Ps.autoscaleInfoProvider(()=>{const i=this.na(t,e);return null===i?null:i.Xe()});return qh.Ze(i)}return this.na(t,e)}nh(){const t=this.Ps.priceFormat;return t.base??1/t.minMove}ea(){return this.ra}Ns(){this.sh.yt();for(const t of this.vs)t.yt();for(const t of this.bh)t.yt();this.er.yt(),this.Sh.yt(),this.xh?.yt(),this.yh.forEach(t=>t.Ns())}Ft(){return Bl(super.Ft())}At(t){if("Line"!==this.kh&&"Area"!==this.kh&&"Baseline"!==this.kh||!this.Ps.crosshairMarkerVisible)return null;const e=this.Yt.kr(t);return null===e?null:{gt:e.Wt[3],ft:this.ha(),Ht:this.aa(),Ot:this.la(),Lt:this.oa(t)}}Ee(){return this.Ps.title}Vt(){return this.Ps.visible}_a(t){this.yh.push(new gc(t,this))}ua(t){this.yh=this.yh.filter(e=>e.oh()!==t)}ca(){if("Custom"===this.kh)return t=>this.sh.da(t)}fa(){if("Custom"===this.kh)return t=>this.sh.pa(t)}va(){return this.Yt.qr()}Gh(){return!Sh(this.Ft().ma())}na(t,e){if(!ql(t)||!ql(e)||this.Yt.Ki())return null;const i="Line"===this.kh||"Area"===this.kh||"Baseline"===this.kh||"Histogram"===this.kh?[3]:[2,1],s=this.Yt.Ur(t,e,i);let o=null!==s?new Yh(s.Jr,s.Qr):null,r=null;if("Histogram"===this.Rr()){const t=this.Ps.base,e=new Yh(t,t);o=null!==o?o.vn(e):e}return this.yh.forEach(i=>{const s=i.Mh(t,e);if(s?.priceRange){const t=new Yh(s.priceRange.minValue,s.priceRange.maxValue);o=null!==o?o.vn(t):t}s?.margins&&(r=s.margins)}),new qh(o,r)}ha(){switch(this.kh){case"Line":case"Area":case"Baseline":return this.Ps.crosshairMarkerRadius}return 0}aa(){switch(this.kh){case"Line":case"Area":case"Baseline":{const t=this.Ps.crosshairMarkerBorderColor;if(0!==t.length)return t}}return null}la(){switch(this.kh){case"Line":case"Area":case"Baseline":return this.Ps.crosshairMarkerBorderWidth}return 0}oa(t){switch(this.kh){case"Line":case"Area":case"Baseline":{const t=this.Ps.crosshairMarkerBackgroundColor;if(0!==t.length)return t}}return this.Rh().Dr(t).cr}Th(){switch(this.Ps.priceFormat.type){case"custom":{const t=this.Ps.priceFormat.formatter;this.ra={format:t,formatTickmarks:this.Ps.priceFormat.tickmarksFormatter??(e=>e.map(t))};break}case"volume":this.ra=new Th(this.Ps.priceFormat.precision);break;case"percent":this.ra=new Ph(this.Ps.priceFormat.precision);break;default:{const t=Math.pow(10,this.Ps.priceFormat.precision);this.ra=new Mh(t,this.Ps.priceFormat.minMove*t)}}null!==this.es&&this.es.wa()}Qh(t,e){const i=[];return bc(this.yh,t,e,i),i}}const kc=[3],Cc=[0,1,2,3];class Sc{constructor(t){this.Ps=t}ga(t,e,i){let s=t;if(0===this.Ps.mode)return s;const o=i.ks(),r=o.zt();if(null===r)return s;const n=o.Nt(t,r),a=i.Ma().filter(t=>t instanceof xc).reduce((t,s)=>{if(i.Un(s)||!s.Vt())return t;const o=s.Ft(),r=s.Xs();if(o.Ki()||!r.Te(e))return t;const n=r.kr(e);if(null===n)return t;const a=Hl(s.zt()),l=3===this.Ps.mode?Cc:kc;return t.concat(l.map(t=>o.Nt(n.Wt[t],a.Wt)))},[]);if(0===a.length)return s;a.sort((t,e)=>Math.abs(t-n)-Math.abs(e-n));const l=a[0];return s=o.Ts(l,r),s}}function zc(t,e,i){return Math.min(Math.max(t,e),i)}function $c(t,e,i){return e-t<=i}class Ec extends rh{constructor(){super(...arguments),this.Yt=null}ht(t){this.Yt=t}et({context:t,bitmapSize:e,horizontalPixelRatio:i,verticalPixelRatio:s}){if(null===this.Yt)return;const o=Math.max(1,Math.floor(i));t.lineWidth=o,function(t,e){t.save(),t.lineWidth%2&&t.translate(.5,.5),e(),t.restore()}(t,()=>{const r=Bl(this.Yt);if(r.ba){t.strokeStyle=r.Sa,Vl(t,r.xa),t.beginPath();for(const s of r.Ca){const r=Math.round(s.Pa*i);t.moveTo(r,-o),t.lineTo(r,e.height+o)}t.stroke()}if(r.ya){t.strokeStyle=r.ka,Vl(t,r.Ta),t.beginPath();for(const i of r.Ra){const r=Math.round(i.Pa*s);t.moveTo(-o,r),t.lineTo(e.width+o,r)}t.stroke()}})}}class Mc{constructor(t){this.Gt=new Ec,this.xt=!0,this.Pt=t}yt(){this.xt=!0}Tt(){if(this.xt){const t=this.Pt.Qt().N().grid,e={ya:t.horzLines.visible,ba:t.vertLines.visible,ka:t.horzLines.color,Sa:t.vertLines.color,Ta:t.horzLines.style,xa:t.vertLines.style,Ra:this.Pt.ks().Da(),Ca:(this.Pt.Qt().Et().Da()||[]).map(t=>({Pa:t.coord}))};this.Gt.ht(e),this.xt=!1}return this.Gt}}class Pc{constructor(t){this.sh=new Mc(t)}lr(){return this.sh}}const Tc={Va:4,Ba:1e-4};function Ac(t,e){const i=100*(t-e)/e;return e<0?-i:i}function Lc(t,e){const i=Ac(t.$e(),e),s=Ac(t.qe(),e);return new Yh(i,s)}function Dc(t,e){const i=100*(t-e)/e+100;return e<0?-i:i}function Oc(t,e){const i=Dc(t.$e(),e),s=Dc(t.qe(),e);return new Yh(i,s)}function Ic(t,e){const i=Math.abs(t);if(i<1e-15)return 0;const s=Math.log10(i+e.Ba)+e.Va;return t<0?-s:s}function Vc(t,e){const i=Math.abs(t);if(i<1e-15)return 0;const s=Math.pow(10,i-e.Va)-e.Ba;return t<0?-s:s}function Fc(t,e){if(null===t)return null;const i=Ic(t.$e(),e),s=Ic(t.qe(),e);return new Yh(i,s)}function Rc(t,e){if(null===t)return null;const i=Vc(t.$e(),e),s=Vc(t.qe(),e);return new Yh(i,s)}function Nc(t){if(null===t)return Tc;const e=Math.abs(t.qe()-t.$e());if(e>=1||e<1e-15)return Tc;const i=Math.ceil(Math.abs(Math.log10(e))),s=Tc.Va+i;return{Va:s,Ba:1/Math.pow(10,s)}}class Bc{constructor(t,e){if(this.Ia=t,this.Ea=e,function(t){if(t<0)return!1;if(t>1e18)return!0;for(let e=t;e>1;e/=10)if(e%10!=0)return!1;return!0}(this.Ia))this.Aa=[2,2.5,2];else{this.Aa=[];for(let t=this.Ia;1!==t;){if(t%2==0)this.Aa.push(2),t/=2;else{if(t%5!=0)throw new Error("unexpected base");this.Aa.push(2,2.5),t/=5}if(this.Aa.length>100)throw new Error("something wrong with base")}}}za(t,e,i){const s=0===this.Ia?0:1/this.Ia;let o=Math.pow(10,Math.max(0,Math.ceil(Math.log10(t-e)))),r=0,n=this.Ea[0];for(;;){const t=$c(o,s,1e-14)&&o>s+1e-14,e=$c(o,i*n,1e-14),a=$c(o,1,1e-14);if(!(t&&e&&a))break;o/=n,n=this.Ea[++r%this.Ea.length]}if(o<=s+1e-14&&(o=s),o=Math.max(1,o),this.Aa.length>0&&(a=o,Math.abs(a-1)<1e-14))for(r=0,n=this.Aa[0];$c(o,i*n,1e-14)&&o>s+1e-14;)o/=n,n=this.Aa[++r%this.Aa.length];var a;return o}}class Hc{constructor(t,e,i,s){this.La=[],this.Yi=t,this.Ia=e,this.Oa=i,this.Na=s}za(t,e){if(t<e)throw new Error("high < low");const i=this.Yi.$t(),s=(t-e)*this.Fa()/i,o=new Bc(this.Ia,[2,2.5,2]),r=new Bc(this.Ia,[2,2,2.5]),n=new Bc(this.Ia,[2.5,2,2]),a=[];return a.push(o.za(t,e,s),r.za(t,e,s),n.za(t,e,s)),function(t){if(t.length<1)throw Error("array is empty");let e=t[0];for(let i=1;i<t.length;++i)t[i]<e&&(e=t[i]);return e}(a)}Wa(){const t=this.Yi,e=t.zt();if(null===e)return void(this.La=[]);const i=t.$t(),s=this.Oa(i-1,e),o=this.Oa(0,e),r=this.Yi.N().entireTextOnly?this.Ha()/2:0,n=r,a=i-1-r,l=Math.max(s,o),h=Math.min(s,o);if(l===h)return void(this.La=[]);const c=this.za(l,h);if(this.Ua(e,c,l,h,n,a),t.$a()&&this.qa(c,h,l)){const t=this.Yi.Ya();this.ja(e,c,n,a,t,2*t)}const d=this.La.map(t=>t.Ka),u=this.Yi.Xa(d);for(let t=0;t<this.La.length;t++)this.La[t].Za=u[t]}Da(){return this.La}Ha(){return this.Yi.P()}Fa(){return Math.ceil(2.5*this.Ha())}Ua(t,e,i,s,o,r){const n=this.La,a=this.Yi;let l=i%e;l+=l<0?e:0;const h=i>=s?1:-1;let c=null,d=0;for(let u=i-l;u>s;u-=e){const i=this.Na(u,t,!0);null!==c&&Math.abs(i-c)<this.Fa()||i<o||i>r||(d<n.length?(n[d].Pa=i,n[d].Za=a.Ga(u),n[d].Ka=u):n.push({Pa:i,Za:a.Ga(u),Ka:u}),d++,c=i,a.Ja()&&(e=this.za(u*h,s)))}n.length=d}ja(t,e,i,s,o,r){const n=this.La,a=this.Qa(t,i,o,r),l=this.Qa(t,s,-r,-o),h=this.Na(0,t,!0)-this.Na(e,t,!0);n.length>0&&n[0].Pa-a.Pa<h/2&&n.shift(),n.length>0&&l.Pa-n[n.length-1].Pa<h/2&&n.pop(),n.unshift(a),n.push(l)}Qa(t,e,i,s){const o=(i+s)/2,r=this.Oa(e+i,t),n=this.Oa(e+s,t),a=Math.min(r,n),l=Math.max(r,n),h=Math.max(.1,this.za(l,a)),c=this.Oa(e+o,t),d=c-c%h,u=this.Na(d,t,!0);return{Za:this.Yi.Ga(d),Pa:u,Ka:d}}qa(t,e,i){let s=Hl(this.Yi.Qe());return this.Yi.Ja()&&(s=Rc(s,this.Yi.tl())),s.$e()-e<t&&i-s.qe()<t}}function Uc(t){return t.slice().sort((t,e)=>Bl(t.hs())-Bl(e.hs()))}var Wc;!function(t){t[t.Normal=0]="Normal",t[t.Logarithmic=1]="Logarithmic",t[t.Percentage=2]="Percentage",t[t.IndexedTo100=3]="IndexedTo100"}(Wc||(Wc={}));const Yc=new Ph,qc=new Mh(100,1);class jc{constructor(t,e,i,s,o){this.il=0,this.sl=null,this.Ge=null,this.nl=null,this.el={rl:!1,hl:null},this.al=!1,this.ll=0,this.ol=0,this._l=new Ul,this.ul=new Ul,this.cl=[],this.dl=null,this.fl=null,this.pl=null,this.vl=null,this.ml=null,this.ra=qc,this.wl=Nc(null),this.gl=t,this.Ps=e,this.Ml=i,this.bl=s,this.Sl=o,this.xl=new Hc(this,100,this.Cl.bind(this),this.Pl.bind(this))}ma(){return this.gl}N(){return this.Ps}hr(t){if(Wl(this.Ps,t),this.wa(),void 0!==t.mode&&this.yl({ie:t.mode}),void 0!==t.scaleMargins){const e=Nl(t.scaleMargins.top),i=Nl(t.scaleMargins.bottom);if(e<0||e>1)throw new Error(`Invalid top margin - expect value between 0 and 1, given=${e}`);if(i<0||i>1)throw new Error(`Invalid bottom margin - expect value between 0 and 1, given=${i}`);if(e+i>1)throw new Error(`Invalid margins - sum of margins must be less than 1, given=${e+i}`);this.kl(),this.pl=null}}Tl(){return this.Ps.autoScale}Rl(){return this.al}Ja(){return 1===this.Ps.mode}Le(){return 2===this.Ps.mode}Dl(){return 3===this.Ps.mode}tl(){return this.wl}ie(){return{sn:this.Ps.autoScale,Vl:this.Ps.invertScale,ie:this.Ps.mode}}yl(t){const e=this.ie();let i=null;void 0!==t.sn&&(this.Ps.autoScale=t.sn),void 0!==t.ie&&(this.Ps.mode=t.ie,2!==t.ie&&3!==t.ie||(this.Ps.autoScale=!0),this.el.rl=!1),1===e.ie&&t.ie!==e.ie&&(function(t,e){if(null===t)return!1;const i=Vc(t.$e(),e),s=Vc(t.qe(),e);return isFinite(i)&&isFinite(s)}(this.Ge,this.wl)?(i=Rc(this.Ge,this.wl),null!==i&&this.Bl(i)):this.Ps.autoScale=!0),1===t.ie&&t.ie!==e.ie&&(i=Fc(this.Ge,this.wl),null!==i&&this.Bl(i));const s=e.ie!==this.Ps.mode;s&&(2===e.ie||this.Le())&&this.wa(),s&&(3===e.ie||this.Dl())&&this.wa(),void 0!==t.Vl&&e.Vl!==t.Vl&&(this.Ps.invertScale=t.Vl,this.Il()),this.ul.p(e,this.ie())}El(){return this.ul}P(){return this.Ml.fontSize}$t(){return this.il}Al(t){this.il!==t&&(this.il=t,this.kl(),this.pl=null)}zl(){if(this.sl)return this.sl;const t=this.$t()-this.Ll()-this.Ol();return this.sl=t,t}Qe(){return this.Nl(),this.Ge}Bl(t,e){const i=this.Ge;(e||null===i&&null!==t||null!==i&&!i.He(t))&&(this.pl=null,this.Ge=t)}Fl(t){this.Bl(t),this.Wl(null!==t)}Ki(){return this.Nl(),0===this.il||!this.Ge||this.Ge.Ki()}Hl(t){return this.Vl()?t:this.$t()-1-t}Nt(t,e){return this.Le()?t=Ac(t,e):this.Dl()&&(t=Dc(t,e)),this.Pl(t,e)}Ul(t,e,i){this.Nl();const s=this.Ol(),o=Bl(this.Qe()),r=o.$e(),n=o.qe(),a=this.zl()-1,l=this.Vl(),h=a/(n-r),c=void 0===i?0:i.from,d=void 0===i?t.length:i.to,u=this.$l();for(let i=c;i<d;i++){const o=t[i],n=o.gt;if(isNaN(n))continue;let a=n;null!==u&&(a=u(o.gt,e));const c=s+h*(a-r),d=l?c:this.il-1-c;o.ut=d}}ql(t,e,i){this.Nl();const s=this.Ol(),o=Bl(this.Qe()),r=o.$e(),n=o.qe(),a=this.zl()-1,l=this.Vl(),h=a/(n-r),c=void 0===i?0:i.from,d=void 0===i?t.length:i.to,u=this.$l();for(let i=c;i<d;i++){const o=t[i];let n=o.qh,a=o.Yh,c=o.jh,d=o.Kh;null!==u&&(n=u(o.qh,e),a=u(o.Yh,e),c=u(o.jh,e),d=u(o.Kh,e));let p=s+h*(n-r),f=l?p:this.il-1-p;o.Yl=f,p=s+h*(a-r),f=l?p:this.il-1-p,o.jl=f,p=s+h*(c-r),f=l?p:this.il-1-p,o.Kl=f,p=s+h*(d-r),f=l?p:this.il-1-p,o.Xl=f}}Ts(t,e){const i=this.Cl(t,e);return this.Zl(i,e)}Zl(t,e){let i=t;return this.Le()?i=function(t,e){return e<0&&(t=-t),t/100*e+e}(i,e):this.Dl()&&(i=function(t,e){return t-=100,e<0&&(t=-t),t/100*e+e}(i,e)),i}Ma(){return this.cl}Dt(){return this.fl||(this.fl=Uc(this.cl)),this.fl}Gl(t){-1===this.cl.indexOf(t)&&(this.cl.push(t),this.wa(),this.Jl())}Ql(t){const e=this.cl.indexOf(t);if(-1===e)throw new Error("source is not attached to scale");this.cl.splice(e,1),0===this.cl.length&&(this.yl({sn:!0}),this.Bl(null)),this.wa(),this.Jl()}zt(){let t=null;for(const e of this.cl){const i=e.zt();null!==i&&(null===t||i.Hh<t.Hh)&&(t=i)}return null===t?null:t.Wt}Vl(){return this.Ps.invertScale}Da(){const t=null===this.zt();if(null!==this.pl&&(t||this.pl.io===t))return this.pl.Da;this.xl.Wa();const e=this.xl.Da();return this.pl={Da:e,io:t},this._l.p(),e}so(){return this._l}no(t){this.Le()||this.Dl()||null===this.vl&&null===this.nl&&(this.Ki()||(this.vl=this.il-t,this.nl=Bl(this.Qe()).Ue()))}eo(t){if(this.Le()||this.Dl())return;if(null===this.vl)return;this.yl({sn:!1}),(t=this.il-t)<0&&(t=0);let e=(this.vl+.2*(this.il-1))/(t+.2*(this.il-1));const i=Bl(this.nl).Ue();e=Math.max(e,.1),i.je(e),this.Bl(i)}ro(){this.Le()||this.Dl()||(this.vl=null,this.nl=null)}ho(t){this.Tl()||null===this.ml&&null===this.nl&&(this.Ki()||(this.ml=t,this.nl=Bl(this.Qe()).Ue()))}ao(t){if(this.Tl())return;if(null===this.ml)return;const e=Bl(this.Qe()).Ye()/(this.zl()-1);let i=t-this.ml;this.Vl()&&(i*=-1);const s=i*e,o=Bl(this.nl).Ue();o.Ke(s),this.Bl(o,!0),this.pl=null}lo(){this.Tl()||null!==this.ml&&(this.ml=null,this.nl=null)}ea(){return this.ra||this.wa(),this.ra}Zi(t,e){switch(this.Ps.mode){case 2:return this.oo(Ac(t,e));case 3:return this.ea().format(Dc(t,e));default:return this.nr(t)}}Ga(t){switch(this.Ps.mode){case 2:return this.oo(t);case 3:return this.ea().format(t);default:return this.nr(t)}}Xa(t){switch(this.Ps.mode){case 2:return this._o(t);case 3:return this.ea().formatTickmarks(t);default:return this.uo(t)}}Dh(t){return this.nr(t,Bl(this.dl).ea())}Vh(t,e){return t=Ac(t,e),this.oo(t,Yc)}co(){return this.cl}do(t){this.el={hl:t,rl:!1}}Ns(){this.cl.forEach(t=>t.Ns())}$a(){return this.Ps.ensureEdgeTickMarksVisible&&this.Tl()}Ya(){return this.P()/2}wa(){this.pl=null;let t=1/0;this.dl=null;for(const e of this.cl)e.hs()<t&&(t=e.hs(),this.dl=e);let e=100;null!==this.dl&&(e=Math.round(this.dl.nh())),this.ra=qc,this.Le()?(this.ra=Yc,e=100):this.Dl()?(this.ra=new Mh(100,1),e=100):null!==this.dl&&(this.ra=this.dl.ea()),this.xl=new Hc(this,e,this.Cl.bind(this),this.Pl.bind(this)),this.xl.Wa()}Jl(){this.fl=null}fo(){return null===this.dl||this.Le()||this.Dl()?1:1/this.dl.nh()}Xi(){return this.Sl}Wl(t){this.al=t}Ll(){return this.Vl()?this.Ps.scaleMargins.bottom*this.$t()+this.ol:this.Ps.scaleMargins.top*this.$t()+this.ll}Ol(){return this.Vl()?this.Ps.scaleMargins.top*this.$t()+this.ll:this.Ps.scaleMargins.bottom*this.$t()+this.ol}Nl(){this.el.rl||(this.el.rl=!0,this.po())}kl(){this.sl=null}Pl(t,e){if(this.Nl(),this.Ki())return 0;t=this.Ja()&&t?Ic(t,this.wl):t;const i=Bl(this.Qe()),s=this.Ol()+(this.zl()-1)*(t-i.$e())/i.Ye();return this.Hl(s)}Cl(t,e){if(this.Nl(),this.Ki())return 0;const i=this.Hl(t),s=Bl(this.Qe()),o=s.$e()+s.Ye()*((i-this.Ol())/(this.zl()-1));return this.Ja()?Vc(o,this.wl):o}Il(){this.pl=null,this.xl.Wa()}po(){if(this.Rl()&&!this.Tl())return;const t=this.el.hl;if(null===t)return;let e=null;const i=this.co();let s=0,o=0;for(const r of i){if(!r.Vt())continue;const i=r.zt();if(null===i)continue;const n=r.Mh(t.Uh(),t.bi());let a=n&&n.Qe();if(null!==a){switch(this.Ps.mode){case 1:a=Fc(a,this.wl);break;case 2:a=Lc(a,i.Wt);break;case 3:a=Oc(a,i.Wt)}if(e=null===e?a:e.vn(Bl(a)),null!==n){const t=n.tr();null!==t&&(s=Math.max(s,t.above),o=Math.max(o,t.below))}}}if(this.$a()&&(s=Math.max(s,this.Ya()),o=Math.max(o,this.Ya())),s===this.ll&&o===this.ol||(this.ll=s,this.ol=o,this.pl=null,this.kl()),null!==e){if(e.$e()===e.qe()){const t=5*this.fo();this.Ja()&&(e=Rc(e,this.wl)),e=new Yh(e.$e()-t,e.qe()+t),this.Ja()&&(e=Fc(e,this.wl))}if(this.Ja()){const t=Rc(e,this.wl),i=Nc(t);if(r=i,n=this.wl,r.Va!==n.Va||r.Ba!==n.Ba){const s=null!==this.nl?Rc(this.nl,this.wl):null;this.wl=i,e=Fc(t,i),null!==s&&(this.nl=Fc(s,i))}}this.Bl(e)}else null===this.Ge&&(this.Bl(new Yh(-.5,.5)),this.wl=Nc(null));var r,n}$l(){return this.Le()?Ac:this.Dl()?Dc:this.Ja()?t=>Ic(t,this.wl):null}vo(t,e,i){return void 0===e?(void 0===i&&(i=this.ea()),i.format(t)):e(t)}mo(t,e,i){return void 0===e?(void 0===i&&(i=this.ea()),i.formatTickmarks(t)):e(t)}nr(t,e){return this.vo(t,this.bl.priceFormatter,e)}uo(t,e){const i=this.bl.priceFormatter;return this.mo(t,this.bl.tickmarksPriceFormatter??(i?t=>t.map(i):void 0),e)}oo(t,e){return this.vo(t,this.bl.percentageFormatter,e)}_o(t,e){const i=this.bl.percentageFormatter;return this.mo(t,this.bl.tickmarksPercentageFormatter??(i?t=>t.map(i):void 0),e)}}function Gc(t){return t instanceof xc}class Kc{constructor(t,e){this.cl=[],this.wo=new Map,this.il=0,this.Mo=0,this.bo=1,this.fl=null,this.So=!1,this.xo=new Ul,this.yh=[],this.uh=t,this.ts=e,this.Co=new Pc(this);const i=e.N();this.Po=this.yo("left",i.leftPriceScale),this.ko=this.yo("right",i.rightPriceScale),this.Po.El().i(this.To.bind(this,this.Po),this),this.ko.El().i(this.To.bind(this,this.ko),this),this.Ro(i)}Ro(t){if(t.leftPriceScale&&this.Po.hr(t.leftPriceScale),t.rightPriceScale&&this.ko.hr(t.rightPriceScale),t.localization&&(this.Po.wa(),this.ko.wa()),t.overlayPriceScales){const e=Array.from(this.wo.values());for(const i of e){const e=Bl(i[0].Ft());e.hr(t.overlayPriceScales),t.localization&&e.wa()}}}Do(t){switch(t){case"left":return this.Po;case"right":return this.ko}return this.wo.has(t)?Nl(this.wo.get(t))[0].Ft():null}m(){this.Qt().Vo().u(this),this.Po.El().u(this),this.ko.El().u(this),this.cl.forEach(t=>{t.m&&t.m()}),this.yh=this.yh.filter(t=>{const e=t.oh();return e.detached&&e.detached(),!1}),this.xo.p()}Bo(){return this.bo}Io(t){this.bo=t}Qt(){return this.ts}Qi(){return this.Mo}$t(){return this.il}Eo(t){this.Mo=t,this.Ao()}Al(t){this.il=t,this.Po.Al(t),this.ko.Al(t),this.cl.forEach(e=>{if(this.Un(e)){const i=e.Ft();null!==i&&i.Al(t)}}),this.Ao()}zo(t){this.So=t}Lo(){return this.So}Oo(){return this.cl.filter(Gc)}Ma(){return this.cl}Un(t){const e=t.Ft();return null===e||this.Po!==e&&this.ko!==e}Gl(t,e,i){this.No(t,e,i?t.hs():this.cl.length)}Ql(t,e){const i=this.cl.indexOf(t);Rl(-1!==i,"removeDataSource: invalid data source"),this.cl.splice(i,1),e||this.cl.forEach((t,e)=>t.ls(e));const s=Bl(t.Ft()).ma();if(this.wo.has(s)){const e=Nl(this.wo.get(s)),i=e.indexOf(t);-1!==i&&(e.splice(i,1),0===e.length&&this.wo.delete(s))}const o=t.Ft();o&&o.Ma().indexOf(t)>=0&&(o.Ql(t),this.Fo(o)),this.fl=null}qn(t){return t===this.Po?"left":t===this.ko?"right":"overlay"}Wo(){return this.Po}Ho(){return this.ko}Uo(t,e){t.no(e)}$o(t,e){t.eo(e),this.Ao()}qo(t){t.ro()}Yo(t,e){t.ho(e)}jo(t,e){t.ao(e),this.Ao()}Ko(t){t.lo()}Ao(){this.cl.forEach(t=>{t.Ns()})}ks(){let t=null;return this.ts.N().rightPriceScale.visible&&0!==this.ko.Ma().length?t=this.ko:this.ts.N().leftPriceScale.visible&&0!==this.Po.Ma().length?t=this.Po:0!==this.cl.length&&(t=this.cl[0].Ft()),null===t&&(t=this.ko),t}$n(){let t=null;return this.ts.N().rightPriceScale.visible?t=this.ko:this.ts.N().leftPriceScale.visible&&(t=this.Po),t}Fo(t){null!==t&&t.Tl()&&this.Xo(t)}Zo(t){const e=this.uh.Pe();t.yl({sn:!0}),null!==e&&t.do(e),this.Ao()}Go(){this.Xo(this.Po),this.Xo(this.ko)}Jo(){this.Fo(this.Po),this.Fo(this.ko),this.cl.forEach(t=>{this.Un(t)&&this.Fo(t.Ft())}),this.Ao(),this.ts.ar()}Dt(){return null===this.fl&&(this.fl=Uc(this.cl)),this.fl}Qo(t,e){e=zc(e,0,this.cl.length-1);const i=this.cl.indexOf(t);Rl(-1!==i,"setSeriesOrder: invalid data source"),this.cl.splice(i,1),this.cl.splice(e,0,t),this.cl.forEach((t,e)=>t.ls(e)),this.fl=null;for(const t of[this.Po,this.ko])t.Jl(),t.wa();this.ts.ar()}Bt(){return this.Dt().filter(Gc)}t_(){return this.xo}i_(){return this.Co}_a(t){this.yh.push(new cc(t))}ua(t){this.yh=this.yh.filter(e=>e.oh()!==t),t.detached&&t.detached(),this.ts.ar()}s_(){return this.yh}sa(t,e){return this.yh.map(i=>i.jn(t,e)).filter(t=>null!==t)}Xo(t){const e=t.co();if(e&&e.length>0&&!this.uh.Ki()){const e=this.uh.Pe();null!==e&&t.do(e)}t.Ns()}No(t,e,i){let s=this.Do(e);if(null===s&&(s=this.yo(e,this.ts.N().overlayPriceScales)),this.cl.splice(i,0,t),!Sh(e)){const i=this.wo.get(e)||[];i.push(t),this.wo.set(e,i)}t.ls(i),s.Gl(t),t._s(s),this.Fo(s),this.fl=null}To(t,e,i){e.ie!==i.ie&&this.Xo(t)}yo(t,e){const i={visible:!0,autoScale:!0,...Kl(e)},s=new jc(t,i,this.ts.N().layout,this.ts.N().localization,this.ts.Xi());return s.Al(this.$t()),s}}function Qc(t){return{n_:t.n_,e_:{Kn:t.r_.externalId},h_:t.r_.cursorStyle}}function Jc(t,e,i,s){for(const o of t){const t=o.Tt(s);if(null!==t&&t.jn){const s=t.jn(e,i);if(null!==s)return{a_:o,e_:s}}}return null}function Xc(t){return void 0!==t.Fs}function Zc(t,e,i){const s=[t,...t.Dt()],o=function(t,e,i){let s,o;for(const a of t){const t=a.sa?.(e,i)??[];for(const e of t)r=e.zOrder,n=s?.zOrder,(!n||"top"===r&&"top"!==n||"normal"===r&&"bottom"===n)&&(s=e,o=a)}var r,n;return s&&o?{r_:s,n_:o}:null}(s,e,i);if("top"===o?.r_.zOrder)return Qc(o);for(const r of s){if(o&&o.n_===r&&"bottom"!==o.r_.zOrder&&!o.r_.isBackground)return Qc(o);if(Xc(r)){const s=Jc(r.Fs(t),e,i,t);if(null!==s)return{n_:r,a_:s.a_,e_:s.e_}}if(o&&o.n_===r&&"bottom"!==o.r_.zOrder&&o.r_.isBackground)return Qc(o)}return o?.r_?Qc(o):null}class td{constructor(t,e,i=50){this.yn=0,this.kn=1,this.Tn=1,this.Dn=new Map,this.Rn=new Map,this.l_=t,this.o_=e,this.Vn=i}__(t){const e=t.time,i=this.o_.cacheKey(e),s=this.Dn.get(i);if(void 0!==s)return s.u_;if(this.yn===this.Vn){const t=this.Rn.get(this.Tn);this.Rn.delete(this.Tn),this.Dn.delete(Nl(t)),this.Tn++,this.yn--}const o=this.l_(t);return this.Dn.set(i,{u_:o,An:this.kn}),this.Rn.set(this.kn,i),this.yn++,this.kn++,o}}class ed{constructor(t,e){Rl(t<=e,"right should be >= left"),this.c_=t,this.d_=e}Uh(){return this.c_}bi(){return this.d_}f_(){return this.d_-this.c_+1}Te(t){return this.c_<=t&&t<=this.d_}He(t){return this.c_===t.Uh()&&this.d_===t.bi()}}function id(t,e){return null===t||null===e?t===e:t.He(e)}class sd{constructor(){this.p_=new Map,this.Dn=null,this.v_=!1}m_(t){this.v_=t,this.Dn=null}w_(t,e){this.g_(e),this.Dn=null;for(let i=e;i<t.length;++i){const e=t[i];let s=this.p_.get(e.timeWeight);void 0===s&&(s=[],this.p_.set(e.timeWeight,s)),s.push({index:i,time:e.time,weight:e.timeWeight,originalTime:e.originalTime})}}M_(t,e,i,s,o){const r=Math.ceil(e/t);return null!==this.Dn&&this.Dn.b_===r&&o===this.Dn.S_&&i===this.Dn.x_||(this.Dn={S_:o,x_:i,Da:this.C_(r,i,s),b_:r}),this.Dn.Da}g_(t){if(0===t)return void this.p_.clear();const e=[];this.p_.forEach((i,s)=>{t<=i[0].index?e.push(s):i.splice(tc(i,t,e=>e.index<t),1/0)});for(const t of e)this.p_.delete(t)}C_(t,e,i){let s=[];const o=t=>!e||i.has(t.index);for(const e of Array.from(this.p_.keys()).sort((t,e)=>e-t)){if(!this.p_.get(e))continue;const i=s;s=[];const r=i.length;let n=0;const a=Nl(this.p_.get(e)),l=a.length;let h=1/0,c=-1/0;for(let e=0;e<l;e++){const l=a[e],d=l.index;for(;n<r;){const t=i[n],e=t.index;if(!(e<d&&o(t))){h=e;break}n++,s.push(t),c=e,h=1/0}if(h-d>=t&&d-c>=t&&o(l))s.push(l),c=d;else if(this.v_)return i}for(;n<r;n++)o(i[n])&&s.push(i[n])}return s}}class od{constructor(t){this.P_=t}y_(){return null===this.P_?null:new ed(Math.floor(this.P_.Uh()),Math.ceil(this.P_.bi()))}k_(){return this.P_}static T_(){return new od(null)}}function rd(t,e){return t.weight>e.weight?t:e}class nd{constructor(t,e,i,s){this.Mo=0,this.R_=null,this.D_=[],this.ml=null,this.vl=null,this.V_=new sd,this.B_=new Map,this.I_=od.T_(),this.E_=!0,this.A_=new Ul,this.z_=new Ul,this.L_=new Ul,this.O_=null,this.N_=null,this.F_=new Map,this.W_=-1,this.H_=[],this.Ps=e,this.bl=i,this.U_=e.rightOffset,this.q_=e.barSpacing,this.ts=t,this.Y_(e),this.o_=s,this.j_(),this.V_.m_(e.uniformDistribution),this.K_()}N(){return this.Ps}X_(t){Wl(this.bl,t),this.Z_(),this.j_()}hr(t,e){Wl(this.Ps,t),this.Ps.fixLeftEdge&&this.G_(),this.Ps.fixRightEdge&&this.J_(),void 0!==t.barSpacing&&this.ts.dn(t.barSpacing),void 0!==t.rightOffset&&this.ts.fn(t.rightOffset),this.Y_(t),void 0===t.minBarSpacing&&void 0===t.maxBarSpacing||this.ts.dn(t.barSpacing??this.q_),void 0!==t.ignoreWhitespaceIndices&&t.ignoreWhitespaceIndices!==this.Ps.ignoreWhitespaceIndices&&this.K_(),this.Z_(),this.j_(),this.L_.p()}Rs(t){return this.D_[t]?.time??null}ss(t){return this.D_[t]??null}Q_(t,e){if(this.D_.length<1)return null;if(this.o_.key(t)>this.o_.key(this.D_[this.D_.length-1].time))return e?this.D_.length-1:null;const i=tc(this.D_,this.o_.key(t),(t,e)=>this.o_.key(t.time)<e);return this.o_.key(t)<this.o_.key(this.D_[i].time)?e?i:null:i}Ki(){return 0===this.Mo||0===this.D_.length||null===this.R_}tu(){return this.D_.length>0}Pe(){return this.iu(),this.I_.y_()}su(){return this.iu(),this.I_.k_()}nu(){const t=this.Pe();if(null===t)return null;const e={from:t.Uh(),to:t.bi()};return this.eu(e)}eu(t){const e=Math.round(t.from),i=Math.round(t.to),s=Bl(this.ru()),o=Bl(this.hu());return{from:Bl(this.ss(Math.max(s,e))),to:Bl(this.ss(Math.min(o,i)))}}au(t){return{from:Bl(this.Q_(t.from,!0)),to:Bl(this.Q_(t.to,!0))}}Qi(){return this.Mo}Eo(t){if(!isFinite(t)||t<=0)return;if(this.Mo===t)return;const e=this.su(),i=this.Mo;if(this.Mo=t,this.E_=!0,this.Ps.lockVisibleTimeRangeOnResize&&0!==i){const e=this.q_*t/i;this.q_=e}if(this.Ps.fixLeftEdge&&null!==e&&e.Uh()<=0){const e=i-t;this.U_-=Math.round(e/this.q_)+1,this.E_=!0}this.lu(),this.ou()}qt(t){if(this.Ki()||!ql(t))return 0;const e=this._u()+this.U_-t;return this.Mo-(e+.5)*this.q_-1}uu(t,e){const i=this._u(),s=void 0===e?0:e.from,o=void 0===e?t.length:e.to;for(let e=s;e<o;e++){const s=t[e].wt,o=i+this.U_-s,r=this.Mo-(o+.5)*this.q_-1;t[e]._t=r}}cu(t,e){const i=Math.ceil(this.du(t));return e&&this.Ps.ignoreWhitespaceIndices&&!this.fu(i)?this.pu(i):i}fn(t){this.E_=!0,this.U_=t,this.ou(),this.ts.vu(),this.ts.ar()}mu(){return this.q_}dn(t){const e=this.q_;if(this.wu(t),void 0!==this.Ps.rightOffsetPixels&&0!==e){const t=this.U_*e/this.q_;this.U_=t}this.ou(),this.ts.vu(),this.ts.ar()}gu(){return this.U_}Da(){if(this.Ki())return null;if(null!==this.N_)return this.N_;const t=this.q_,e=5*(this.ts.N().layout.fontSize+4)/8*(this.Ps.tickMarkMaxCharacterLength||8),i=Math.round(e/t),s=Bl(this.Pe()),o=Math.max(s.Uh(),s.Uh()-i),r=Math.max(s.bi(),s.bi()-i),n=this.V_.M_(t,e,this.Ps.ignoreWhitespaceIndices,this.F_,this.W_),a=this.ru()+i,l=this.hu()-i,h=this.Mu(),c=this.Ps.fixLeftEdge||h,d=this.Ps.fixRightEdge||h;let u=0;for(const t of n){if(!(o<=t.index&&t.index<=r))continue;let i;u<this.H_.length?(i=this.H_[u],i.coord=this.qt(t.index),i.label=this.bu(t),i.weight=t.weight):(i={needAlignCoordinate:!1,coord:this.qt(t.index),label:this.bu(t),weight:t.weight},this.H_.push(i)),this.q_>e/2&&!h?i.needAlignCoordinate=!1:i.needAlignCoordinate=c&&t.index<=a||d&&t.index>=l,u++}return this.H_.length=u,this.N_=this.H_,this.H_}Su(){let t;this.E_=!0,this.dn(this.Ps.barSpacing),t=void 0!==this.Ps.rightOffsetPixels?this.Ps.rightOffsetPixels/this.mu():this.Ps.rightOffset,this.fn(t)}xu(t){this.E_=!0,this.R_=t,this.ou(),this.G_()}Cu(t,e){const i=this.du(t),s=this.mu(),o=s+e*(s/10);this.dn(o),this.Ps.rightBarStaysOnScroll||this.fn(this.gu()+(i-this.du(t)))}no(t){this.ml&&this.lo(),null===this.vl&&null===this.O_&&(this.Ki()||(this.vl=t,this.Pu()))}eo(t){if(null===this.O_)return;const e=zc(this.Mo-t,0,this.Mo),i=zc(this.Mo-Bl(this.vl),0,this.Mo);0!==e&&0!==i&&this.dn(this.O_.mu*e/i)}ro(){null!==this.vl&&(this.vl=null,this.yu())}ho(t){null===this.ml&&null===this.O_&&(this.Ki()||(this.ml=t,this.Pu()))}ao(t){if(null===this.ml)return;const e=(this.ml-t)/this.mu();this.U_=Bl(this.O_).gu+e,this.E_=!0,this.ou()}lo(){null!==this.ml&&(this.ml=null,this.yu())}ku(){this.Tu(this.Ps.rightOffset)}Tu(t,e=400){if(!isFinite(t))throw new RangeError("offset is required and must be finite number");if(!isFinite(e)||e<=0)throw new RangeError("animationDuration (optional) must be finite positive number");const i=this.U_,s=performance.now();this.ts._n({Ru:t=>(t-s)/e>=1,Du:o=>{const r=(o-s)/e;return r>=1?t:i+(t-i)*r}})}yt(t,e){this.E_=!0,this.D_=t,this.V_.w_(t,e),this.ou()}Vu(){return this.A_}Bu(){return this.z_}Iu(){return this.L_}_u(){return this.R_||0}Eu(t,e){const i=t.f_(),s=e&&this.Ps.rightOffsetPixels||0;this.wu((this.Mo-s)/i),this.U_=t.bi()-this._u(),e&&(this.U_=s?s/this.mu():this.Ps.rightOffset),this.ou(),this.E_=!0,this.ts.vu(),this.ts.ar()}Au(){const t=this.ru(),e=this.hu();null!==t&&null!==e&&this.Eu(new ed(t,e),!0)}zu(t){const e=new ed(t.from,t.to);this.Eu(e)}ns(t){return void 0!==this.bl.timeFormatter?this.bl.timeFormatter(t.originalTime):this.o_.formatHorzItem(t.time)}K_(){if(!this.Ps.ignoreWhitespaceIndices)return;this.F_.clear();const t=this.ts.js();for(const e of t)for(const t of e.va())this.F_.set(t,!0);this.W_++}Mu(){const t=this.ts.N().handleScroll,e=this.ts.N().handleScale;return!(t.horzTouchDrag||t.mouseWheel||t.pressedMouseMove||t.vertTouchDrag||e.axisDoubleClickReset.time||e.axisPressedMouseMove.time||e.mouseWheel||e.pinch)}ru(){return 0===this.D_.length?null:0}hu(){return 0===this.D_.length?null:this.D_.length-1}Lu(t){return(this.Mo-1-t)/this.q_}du(t){const e=this.Lu(t),i=this._u()+this.U_-e;return Math.round(1e6*i)/1e6}wu(t){const e=this.q_;this.q_=t,this.lu(),e!==this.q_&&(this.E_=!0,this.Ou())}iu(){if(!this.E_)return;if(this.E_=!1,this.Ki())return void this.Nu(od.T_());const t=this._u(),e=this.Mo/this.q_,i=this.U_+t,s=new ed(i-e+1,i);this.Nu(new od(s))}lu(){const t=zc(this.q_,this.Fu(),this.Wu());this.q_!==t&&(this.q_=t,this.E_=!0)}Wu(){return this.Ps.maxBarSpacing>0?this.Ps.maxBarSpacing:.5*this.Mo}Fu(){return this.Ps.fixLeftEdge&&this.Ps.fixRightEdge&&0!==this.D_.length?this.Mo/this.D_.length:this.Ps.minBarSpacing}ou(){const t=this.Hu();null!==t&&this.U_<t&&(this.U_=t,this.E_=!0);const e=this.Uu();this.U_>e&&(this.U_=e,this.E_=!0)}Hu(){const t=this.ru(),e=this.R_;return null===t||null===e?null:t-e-1+(this.Ps.fixLeftEdge?this.Mo/this.q_:Math.min(2,this.D_.length))}Uu(){return this.Ps.fixRightEdge?0:this.Mo/this.q_-Math.min(2,this.D_.length)}Pu(){this.O_={mu:this.mu(),gu:this.gu()}}yu(){this.O_=null}bu(t){let e=this.B_.get(t.weight);return void 0===e&&(e=new td(t=>this.$u(t),this.o_),this.B_.set(t.weight,e)),e.__(t)}$u(t){return this.o_.formatTickmark(t,this.bl)}Nu(t){const e=this.I_;this.I_=t,id(e.y_(),this.I_.y_())||this.A_.p(),id(e.k_(),this.I_.k_())||this.z_.p(),this.Ou()}Ou(){this.N_=null}Z_(){this.Ou(),this.B_.clear()}j_(){this.o_.updateFormatter(this.bl)}G_(){if(!this.Ps.fixLeftEdge)return;const t=this.ru();if(null===t)return;const e=this.Pe();if(null===e)return;const i=e.Uh()-t;if(i<0){const t=this.U_-i-1;this.fn(t)}this.lu()}J_(){this.ou(),this.lu()}fu(t){return!this.Ps.ignoreWhitespaceIndices||this.F_.get(t)||!1}pu(t){const e=function*(t){const e=Math.round(t),i=e<t;let s=1;for(;;)i?(yield e+s,yield e-s):(yield e-s,yield e+s),s++}(t),i=this.hu();for(;i;){const t=e.next().value;if(this.F_.get(t))return t;if(t<0||t>i)break}return t}Y_(t){if(void 0!==t.rightOffsetPixels){const e=t.rightOffsetPixels/(t.barSpacing||this.q_);this.ts.fn(e)}}}var ad,ld,hd,cd,dd;!function(t){t[t.OnTouchEnd=0]="OnTouchEnd",t[t.OnNextTap=1]="OnNextTap"}(ad||(ad={}));class ud{constructor(t,e,i){this.qu=[],this.Yu=[],this.Mo=0,this.ju=null,this.Ku=new Ul,this.Xu=new Ul,this.Zu=null,this.Gu=t,this.Ps=e,this.o_=i,this.Sl=new sh(this.Ps.layout.colorParsers),this.Ju=new th(this),this.uh=new nd(this,e.timeScale,this.Ps.localization,i),this.Ct=new Ch(this,e.crosshair),this.Qu=new Sc(e.crosshair),e.addDefaultPane&&(this.tc(0),this.qu[0].Io(2)),this.sc=this.nc(0),this.ec=this.nc(1)}Ih(){this.rc(zh.gn())}ar(){this.rc(zh.wn())}Zh(){this.rc(new zh(1))}Eh(t){const e=this.hc(t);this.rc(e)}ac(){return this.ju}lc(t){if(this.ju?.n_===t?.n_&&this.ju?.e_?.Kn===t?.e_?.Kn)return;const e=this.ju;this.ju=t,null!==e&&this.Eh(e.n_),null!==t&&t.n_!==e?.n_&&this.Eh(t.n_)}N(){return this.Ps}hr(t){Wl(this.Ps,t),this.qu.forEach(e=>e.Ro(t)),void 0!==t.timeScale&&this.uh.hr(t.timeScale),void 0!==t.localization&&this.uh.X_(t.localization),(t.leftPriceScale||t.rightPriceScale)&&this.Ku.p(),this.sc=this.nc(0),this.ec=this.nc(1),this.Ih()}oc(t,e,i=0){const s=this.qu[i];if(void 0===s)return;if("left"===t)return Wl(this.Ps,{leftPriceScale:e}),s.Ro({leftPriceScale:e}),this.Ku.p(),void this.Ih();if("right"===t)return Wl(this.Ps,{rightPriceScale:e}),s.Ro({rightPriceScale:e}),this.Ku.p(),void this.Ih();const o=this._c(t,i);null!==o&&(o.Ft.hr(e),this.Ku.p())}_c(t,e){const i=this.qu[e];if(void 0===i)return null;const s=i.Do(t);return null!==s?{Us:i,Ft:s}:null}Et(){return this.uh}$s(){return this.qu}uc(){return this.Ct}cc(){return this.Xu}dc(t,e){t.Al(e),this.vu()}Eo(t){this.Mo=t,this.uh.Eo(this.Mo),this.qu.forEach(e=>e.Eo(t)),this.vu()}fc(t){1!==this.qu.length&&(Rl(t>=0&&t<this.qu.length,"Invalid pane index"),this.qu.splice(t,1),this.Ih())}vc(t,e){if(this.qu.length<2)return;Rl(t>=0&&t<this.qu.length,"Invalid pane index");const i=this.qu[t],s=this.qu.reduce((t,e)=>t+e.Bo(),0),o=this.qu.reduce((t,e)=>t+e.$t(),0),r=o-30*(this.qu.length-1);e=Math.min(r,Math.max(30,e));const n=s/o,a=i.$t();i.Io(e*n);let l=e-a,h=this.qu.length-1;for(const t of this.qu)if(t!==i){const e=Math.min(r,Math.max(30,t.$t()-l/h));l-=t.$t()-e,h-=1;const i=e*n;t.Io(i)}this.Ih()}mc(t,e){Rl(t>=0&&t<this.qu.length&&e>=0&&e<this.qu.length,"Invalid pane index");const i=this.qu[t],s=this.qu[e];this.qu[t]=s,this.qu[e]=i,this.Ih()}wc(t,e){if(Rl(t>=0&&t<this.qu.length&&e>=0&&e<this.qu.length,"Invalid pane index"),t===e)return;const[i]=this.qu.splice(t,1);this.qu.splice(e,0,i),this.Ih()}Uo(t,e,i){t.Uo(e,i)}$o(t,e,i){t.$o(e,i),this.Ah(),this.rc(this.gc(t,2))}qo(t,e){t.qo(e),this.rc(this.gc(t,2))}Yo(t,e,i){e.Tl()||t.Yo(e,i)}jo(t,e,i){e.Tl()||(t.jo(e,i),this.Ah(),this.rc(this.gc(t,2)))}Ko(t,e){e.Tl()||(t.Ko(e),this.rc(this.gc(t,2)))}Zo(t,e){t.Zo(e),this.rc(this.gc(t,2))}Mc(t){this.uh.no(t)}bc(t,e){const i=this.Et();if(i.Ki()||0===e)return;const s=i.Qi();t=Math.max(1,Math.min(t,s)),i.Cu(t,e),this.vu()}Sc(t){this.xc(0),this.Cc(t),this.Pc()}yc(t){this.uh.eo(t),this.vu()}kc(){this.uh.ro(),this.ar()}xc(t){this.uh.ho(t)}Cc(t){this.uh.ao(t),this.vu()}Pc(){this.uh.lo(),this.ar()}js(){return this.Yu}Tc(t,e,i,s,o){this.Ct.Vs(t,e);let r=NaN,n=this.uh.cu(t,!0);const a=this.uh.Pe();null!==a&&(n=Math.min(Math.max(a.Uh(),n),a.bi()));const l=s.ks(),h=l.zt();if(null!==h&&(r=l.Ts(e,h)),r=this.Qu.ga(r,n,s),this.Ct.As(n,r,s),this.Zh(),!o){const o=Zc(s,t,e);this.lc(o&&{n_:o.n_,e_:o.e_,h_:o.h_||null}),this.Xu.p(this.Ct.It(),{x:t,y:e},i)}}Rc(t,e,i){const s=i.ks(),o=s.zt(),r=s.Nt(t,Bl(o)),n=this.uh.Q_(e,!0),a=this.uh.qt(Bl(n));this.Tc(a,r,null,i,!0)}Dc(t){this.uc().Ls(),this.Zh(),t||this.Xu.p(null,null,null)}Ah(){const t=this.Ct.Us();if(null!==t){const e=this.Ct.Is(),i=this.Ct.Es();this.Tc(e,i,null,t)}this.Ct.Ns()}Vc(t,e,i){const s=this.uh.Rs(0);void 0!==e&&void 0!==i&&this.uh.yt(e,i);const o=this.uh.Rs(0),r=this.uh._u(),n=this.uh.Pe();if(null!==n&&null!==s&&null!==o){const e=n.Te(r),a=this.o_.key(s)>this.o_.key(o),l=null!==t&&t>r&&!a,h=this.uh.N().allowShiftVisibleRangeOnWhitespaceReplacement,c=e&&(!(void 0===i)||h)&&this.uh.N().shiftVisibleRangeOnNewBar;if(l&&!c){const e=t-r;this.uh.fn(this.uh.gu()-e)}}this.uh.xu(t)}Lh(t){null!==t&&t.Jo()}Hn(t){if(function(t){return t instanceof Kc}(t))return t;const e=this.qu.find(e=>e.Dt().includes(t));return void 0===e?null:e}vu(){this.qu.forEach(t=>t.Jo()),this.Ah()}m(){this.qu.forEach(t=>t.m()),this.qu.length=0,this.Ps.localization.priceFormatter=void 0,this.Ps.localization.percentageFormatter=void 0,this.Ps.localization.timeFormatter=void 0}Bc(){return this.Ju}Yn(){return this.Ju.N()}Vo(){return this.Ku}Ic(t,e){const i=this.tc(e);this.Ec(t,i),this.Yu.push(t),1===this.Yu.length?this.Ih():this.ar()}Ac(t){const e=this.Hn(t),i=this.Yu.indexOf(t);Rl(-1!==i,"Series not found");const s=Bl(e);this.Yu.splice(i,1),s.Ql(t),t.m&&t.m(),this.uh.K_(),this.zc(s)}Bh(t,e){const i=Bl(this.Hn(t));i.Ql(t,!0),i.Gl(t,e,!0)}Au(){const t=zh.wn();t.rn(),this.rc(t)}Lc(t){const e=zh.wn();e.ln(t),this.rc(e)}cn(){const t=zh.wn();t.cn(),this.rc(t)}dn(t){const e=zh.wn();e.dn(t),this.rc(e)}fn(t){const e=zh.wn();e.fn(t),this.rc(e)}_n(t){const e=zh.wn();e._n(t),this.rc(e)}hn(){const t=zh.wn();t.hn(),this.rc(t)}Oc(){return this.Ps.rightPriceScale.visible?"right":"left"}Nc(t,e){if(Rl(e>=0,"Index should be greater or equal to 0"),e===this.Fc(t))return;const i=Bl(this.Hn(t));i.Ql(t);const s=this.tc(e);this.Ec(t,s),0===i.Ma().length&&this.zc(i),this.Ih()}Wc(){return this.ec}$(){return this.sc}Ut(t){const e=this.ec,i=this.sc;if(e===i)return e;if(t=Math.max(0,Math.min(100,Math.round(100*t))),null===this.Zu||this.Zu.mr!==i||this.Zu.wr!==e)this.Zu={mr:i,wr:e,Hc:new Map};else{const e=this.Zu.Hc.get(t);if(void 0!==e)return e}const s=this.Sl.tt(i,e,t/100);return this.Zu.Hc.set(t,s),s}Uc(t){return this.qu.indexOf(t)}Xi(){return this.Sl}$c(){return this.qc()}qc(t){const e=new Kc(this.uh,this);this.qu.push(e);const i=t??this.qu.length-1,s=zh.gn();return s.Qs(i,{tn:0,sn:!0}),this.rc(s),e}tc(t){return Rl(t>=0,"Index should be greater or equal to 0"),(t=Math.min(this.qu.length,t))<this.qu.length?this.qu[t]:this.qc(t)}Fc(t){return this.qu.findIndex(e=>e.Oo().includes(t))}gc(t,e){const i=new zh(e);if(null!==t){const s=this.qu.indexOf(t);i.Qs(s,{tn:e})}return i}hc(t,e){return void 0===e&&(e=2),this.gc(this.Hn(t),e)}rc(t){this.Gu&&this.Gu(t),this.qu.forEach(t=>t.i_().lr().yt())}Ec(t,e){const i=t.N().priceScaleId,s=void 0!==i?i:this.Oc();e.Gl(t,s),Sh(s)||t.hr(t.N())}nc(t){const e=this.Ps.layout;return"gradient"===e.background.type?0===t?e.background.topColor:e.background.bottomColor:e.background.color}zc(t){!t.Lo()&&0===t.Ma().length&&this.qu.length>1&&this.qu.splice(this.Uc(t),1)}}function pd(t){if(t>=1)return 0;let e=0;for(;e<8;e++){const i=Math.round(t);if(Math.abs(i-t)<1e-8)return e;t*=10}return e}function fd(t){return!Yl(t)&&!jl(t)}function md(t){return Yl(t)}!function(t){t[t.Disabled=0]="Disabled",t[t.Continuous=1]="Continuous",t[t.OnDataUpdate=2]="OnDataUpdate"}(ld||(ld={})),function(t){t[t.LastBar=0]="LastBar",t[t.LastVisible=1]="LastVisible"}(hd||(hd={})),function(t){t.Solid="solid",t.VerticalGradient="gradient"}(cd||(cd={})),function(t){t[t.Year=0]="Year",t[t.Month=1]="Month",t[t.DayOfMonth=2]="DayOfMonth",t[t.Time=3]="Time",t[t.TimeWithSeconds=4]="TimeWithSeconds"}(dd||(dd={}));const gd=t=>t.getUTCFullYear();class bd{constructor(t="yyyy-MM-dd",e="default"){this.Yc=t,this.jc=e}__(t){return function(t,e,i){return e.replace(/yyyy/g,(t=>Eh(gd(t),4))(t)).replace(/yy/g,(t=>Eh(gd(t)%100,2))(t)).replace(/MMMM/g,((t,e)=>new Date(t.getUTCFullYear(),t.getUTCMonth(),1).toLocaleString(e,{month:"long"}))(t,i)).replace(/MMM/g,((t,e)=>new Date(t.getUTCFullYear(),t.getUTCMonth(),1).toLocaleString(e,{month:"short"}))(t,i)).replace(/MM/g,(t=>Eh((t=>t.getUTCMonth()+1)(t),2))(t)).replace(/dd/g,(t=>Eh((t=>t.getUTCDate())(t),2))(t))}(t,this.Yc,this.jc)}}class vd{constructor(t){this.Kc=t||"%h:%m:%s"}__(t){return this.Kc.replace("%h",Eh(t.getUTCHours(),2)).replace("%m",Eh(t.getUTCMinutes(),2)).replace("%s",Eh(t.getUTCSeconds(),2))}}const yd={Xc:"yyyy-MM-dd",Zc:"%h:%m:%s",Gc:" ",Jc:"default"};class wd{constructor(t={}){const e={...yd,...t};this.Qc=new bd(e.Xc,e.Jc),this.td=new vd(e.Zc),this.sd=e.Gc}__(t){return`${this.Qc.__(t)}${this.sd}${this.td.__(t)}`}}function _d(t){return 60*t*60*1e3}function xd(t){return 60*t*1e3}const kd=[{nd:1e3,ed:10},{nd:xd(1),ed:20},{nd:xd(5),ed:21},{nd:xd(30),ed:22},{nd:_d(1),ed:30},{nd:_d(3),ed:31},{nd:_d(6),ed:32},{nd:_d(12),ed:33}];function Cd(t,e){if(t.getUTCFullYear()!==e.getUTCFullYear())return 70;if(t.getUTCMonth()!==e.getUTCMonth())return 60;if(t.getUTCDate()!==e.getUTCDate())return 50;for(let i=kd.length-1;i>=0;--i)if(Math.floor(e.getTime()/kd[i].nd)!==Math.floor(t.getTime()/kd[i].nd))return kd[i].ed;return 0}function Sd(t){let e=t;if(jl(t)&&(e=$d(t)),!fd(e))throw new Error("time must be of type BusinessDay");const i=new Date(Date.UTC(e.year,e.month-1,e.day,0,0,0,0));return{rd:Math.round(i.getTime()/1e3),hd:e}}function zd(t){if(!md(t))throw new Error("time must be of type isUTCTimestamp");return{rd:t}}function $d(t){const e=new Date(t);if(isNaN(e.getTime()))throw new Error(`Invalid date string=${t}, expected format=yyyy-mm-dd`);return{day:e.getUTCDate(),month:e.getUTCMonth()+1,year:e.getUTCFullYear()}}function Ed(t){jl(t.time)&&(t.time=$d(t.time))}class Md{options(){return this.Ps}setOptions(t){this.Ps=t,this.updateFormatter(t.localization)}preprocessData(t){Array.isArray(t)?function(t){t.forEach(Ed)}(t):Ed(t)}createConverterToInternalObj(t){return Bl(function(t){return 0===t.length?null:fd(t[0].time)||jl(t[0].time)?Sd:zd}(t))}key(t){return"object"==typeof t&&"rd"in t?t.rd:this.key(this.convertHorzItemToInternal(t))}cacheKey(t){const e=t;return void 0===e.hd?new Date(1e3*e.rd).getTime():new Date(Date.UTC(e.hd.year,e.hd.month-1,e.hd.day)).getTime()}convertHorzItemToInternal(t){return md(e=t)?zd(e):fd(e)?Sd(e):Sd($d(e));var e}updateFormatter(t){if(!this.Ps)return;const e=t.dateFormat;this.Ps.timeScale.timeVisible?this.ad=new wd({Xc:e,Zc:this.Ps.timeScale.secondsVisible?"%h:%m:%s":"%h:%m",Gc:"   ",Jc:t.locale}):this.ad=new bd(e,t.locale)}formatHorzItem(t){const e=t;return this.ad.__(new Date(1e3*e.rd))}formatTickmark(t,e){const i=function(t,e,i){switch(t){case 0:case 10:return e?i?4:3:2;case 20:case 21:case 22:case 30:case 31:case 32:case 33:return e?3:2;case 50:return 2;case 60:return 1;case 70:return 0}}(t.weight,this.Ps.timeScale.timeVisible,this.Ps.timeScale.secondsVisible),s=this.Ps.timeScale;if(void 0!==s.tickMarkFormatter){const o=s.tickMarkFormatter(t.originalTime,i,e.locale);if(null!==o)return o}return function(t,e,i){const s={};switch(e){case 0:s.year="numeric";break;case 1:s.month="short";break;case 2:s.day="numeric";break;case 3:s.hour12=!1,s.hour="2-digit",s.minute="2-digit";break;case 4:s.hour12=!1,s.hour="2-digit",s.minute="2-digit",s.second="2-digit"}const o=void 0===t.hd?new Date(1e3*t.rd):new Date(Date.UTC(t.hd.year,t.hd.month-1,t.hd.day));return new Date(o.getUTCFullYear(),o.getUTCMonth(),o.getUTCDate(),o.getUTCHours(),o.getUTCMinutes(),o.getUTCSeconds(),o.getUTCMilliseconds()).toLocaleString(i,s)}(t.time,i,e.locale)}maxTickMarkWeight(t){let e=t.reduce(rd,t[0]).weight;return e>30&&e<50&&(e=30),e}fillWeightsForPoints(t,e){!function(t,e=0){if(0===t.length)return;let i=0===e?null:t[e-1].time.rd,s=null!==i?new Date(1e3*i):null,o=0;for(let r=e;r<t.length;++r){const e=t[r],n=new Date(1e3*e.time.rd);null!==s&&(e.timeWeight=Cd(n,s)),o+=e.time.rd-(i||e.time.rd),i=e.time.rd,s=n}if(0===e&&t.length>1){const e=Math.ceil(o/(t.length-1)),i=new Date(1e3*(t[0].time.rd-e));t[0].timeWeight=Cd(new Date(1e3*t[0].time.rd),i)}}(t,e)}static ld(t){return Wl({localization:{dateFormat:"dd MMM 'yy"}},t??{})}}const Pd="undefined"!=typeof window;function Td(){return!!Pd&&window.navigator.userAgent.toLowerCase().indexOf("firefox")>-1}function Ad(){return!!Pd&&/iPhone|iPad|iPod/.test(window.navigator.platform)}function Ld(t){return t+t%2}class Dd{constructor(t,e,i){this.od=0,this._d=null,this.ud={_t:Number.NEGATIVE_INFINITY,ut:Number.POSITIVE_INFINITY},this.dd=0,this.fd=null,this.pd={_t:Number.NEGATIVE_INFINITY,ut:Number.POSITIVE_INFINITY},this.vd=null,this.md=!1,this.wd=null,this.gd=null,this.Md=!1,this.bd=!1,this.Sd=!1,this.xd=null,this.Cd=null,this.Pd=null,this.yd=null,this.kd=null,this.Td=null,this.Rd=null,this.Dd=0,this.Vd=!1,this.Bd=!1,this.Id=!1,this.Ed=0,this.Ad=null,this.zd=!Ad(),this.Ld=t=>{this.Od(t)},this.Nd=t=>{if(this.Fd(t)){const e=this.Wd(t);if(++this.dd,this.fd&&this.dd>1){const{Hd:i}=this.Ud(Vd(t),this.pd);i<30&&!this.Sd&&this.$d(e,this.Yd.qd),this.jd()}}else{const e=this.Wd(t);if(++this.od,this._d&&this.od>1){const{Hd:i}=this.Ud(Vd(t),this.ud);i<5&&!this.bd&&this.Kd(e,this.Yd.Xd),this.Zd()}}},this.Gd=t,this.Yd=e,this.Ps=i,this.Jd()}m(){null!==this.xd&&(this.xd(),this.xd=null),null!==this.Cd&&(this.Cd(),this.Cd=null),null!==this.yd&&(this.yd(),this.yd=null),null!==this.kd&&(this.kd(),this.kd=null),null!==this.Td&&(this.Td(),this.Td=null),null!==this.Pd&&(this.Pd(),this.Pd=null),this.Qd(),this.Zd()}tf(t){this.yd&&this.yd();const e=this.if.bind(this);if(this.yd=()=>{this.Gd.removeEventListener("mousemove",e)},this.Gd.addEventListener("mousemove",e),this.Fd(t))return;const i=this.Wd(t);this.Kd(i,this.Yd.sf),this.zd=!0}Zd(){null!==this._d&&clearTimeout(this._d),this.od=0,this._d=null,this.ud={_t:Number.NEGATIVE_INFINITY,ut:Number.POSITIVE_INFINITY}}jd(){null!==this.fd&&clearTimeout(this.fd),this.dd=0,this.fd=null,this.pd={_t:Number.NEGATIVE_INFINITY,ut:Number.POSITIVE_INFINITY}}if(t){if(this.Id||null!==this.gd)return;if(this.Fd(t))return;const e=this.Wd(t);this.Kd(e,this.Yd.nf),this.zd=!0}ef(t){const e=Rd(t.changedTouches,Bl(this.Ad));if(null===e)return;if(this.Ed=Fd(t),null!==this.Rd)return;if(this.Bd)return;this.Vd=!0;const i=this.Ud(Vd(e),Bl(this.gd)),{rf:s,hf:o,Hd:r}=i;if(this.Md||!(r<5)){if(!this.Md){const t=.5*s,e=o>=t&&!this.Ps.af(),i=t>o&&!this.Ps.lf();e||i||(this.Bd=!0),this.Md=!0,this.Sd=!0,this.Qd(),this.jd()}if(!this.Bd){const i=this.Wd(t,e);this.$d(i,this.Yd._f),Id(t)}}}uf(t){if(0!==t.button)return;const e=this.Ud(Vd(t),Bl(this.wd)),{Hd:i}=e;if(i>=5&&(this.bd=!0,this.Zd()),this.bd){const e=this.Wd(t);this.Kd(e,this.Yd.cf)}}Ud(t,e){const i=Math.abs(e._t-t._t),s=Math.abs(e.ut-t.ut);return{rf:i,hf:s,Hd:i+s}}df(t){let e=Rd(t.changedTouches,Bl(this.Ad));if(null===e&&0===t.touches.length&&(e=t.changedTouches[0]),null===e)return;this.Ad=null,this.Ed=Fd(t),this.Qd(),this.gd=null,this.Td&&(this.Td(),this.Td=null);const i=this.Wd(t,e);if(this.$d(i,this.Yd.ff),++this.dd,this.fd&&this.dd>1){const{Hd:t}=this.Ud(Vd(e),this.pd);t<30&&!this.Sd&&this.$d(i,this.Yd.qd),this.jd()}else this.Sd||(this.$d(i,this.Yd.pf),this.Yd.pf&&Id(t));0===this.dd&&Id(t),0===t.touches.length&&this.md&&(this.md=!1,Id(t))}Od(t){if(0!==t.button)return;const e=this.Wd(t);if(this.wd=null,this.Id=!1,this.kd&&(this.kd(),this.kd=null),Td()&&this.Gd.ownerDocument.documentElement.removeEventListener("mouseleave",this.Ld),!this.Fd(t))if(this.Kd(e,this.Yd.vf),++this.od,this._d&&this.od>1){const{Hd:i}=this.Ud(Vd(t),this.ud);i<5&&!this.bd&&this.Kd(e,this.Yd.Xd),this.Zd()}else this.bd||this.Kd(e,this.Yd.mf)}Qd(){null!==this.vd&&(clearTimeout(this.vd),this.vd=null)}wf(t){if(null!==this.Ad)return;const e=t.changedTouches[0];this.Ad=e.identifier,this.Ed=Fd(t);const i=this.Gd.ownerDocument.documentElement;this.Sd=!1,this.Md=!1,this.Bd=!1,this.gd=Vd(e),this.Td&&(this.Td(),this.Td=null);{const e=this.ef.bind(this),s=this.df.bind(this);this.Td=()=>{i.removeEventListener("touchmove",e),i.removeEventListener("touchend",s)},i.addEventListener("touchmove",e,{passive:!1}),i.addEventListener("touchend",s,{passive:!1}),this.Qd(),this.vd=setTimeout(this.gf.bind(this,t),240)}const s=this.Wd(t,e);this.$d(s,this.Yd.Mf),this.fd||(this.dd=0,this.fd=setTimeout(this.jd.bind(this),500),this.pd=Vd(e))}bf(t){if(0!==t.button)return;const e=this.Gd.ownerDocument.documentElement;Td()&&e.addEventListener("mouseleave",this.Ld),this.bd=!1,this.wd=Vd(t),this.kd&&(this.kd(),this.kd=null);{const t=this.uf.bind(this),i=this.Od.bind(this);this.kd=()=>{e.removeEventListener("mousemove",t),e.removeEventListener("mouseup",i)},e.addEventListener("mousemove",t),e.addEventListener("mouseup",i)}if(this.Id=!0,this.Fd(t))return;const i=this.Wd(t);this.Kd(i,this.Yd.Sf),this._d||(this.od=0,this._d=setTimeout(this.Zd.bind(this),500),this.ud=Vd(t))}Jd(){this.Gd.addEventListener("mouseenter",this.tf.bind(this)),this.Gd.addEventListener("touchcancel",this.Qd.bind(this));{const t=this.Gd.ownerDocument,e=t=>{this.Yd.xf&&(t.composed&&this.Gd.contains(t.composedPath()[0])||t.target&&this.Gd.contains(t.target)||this.Yd.xf())};this.Cd=()=>{t.removeEventListener("touchstart",e)},this.xd=()=>{t.removeEventListener("mousedown",e)},t.addEventListener("mousedown",e),t.addEventListener("touchstart",e,{passive:!0})}Ad()&&(this.Pd=()=>{this.Gd.removeEventListener("dblclick",this.Nd)},this.Gd.addEventListener("dblclick",this.Nd)),this.Gd.addEventListener("mouseleave",this.Cf.bind(this)),this.Gd.addEventListener("touchstart",this.wf.bind(this),{passive:!0}),function(t){Pd&&void 0!==window.chrome&&t.addEventListener("mousedown",t=>{if(1===t.button)return t.preventDefault(),!1})}(this.Gd),this.Gd.addEventListener("mousedown",this.bf.bind(this)),this.Pf(),this.Gd.addEventListener("touchmove",()=>{},{passive:!1})}Pf(){void 0===this.Yd.yf&&void 0===this.Yd.kf&&void 0===this.Yd.Tf||(this.Gd.addEventListener("touchstart",t=>this.Rf(t.touches),{passive:!0}),this.Gd.addEventListener("touchmove",t=>{if(2===t.touches.length&&null!==this.Rd&&void 0!==this.Yd.kf){const e=Od(t.touches[0],t.touches[1])/this.Dd;this.Yd.kf(this.Rd,e),Id(t)}},{passive:!1}),this.Gd.addEventListener("touchend",t=>{this.Rf(t.touches)}))}Rf(t){1===t.length&&(this.Vd=!1),2!==t.length||this.Vd||this.md?this.Df():this.Vf(t)}Vf(t){const e=this.Gd.getBoundingClientRect()||{left:0,top:0};this.Rd={_t:(t[0].clientX-e.left+(t[1].clientX-e.left))/2,ut:(t[0].clientY-e.top+(t[1].clientY-e.top))/2},this.Dd=Od(t[0],t[1]),void 0!==this.Yd.yf&&this.Yd.yf(),this.Qd()}Df(){null!==this.Rd&&(this.Rd=null,void 0!==this.Yd.Tf&&this.Yd.Tf())}Cf(t){if(this.yd&&this.yd(),this.Fd(t))return;if(!this.zd)return;const e=this.Wd(t);this.Kd(e,this.Yd.Bf),this.zd=!Ad()}gf(t){const e=Rd(t.touches,Bl(this.Ad));if(null===e)return;const i=this.Wd(t,e);this.$d(i,this.Yd.If),this.Sd=!0,this.md=!0}Fd(t){return t.sourceCapabilities&&void 0!==t.sourceCapabilities.firesTouchEvents?t.sourceCapabilities.firesTouchEvents:Fd(t)<this.Ed+500}$d(t,e){e&&e.call(this.Yd,t)}Kd(t,e){e&&e.call(this.Yd,t)}Wd(t,e){const i=e||t,s=this.Gd.getBoundingClientRect()||{left:0,top:0};return{clientX:i.clientX,clientY:i.clientY,pageX:i.pageX,pageY:i.pageY,screenX:i.screenX,screenY:i.screenY,localX:i.clientX-s.left,localY:i.clientY-s.top,ctrlKey:t.ctrlKey,altKey:t.altKey,shiftKey:t.shiftKey,metaKey:t.metaKey,Ef:!t.type.startsWith("mouse")&&"contextmenu"!==t.type&&"click"!==t.type,Af:t.type,zf:i.target,a_:t.view,Lf:()=>{"touchstart"!==t.type&&Id(t)}}}}function Od(t,e){const i=t.clientX-e.clientX,s=t.clientY-e.clientY;return Math.sqrt(i*i+s*s)}function Id(t){t.cancelable&&t.preventDefault()}function Vd(t){return{_t:t.pageX,ut:t.pageY}}function Fd(t){return t.timeStamp||performance.now()}function Rd(t,e){for(let i=0;i<t.length;++i)if(t[i].identifier===e)return t[i];return null}class Nd{constructor(t,e,i){this.Of=null,this.Nf=null,this.Ff=!0,this.Wf=null,this.Hf=t,this.Uf=t.$f()[e],this.qf=t.$f()[i],this.Yf=document.createElement("tr"),this.Yf.style.height="1px",this.jf=document.createElement("td"),this.jf.style.position="relative",this.jf.style.padding="0",this.jf.style.margin="0",this.jf.setAttribute("colspan","3"),this.Kf(),this.Yf.appendChild(this.jf),this.Ff=this.Hf.N().layout.panes.enableResize,this.Ff?this.Xf():(this.Of=null,this.Nf=null)}m(){null!==this.Nf&&this.Nf.m()}Zf(){return this.Yf}Gf(){return $l({width:this.Uf.Gf().width,height:1})}Jf(){return $l({width:this.Uf.Jf().width,height:1*window.devicePixelRatio})}Qf(t,e,i){const s=this.Jf();t.fillStyle=this.Hf.N().layout.panes.separatorColor,t.fillRect(e,i,s.width,s.height)}yt(){this.Kf(),this.Hf.N().layout.panes.enableResize!==this.Ff&&(this.Ff=this.Hf.N().layout.panes.enableResize,this.Ff?this.Xf():(null!==this.Of&&(this.jf.removeChild(this.Of.tp),this.jf.removeChild(this.Of.ip),this.Of=null),null!==this.Nf&&(this.Nf.m(),this.Nf=null)))}Xf(){const t=document.createElement("div"),e=t.style;e.position="fixed",e.display="none",e.zIndex="49",e.top="0",e.left="0",e.width="100%",e.height="100%",e.cursor="row-resize",this.jf.appendChild(t);const i=document.createElement("div"),s=i.style;s.position="absolute",s.zIndex="50",s.top="-4px",s.height="9px",s.width="100%",s.backgroundColor="",s.cursor="row-resize",this.jf.appendChild(i);const o={sf:this.sp.bind(this),Bf:this.np.bind(this),Sf:this.ep.bind(this),Mf:this.ep.bind(this),cf:this.rp.bind(this),_f:this.rp.bind(this),vf:this.hp.bind(this),ff:this.hp.bind(this)};this.Nf=new Dd(i,o,{af:()=>!1,lf:()=>!0}),this.Of={ip:i,tp:t}}Kf(){this.jf.style.background=this.Hf.N().layout.panes.separatorColor}sp(t){null!==this.Of&&(this.Of.ip.style.backgroundColor=this.Hf.N().layout.panes.separatorHoverColor)}np(t){null!==this.Of&&null===this.Wf&&(this.Of.ip.style.backgroundColor="")}ep(t){if(null===this.Of)return;const e=this.Uf.ap().Bo()+this.qf.ap().Bo(),i=e/(this.Uf.Gf().height+this.qf.Gf().height),s=30*i;e<=2*s||(this.Wf={lp:t.pageY,op:this.Uf.ap().Bo(),_p:e-s,up:e,cp:i,dp:s},this.Of.tp.style.display="block")}rp(t){const e=this.Wf;if(null===e)return;const i=(t.pageY-e.lp)*e.cp,s=zc(e.op+i,e.dp,e._p);this.Uf.ap().Io(s),this.qf.ap().Io(e.up-s),this.Hf.Qt().Ih()}hp(t){null!==this.Wf&&null!==this.Of&&(this.Wf=null,this.Of.tp.style.display="none")}}function Bd(t,e){return t.fp-e.fp}function Hd(t,e,i){const s=(t.fp-e.fp)/(t.wt-e.wt);return Math.sign(s)*Math.min(Math.abs(s),i)}class Ud{constructor(t,e,i,s){this.pp=null,this.vp=null,this.mp=null,this.wp=null,this.gp=null,this.Mp=0,this.bp=0,this.Sp=t,this.xp=e,this.Cp=i,this.Mn=s}Pp(t,e){if(null!==this.pp){if(this.pp.wt===e)return void(this.pp.fp=t);if(Math.abs(this.pp.fp-t)<this.Mn)return}this.wp=this.mp,this.mp=this.vp,this.vp=this.pp,this.pp={wt:e,fp:t}}le(t,e){if(null===this.pp||null===this.vp)return;if(e-this.pp.wt>50)return;let i=0;const s=Hd(this.pp,this.vp,this.xp),o=Bd(this.pp,this.vp),r=[s],n=[o];if(i+=o,null!==this.mp){const t=Hd(this.vp,this.mp,this.xp);if(Math.sign(t)===Math.sign(s)){const e=Bd(this.vp,this.mp);if(r.push(t),n.push(e),i+=e,null!==this.wp){const t=Hd(this.mp,this.wp,this.xp);if(Math.sign(t)===Math.sign(s)){const e=Bd(this.mp,this.wp);r.push(t),n.push(e),i+=e}}}}let a=0;for(let t=0;t<r.length;++t)a+=n[t]/i*r[t];Math.abs(a)<this.Sp||(this.gp={fp:t,wt:e},this.bp=a,this.Mp=function(t,e){const i=Math.log(e);return Math.log(1*i/-t)/i}(Math.abs(a),this.Cp))}Du(t){const e=Bl(this.gp),i=t-e.wt;return e.fp+this.bp*(Math.pow(this.Cp,i)-1)/Math.log(this.Cp)}Ru(t){return null===this.gp||this.yp(t)===this.Mp}yp(t){const e=t-Bl(this.gp).wt;return Math.min(e,this.Mp)}}class Wd{constructor(t,e){this.kp=void 0,this.Tp=void 0,this.Rp=void 0,this.ps=!1,this.Dp=t,this.Vp=e,this.Bp()}yt(){this.Bp()}Ip(){this.kp&&this.Dp.removeChild(this.kp),this.Tp&&this.Dp.removeChild(this.Tp),this.kp=void 0,this.Tp=void 0}Ep(){return this.ps!==this.Ap()||this.Rp!==this.zp()}zp(){return this.Vp.Qt().Xi().J(this.Vp.N().layout.textColor)>160?"dark":"light"}Ap(){return this.Vp.N().layout.attributionLogo}Lp(){const t=new URL(location.href);return t.hostname?"&utm_source="+t.hostname+t.pathname:""}Bp(){this.Ep()&&(this.Ip(),this.ps=this.Ap(),this.ps&&(this.Rp=this.zp(),this.Tp=document.createElement("style"),this.Tp.innerText="a#tv-attr-logo{--fill:#131722;--stroke:#fff;position:absolute;left:10px;bottom:10px;height:19px;width:35px;margin:0;padding:0;border:0;z-index:3;}a#tv-attr-logo[data-dark]{--fill:#D1D4DC;--stroke:#131722;}",this.kp=document.createElement("a"),this.kp.href=`https://www.tradingview.com/?utm_medium=lwc-link&utm_campaign=lwc-chart${this.Lp()}`,this.kp.title="Charting by TradingView",this.kp.id="tv-attr-logo",this.kp.target="_blank",this.kp.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="35" height="19" fill="none"><g fill-rule="evenodd" clip-path="url(#a)" clip-rule="evenodd"><path fill="var(--stroke)" d="M2 0H0v10h6v9h21.4l.5-1.3 6-15 1-2.7H23.7l-.5 1.3-.2.6a5 5 0 0 0-7-.9V0H2Zm20 17h4l5.2-13 .8-2h-7l-1 2.5-.2.5-1.5 3.8-.3.7V17Zm-.8-10a3 3 0 0 0 .7-2.7A3 3 0 1 0 16.8 7h4.4ZM14 7V2H2v6h6v9h4V7h2Z"/><path fill="var(--fill)" d="M14 2H2v6h6v9h6V2Zm12 15h-7l6-15h7l-6 15Zm-7-9a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/></g><defs><clipPath id="a"><path fill="var(--stroke)" d="M0 0h35v19H0z"/></clipPath></defs></svg>',this.kp.toggleAttribute("data-dark","dark"===this.Rp),this.Dp.appendChild(this.Tp),this.Dp.appendChild(this.kp)))}}function Yd(t,e){const i=Bl(t.ownerDocument).createElement("canvas");t.appendChild(i);const s=function(t,e){if("device-pixel-content-box"===e.type)return new Pl(t,e.transform,e.options);throw new Error("Unsupported binding target")}(i,{type:"device-pixel-content-box",options:{allowResizeObserver:!0},transform:(t,e)=>({width:Math.max(t.width,e.width),height:Math.max(t.height,e.height)})});return s.resizeCanvasElement(e),s}function qd(t){t.width=1,t.height=1,t.getContext("2d")?.clearRect(0,0,1,1)}function jd(t,e,i,s){t.ih&&t.ih(e,i,s)}function Gd(t,e,i,s){t.nt(e,i,s)}function Kd(t,e,i,s){const o=t(i,s);for(const t of o){const i=t.Tt(s);null!==i&&e(i)}}function Qd(t,e){return i=>function(t){return void 0!==t.Ft}(i)?(i.Ft()?.ma()??"")!==e?[]:i.ta?.(t)??[]:[]}function Jd(t,e,i,s){if(!t.length)return;let o=0;const r=t[0].$t(s,!0);let n=1===e?i/2-(t[0].Fi()-r/2):t[0].Fi()-r/2-i/2;n=Math.max(0,n);for(let r=1;r<t.length;r++){const a=t[r],l=t[r-1],h=l.$t(s,!1),c=a.Fi(),d=l.Fi();if(1===e?c>d-h:c<d+h){const s=d-h*e;a.Wi(s);const r=s-e*h/2;if((1===e?r<0:r>i)&&n>0){const s=1===e?-1-r:r-i,a=Math.min(s,n);for(let i=o;i<t.length;i++)t[i].Wi(t[i].Fi()+e*a);n-=a}}else o=r,n=1===e?d-h-c:c-(d+h)}}class Xd{constructor(t,e,i,s){this.Yi=null,this.Op=null,this.Np=!1,this.Fp=new Lh(200),this.Wp=null,this.Hp=0,this.Up=!1,this.$p=()=>{this.Up||this.Pt.qp().Qt().ar()},this.Yp=()=>{this.Up||this.Pt.qp().Qt().ar()},this.Pt=t,this.Ps=e,this.Ml=e.layout,this.Ju=i,this.jp="left"===s,this.Kp=Qd("normal",s),this.Xp=Qd("top",s),this.Zp=Qd("bottom",s),this.jf=document.createElement("div"),this.jf.style.height="100%",this.jf.style.overflow="hidden",this.jf.style.width="25px",this.jf.style.left="0",this.jf.style.position="relative",this.Gp=Yd(this.jf,$l({width:16,height:16})),this.Gp.subscribeSuggestedBitmapSizeChanged(this.$p);const o=this.Gp.canvasElement;o.style.position="absolute",o.style.zIndex="1",o.style.left="0",o.style.top="0",this.Jp=Yd(this.jf,$l({width:16,height:16})),this.Jp.subscribeSuggestedBitmapSizeChanged(this.Yp);const r=this.Jp.canvasElement;r.style.position="absolute",r.style.zIndex="2",r.style.left="0",r.style.top="0";const n={Sf:this.ep.bind(this),Mf:this.ep.bind(this),cf:this.rp.bind(this),_f:this.rp.bind(this),xf:this.Qp.bind(this),vf:this.hp.bind(this),ff:this.hp.bind(this),Xd:this.tv.bind(this),qd:this.tv.bind(this),sf:this.iv.bind(this),Bf:this.np.bind(this)};this.Nf=new Dd(this.Jp.canvasElement,n,{af:()=>!this.Ps.handleScroll.vertTouchDrag,lf:()=>!0})}m(){this.Nf.m(),this.Jp.unsubscribeSuggestedBitmapSizeChanged(this.Yp),qd(this.Jp.canvasElement),this.Jp.dispose(),this.Gp.unsubscribeSuggestedBitmapSizeChanged(this.$p),qd(this.Gp.canvasElement),this.Gp.dispose(),null!==this.Yi&&this.Yi.so().u(this),this.Yi=null}Zf(){return this.jf}P(){return this.Ml.fontSize}sv(){const t=this.Ju.N();return this.Wp!==t.k&&(this.Fp.Bn(),this.Wp=t.k),t}nv(){if(null===this.Yi)return 0;let t=0;const e=this.sv(),i=Bl(this.Gp.canvasElement.getContext("2d",{colorSpace:this.Pt.qp().N().layout.colorSpace}));i.save();const s=this.Yi.Da();i.font=this.ev(),s.length>0&&(t=Math.max(this.Fp.Vi(i,s[0].Za),this.Fp.Vi(i,s[s.length-1].Za)));const o=this.rv();for(let e=o.length;e--;){const s=this.Fp.Vi(i,o[e].ri());s>t&&(t=s)}const r=this.Yi.zt();if(null!==r&&null!==this.Op&&2!==(n=this.Ps.crosshair).mode&&n.horzLine.visible&&n.horzLine.labelVisible){const e=this.Yi.Ts(1,r),s=this.Yi.Ts(this.Op.height-2,r);t=Math.max(t,this.Fp.Vi(i,this.Yi.Zi(Math.floor(Math.min(e,s))+.11111111111111,r)),this.Fp.Vi(i,this.Yi.Zi(Math.ceil(Math.max(e,s))-.11111111111111,r)))}var n;i.restore();const a=t||34;return Ld(Math.ceil(e.S+e.C+e.B+e.I+5+a))}hv(t){null!==this.Op&&El(this.Op,t)||(this.Op=t,this.Up=!0,this.Gp.resizeCanvasElement(t),this.Jp.resizeCanvasElement(t),this.Up=!1,this.jf.style.width=`${t.width}px`,this.jf.style.height=`${t.height}px`)}av(){return Bl(this.Op).width}_s(t){this.Yi!==t&&(null!==this.Yi&&this.Yi.so().u(this),this.Yi=t,t.so().i(this._l.bind(this),this))}Ft(){return this.Yi}Bn(){const t=this.Pt.ap();this.Pt.qp().Qt().Zo(t,Bl(this.Ft()))}lv(t){if(null===this.Op)return;const e={colorSpace:this.Pt.qp().N().layout.colorSpace};if(1!==t){this.ov(),this.Gp.applySuggestedBitmapSize();const t=Ll(this.Gp,e);null!==t&&(t.useBitmapCoordinateSpace(t=>{this._v(t),this.uv(t)}),this.Pt.cv(t,this.Zp),this.dv(t),this.Pt.cv(t,this.Kp),this.fv(t))}this.Jp.applySuggestedBitmapSize();const i=Ll(this.Jp,e);null!==i&&(i.useBitmapCoordinateSpace(({context:t,bitmapSize:e})=>{t.clearRect(0,0,e.width,e.height)}),this.pv(i),this.Pt.cv(i,this.Xp))}Jf(){return this.Gp.bitmapSize}Qf(t,e,i,s){const o=this.Jf();if(o.width>0&&o.height>0&&(t.drawImage(this.Gp.canvasElement,e,i),s)){const s=this.Jp.canvasElement;t.drawImage(s,e,i)}}yt(){this.Yi?.Da()}ep(t){if(null===this.Yi||this.Yi.Ki()||!this.Ps.handleScale.axisPressedMouseMove.price)return;const e=this.Pt.qp().Qt(),i=this.Pt.ap();this.Np=!0,e.Uo(i,this.Yi,t.localY)}rp(t){if(null===this.Yi||!this.Ps.handleScale.axisPressedMouseMove.price)return;const e=this.Pt.qp().Qt(),i=this.Pt.ap(),s=this.Yi;e.$o(i,s,t.localY)}Qp(){if(null===this.Yi||!this.Ps.handleScale.axisPressedMouseMove.price)return;const t=this.Pt.qp().Qt(),e=this.Pt.ap(),i=this.Yi;this.Np&&(this.Np=!1,t.qo(e,i))}hp(t){if(null===this.Yi||!this.Ps.handleScale.axisPressedMouseMove.price)return;const e=this.Pt.qp().Qt(),i=this.Pt.ap();this.Np=!1,e.qo(i,this.Yi)}tv(t){this.Ps.handleScale.axisDoubleClickReset.price&&this.Bn()}iv(t){null!==this.Yi&&(!this.Pt.qp().Qt().N().handleScale.axisPressedMouseMove.price||this.Yi.Le()||this.Yi.Dl()||this.vv(1))}np(t){this.vv(0)}rv(){const t=[],e=null===this.Yi?void 0:this.Yi;return(i=>{for(let s=0;s<i.length;++s){const o=i[s].Ws(this.Pt.ap(),e);for(let e=0;e<o.length;e++)t.push(o[e])}})(this.Pt.ap().Dt()),t}_v({context:t,bitmapSize:e}){const{width:i,height:s}=e,o=this.Pt.ap().Qt(),r=o.$(),n=o.Wc();r===n?uh(t,0,0,i,s,r):mh(t,0,0,i,s,r,n)}uv({context:t,bitmapSize:e,horizontalPixelRatio:i}){if(null===this.Op||null===this.Yi||!this.Yi.N().borderVisible)return;t.fillStyle=this.Yi.N().borderColor;const s=Math.max(1,Math.floor(this.sv().S*i));let o;o=this.jp?e.width-s:0,t.fillRect(o,0,s,e.height)}dv(t){if(null===this.Op||null===this.Yi)return;const e=this.Yi.Da(),i=this.Yi.N(),s=this.sv(),o=this.jp?this.Op.width-s.C:0;i.borderVisible&&i.ticksVisible&&t.useBitmapCoordinateSpace(({context:t,horizontalPixelRatio:r,verticalPixelRatio:n})=>{t.fillStyle=i.borderColor;const a=Math.max(1,Math.floor(n)),l=Math.floor(.5*n),h=Math.round(s.C*r);t.beginPath();for(const i of e)t.rect(Math.floor(o*r),Math.round(i.Pa*n)-l,h,a);t.fill()}),t.useMediaCoordinateSpace(({context:t})=>{t.font=this.ev(),t.fillStyle=i.textColor??this.Ml.textColor,t.textAlign=this.jp?"right":"left",t.textBaseline="middle";const r=this.jp?Math.round(o-s.B):Math.round(o+s.C+s.B),n=e.map(e=>this.Fp.Di(t,e.Za));for(let i=e.length;i--;){const s=e[i];t.fillText(s.Za,r,s.Pa+n[i])}})}ov(){if(null===this.Op||null===this.Yi)return;let t=this.Op.height/2;const e=[],i=this.Yi.Dt().slice(),s=this.Pt.ap(),o=this.sv();this.Yi===s.$n()&&this.Pt.ap().Dt().forEach(t=>{s.Un(t)&&i.push(t)});const r=this.Yi.Ma()[0],n=this.Yi;i.forEach(i=>{const o=i.Ws(s,n);o.forEach(t=>{t.Wi(null),t.Hi()&&e.push(t)}),r===i&&o.length>0&&(t=o[0].Ii())}),e.forEach(t=>t.Wi(t.Ii())),this.Yi.N().alignLabels&&this.mv(e,o,t)}mv(t,e,i){if(null===this.Op)return;const s=t.filter(t=>t.Ii()<=i),o=t.filter(t=>t.Ii()>i);s.sort((t,e)=>e.Ii()-t.Ii()),s.length&&o.length&&o.push(s[0]),o.sort((t,e)=>t.Ii()-e.Ii());for(const i of t){const t=Math.floor(i.$t(e)/2),s=i.Ii();s>-t&&s<t&&i.Wi(t),s>this.Op.height-t&&s<this.Op.height+t&&i.Wi(this.Op.height-t)}Jd(s,1,this.Op.height,e),Jd(o,-1,this.Op.height,e)}fv(t){if(null===this.Op)return;const e=this.rv(),i=this.sv(),s=this.jp?"right":"left";e.forEach(e=>{e.Ui()&&e.Tt(Bl(this.Yi)).nt(t,i,this.Fp,s)})}pv(t){if(null===this.Op||null===this.Yi)return;const e=this.Pt.qp().Qt(),i=[],s=this.Pt.ap(),o=e.uc().Ws(s,this.Yi);o.length&&i.push(o);const r=this.sv(),n=this.jp?"right":"left";i.forEach(e=>{e.forEach(e=>{e.Tt(Bl(this.Yi)).nt(t,r,this.Fp,n)})})}vv(t){this.jf.style.cursor=1===t?"ns-resize":"default"}_l(){const t=this.nv();this.Hp<t&&this.Pt.qp().Qt().Ih(),this.Hp=t}ev(){return Zl(this.Ml.fontSize,this.Ml.fontFamily)}}function Zd(t,e){return t.Jh?.(e)??[]}function tu(t,e){return t.Fs?.(e)??[]}function eu(t,e){return t.us?.(e)??[]}function iu(t,e){return t.Xh?.(e)??[]}class su{constructor(t,e){this.Op=$l({width:0,height:0}),this.wv=null,this.gv=null,this.Mv=null,this.bv=null,this.Sv=!1,this.xv=new Ul,this.Cv=new Ul,this.Pv=0,this.yv=!1,this.kv=null,this.Tv=!1,this.Rv=null,this.Dv=null,this.Up=!1,this.$p=()=>{this.Up||null===this.Vv||this.ts().ar()},this.Yp=()=>{this.Up||null===this.Vv||this.ts().ar()},this.Vp=t,this.Vv=e,this.Vv.t_().i(this.Bv.bind(this),this,!0),this.Iv=document.createElement("td"),this.Iv.style.padding="0",this.Iv.style.position="relative";const i=document.createElement("div");i.style.width="100%",i.style.height="100%",i.style.position="relative",i.style.overflow="hidden",this.Ev=document.createElement("td"),this.Ev.style.padding="0",this.Av=document.createElement("td"),this.Av.style.padding="0",this.Iv.appendChild(i),this.Gp=Yd(i,$l({width:16,height:16})),this.Gp.subscribeSuggestedBitmapSizeChanged(this.$p);const s=this.Gp.canvasElement;s.style.position="absolute",s.style.zIndex="1",s.style.left="0",s.style.top="0",this.Jp=Yd(i,$l({width:16,height:16})),this.Jp.subscribeSuggestedBitmapSizeChanged(this.Yp);const o=this.Jp.canvasElement;o.style.position="absolute",o.style.zIndex="2",o.style.left="0",o.style.top="0",this.Yf=document.createElement("tr"),this.Yf.appendChild(this.Ev),this.Yf.appendChild(this.Iv),this.Yf.appendChild(this.Av),this.zv(),this.Nf=new Dd(this.Jp.canvasElement,this,{af:()=>null===this.kv&&!this.Vp.N().handleScroll.vertTouchDrag,lf:()=>null===this.kv&&!this.Vp.N().handleScroll.horzTouchDrag})}m(){null!==this.wv&&this.wv.m(),null!==this.gv&&this.gv.m(),this.Mv=null,this.Jp.unsubscribeSuggestedBitmapSizeChanged(this.Yp),qd(this.Jp.canvasElement),this.Jp.dispose(),this.Gp.unsubscribeSuggestedBitmapSizeChanged(this.$p),qd(this.Gp.canvasElement),this.Gp.dispose(),null!==this.Vv&&(this.Vv.t_().u(this),this.Vv.m()),this.Nf.m()}ap(){return Bl(this.Vv)}Lv(t){null!==this.Vv&&this.Vv.t_().u(this),this.Vv=t,null!==this.Vv&&this.Vv.t_().i(su.prototype.Bv.bind(this),this,!0),this.zv(),this.Vp.$f().indexOf(this)===this.Vp.$f().length-1?(this.Mv=this.Mv??new Wd(this.Iv,this.Vp),this.Mv.yt()):(this.Mv?.Ip(),this.Mv=null)}qp(){return this.Vp}Zf(){return this.Yf}zv(){if(null!==this.Vv&&(this.Ov(),0!==this.ts().js().length)){if(null!==this.wv){const t=this.Vv.Wo();this.wv._s(Bl(t))}if(null!==this.gv){const t=this.Vv.Ho();this.gv._s(Bl(t))}}}Nv(){null!==this.wv&&this.wv.yt(),null!==this.gv&&this.gv.yt()}Bo(){return null!==this.Vv?this.Vv.Bo():0}Io(t){this.Vv&&this.Vv.Io(t)}sf(t){if(!this.Vv)return;this.Fv();const e=t.localX,i=t.localY;this.Wv(e,i,t)}Sf(t){this.Fv(),this.Hv(),this.Wv(t.localX,t.localY,t)}nf(t){if(!this.Vv)return;this.Fv();const e=t.localX,i=t.localY;this.Wv(e,i,t)}mf(t){null!==this.Vv&&(this.Fv(),this.Uv(t))}Xd(t){null!==this.Vv&&this.$v(this.Cv,t)}qd(t){this.Xd(t)}cf(t){this.Fv(),this.qv(t),this.Wv(t.localX,t.localY,t)}vf(t){null!==this.Vv&&(this.Fv(),this.yv=!1,this.Yv(t))}pf(t){null!==this.Vv&&this.Uv(t)}If(t){if(this.yv=!0,null===this.kv){const e={x:t.localX,y:t.localY};this.jv(e,e,t)}}Bf(t){null!==this.Vv&&(this.Fv(),this.Vv.Qt().lc(null),this.Kv())}Xv(){return this.xv}Zv(){return this.Cv}yf(){this.Pv=1,this.ts().hn()}kf(t,e){if(!this.Vp.N().handleScale.pinch)return;const i=5*(e-this.Pv);this.Pv=e,this.ts().bc(t._t,i)}Mf(t){this.yv=!1,this.Tv=null!==this.kv,this.Hv();const e=this.ts().uc();null!==this.kv&&e.Vt()&&(this.Rv={x:e.si(),y:e.ni()},this.kv={x:t.localX,y:t.localY})}_f(t){if(null===this.Vv)return;const e=t.localX,i=t.localY;if(null===this.kv)this.qv(t);else{this.Tv=!1;const s=Bl(this.Rv),o=s.x+(e-this.kv.x),r=s.y+(i-this.kv.y);this.Wv(o,r,t)}}ff(t){0===this.qp().N().trackingMode.exitMode&&(this.Tv=!0),this.Gv(),this.Yv(t)}jn(t,e){const i=this.Vv;return null===i?null:Zc(i,t,e)}Jv(t,e){Bl("left"===e?this.wv:this.gv).hv($l({width:t,height:this.Op.height}))}Gf(){return this.Op}hv(t){El(this.Op,t)||(this.Op=t,this.Up=!0,this.Gp.resizeCanvasElement(t),this.Jp.resizeCanvasElement(t),this.Up=!1,this.Iv.style.width=t.width+"px",this.Iv.style.height=t.height+"px")}Qv(){const t=Bl(this.Vv);t.Fo(t.Wo()),t.Fo(t.Ho());for(const e of t.Ma())if(t.Un(e)){const i=e.Ft();null!==i&&t.Fo(i),e.Ns()}for(const e of t.s_())e.Ns()}Jf(){return this.Gp.bitmapSize}Qf(t,e,i,s){const o=this.Jf();if(o.width>0&&o.height>0&&(t.drawImage(this.Gp.canvasElement,e,i),s)){const s=this.Jp.canvasElement;null!==t&&t.drawImage(s,e,i)}}lv(t){if(0===t)return;if(null===this.Vv)return;t>1&&this.Qv(),null!==this.wv&&this.wv.lv(t),null!==this.gv&&this.gv.lv(t);const e={colorSpace:this.Vp.N().layout.colorSpace};if(1!==t){this.Gp.applySuggestedBitmapSize();const t=Ll(this.Gp,e);null!==t&&(t.useBitmapCoordinateSpace(t=>{this._v(t)}),this.Vv&&(this.tm(t,Zd),this.im(t),this.tm(t,tu),this.tm(t,eu)))}this.Jp.applySuggestedBitmapSize();const i=Ll(this.Jp,e);null!==i&&(i.useBitmapCoordinateSpace(({context:t,bitmapSize:e})=>{t.clearRect(0,0,e.width,e.height)}),this.sm(i),this.tm(i,iu),this.tm(i,eu))}nm(){return this.wv}rm(){return this.gv}cv(t,e){this.tm(t,e)}Bv(){null!==this.Vv&&this.Vv.t_().u(this),this.Vv=null}Uv(t){this.$v(this.xv,t)}$v(t,e){const i=e.localX,s=e.localY;t.v()&&t.p(this.ts().Et().cu(i),{x:i,y:s},e)}_v({context:t,bitmapSize:e}){const{width:i,height:s}=e,o=this.ts(),r=o.$(),n=o.Wc();r===n?uh(t,0,0,i,s,n):mh(t,0,0,i,s,r,n)}im(t){const e=Bl(this.Vv),i=e.i_().lr().Tt(e);null!==i&&i.nt(t,!1)}sm(t){this.hm(t,tu,Gd,this.ts().uc())}tm(t,e){const i=Bl(this.Vv),s=i.Dt(),o=i.s_();for(const i of o)this.hm(t,e,jd,i);for(const i of s)this.hm(t,e,jd,i);for(const i of o)this.hm(t,e,Gd,i);for(const i of s)this.hm(t,e,Gd,i)}hm(t,e,i,s){const o=Bl(this.Vv),r=o.Qt().ac(),n=null!==r&&r.n_===s,a=null!==r&&n&&void 0!==r.e_?r.e_.Xn:void 0;Kd(e,e=>i(e,t,n,a),s,o)}Ov(){if(null===this.Vv)return;const t=this.Vp,e=this.Vv.Wo().N().visible,i=this.Vv.Ho().N().visible;e||null===this.wv||(this.Ev.removeChild(this.wv.Zf()),this.wv.m(),this.wv=null),i||null===this.gv||(this.Av.removeChild(this.gv.Zf()),this.gv.m(),this.gv=null);const s=t.Qt().Bc();e&&null===this.wv&&(this.wv=new Xd(this,t.N(),s,"left"),this.Ev.appendChild(this.wv.Zf())),i&&null===this.gv&&(this.gv=new Xd(this,t.N(),s,"right"),this.Av.appendChild(this.gv.Zf()))}am(t){return t.Ef&&this.yv||null!==this.kv}lm(t){return Math.max(0,Math.min(t,this.Op.width-1))}om(t){return Math.max(0,Math.min(t,this.Op.height-1))}Wv(t,e,i){this.ts().Tc(this.lm(t),this.om(e),i,Bl(this.Vv))}Kv(){this.ts().Dc()}Gv(){this.Tv&&(this.kv=null,this.Kv())}jv(t,e,i){this.kv=t,this.Tv=!1,this.Wv(e.x,e.y,i);const s=this.ts().uc();this.Rv={x:s.si(),y:s.ni()}}ts(){return this.Vp.Qt()}Yv(t){if(!this.Sv)return;const e=this.ts(),i=this.ap();if(e.Ko(i,i.ks()),this.bv=null,this.Sv=!1,e.Pc(),null!==this.Dv){const t=performance.now(),i=e.Et();this.Dv.le(i.gu(),t),this.Dv.Ru(t)||e._n(this.Dv)}}Fv(){this.kv=null}Hv(){if(this.Vv){if(this.ts().hn(),document.activeElement!==document.body&&document.activeElement!==document.documentElement)Bl(document.activeElement).blur();else{const t=document.getSelection();null!==t&&t.removeAllRanges()}!this.Vv.ks().Ki()&&this.ts().Et().Ki()}}qv(t){if(null===this.Vv)return;const e=this.ts(),i=e.Et();if(i.Ki())return;const s=this.Vp.N(),o=s.handleScroll,r=s.kineticScroll;if((!o.pressedMouseMove||t.Ef)&&(!o.horzTouchDrag&&!o.vertTouchDrag||!t.Ef))return;const n=this.Vv.ks(),a=performance.now();if(null!==this.bv||this.am(t)||(this.bv={x:t.clientX,y:t.clientY,rd:a,_m:t.localX,um:t.localY}),null!==this.bv&&!this.Sv&&(this.bv.x!==t.clientX||this.bv.y!==t.clientY)){if(t.Ef&&r.touch||!t.Ef&&r.mouse){const t=i.mu();this.Dv=new Ud(.2/t,7/t,.997,15/t),this.Dv.Pp(i.gu(),this.bv.rd)}else this.Dv=null;n.Ki()||e.Yo(this.Vv,n,t.localY),e.xc(t.localX),this.Sv=!0}this.Sv&&(n.Ki()||e.jo(this.Vv,n,t.localY),e.Cc(t.localX),null!==this.Dv&&this.Dv.Pp(i.gu(),a))}}class ou{constructor(t,e,i,s,o){this.xt=!0,this.Op=$l({width:0,height:0}),this.$p=()=>this.lv(3),this.jp="left"===t,this.Ju=i.Bc,this.Ps=e,this.dm=s,this.fm=o,this.jf=document.createElement("div"),this.jf.style.width="25px",this.jf.style.height="100%",this.jf.style.overflow="hidden",this.Gp=Yd(this.jf,$l({width:16,height:16})),this.Gp.subscribeSuggestedBitmapSizeChanged(this.$p)}m(){this.Gp.unsubscribeSuggestedBitmapSizeChanged(this.$p),qd(this.Gp.canvasElement),this.Gp.dispose()}Zf(){return this.jf}Gf(){return this.Op}hv(t){El(this.Op,t)||(this.Op=t,this.Gp.resizeCanvasElement(t),this.jf.style.width=`${t.width}px`,this.jf.style.height=`${t.height}px`,this.xt=!0)}lv(t){if(t<3&&!this.xt)return;if(0===this.Op.width||0===this.Op.height)return;this.xt=!1,this.Gp.applySuggestedBitmapSize();const e=Ll(this.Gp,{colorSpace:this.Ps.layout.colorSpace});null!==e&&e.useBitmapCoordinateSpace(t=>{this._v(t),this.uv(t)})}Jf(){return this.Gp.bitmapSize}Qf(t,e,i){const s=this.Jf();s.width>0&&s.height>0&&t.drawImage(this.Gp.canvasElement,e,i)}uv({context:t,bitmapSize:e,horizontalPixelRatio:i,verticalPixelRatio:s}){if(!this.dm())return;t.fillStyle=this.Ps.timeScale.borderColor;const o=Math.floor(this.Ju.N().S*i),r=Math.floor(this.Ju.N().S*s),n=this.jp?e.width-o:0;t.fillRect(n,0,o,r)}_v({context:t,bitmapSize:e}){uh(t,0,0,e.width,e.height,this.fm())}}function ru(t){return e=>e.ia?.(t)??[]}const nu=ru("normal"),au=ru("top"),lu=ru("bottom");class hu{constructor(t,e){this.pm=null,this.vm=null,this.M=null,this.wm=!1,this.Op=$l({width:0,height:0}),this.gm=new Ul,this.Fp=new Lh(5),this.Up=!1,this.$p=()=>{this.Up||this.Vp.Qt().ar()},this.Yp=()=>{this.Up||this.Vp.Qt().ar()},this.Vp=t,this.o_=e,this.Ps=t.N().layout,this.kp=document.createElement("tr"),this.Mm=document.createElement("td"),this.Mm.style.padding="0",this.bm=document.createElement("td"),this.bm.style.padding="0",this.jf=document.createElement("td"),this.jf.style.height="25px",this.jf.style.padding="0",this.Sm=document.createElement("div"),this.Sm.style.width="100%",this.Sm.style.height="100%",this.Sm.style.position="relative",this.Sm.style.overflow="hidden",this.jf.appendChild(this.Sm),this.Gp=Yd(this.Sm,$l({width:16,height:16})),this.Gp.subscribeSuggestedBitmapSizeChanged(this.$p);const i=this.Gp.canvasElement;i.style.position="absolute",i.style.zIndex="1",i.style.left="0",i.style.top="0",this.Jp=Yd(this.Sm,$l({width:16,height:16})),this.Jp.subscribeSuggestedBitmapSizeChanged(this.Yp);const s=this.Jp.canvasElement;s.style.position="absolute",s.style.zIndex="2",s.style.left="0",s.style.top="0",this.kp.appendChild(this.Mm),this.kp.appendChild(this.jf),this.kp.appendChild(this.bm),this.xm(),this.Vp.Qt().Vo().i(this.xm.bind(this),this),this.Nf=new Dd(this.Jp.canvasElement,this,{af:()=>!0,lf:()=>!this.Vp.N().handleScroll.horzTouchDrag})}m(){this.Nf.m(),null!==this.pm&&this.pm.m(),null!==this.vm&&this.vm.m(),this.Jp.unsubscribeSuggestedBitmapSizeChanged(this.Yp),qd(this.Jp.canvasElement),this.Jp.dispose(),this.Gp.unsubscribeSuggestedBitmapSizeChanged(this.$p),qd(this.Gp.canvasElement),this.Gp.dispose()}Zf(){return this.kp}Cm(){return this.pm}Pm(){return this.vm}Sf(t){if(this.wm)return;this.wm=!0;const e=this.Vp.Qt();!e.Et().Ki()&&this.Vp.N().handleScale.axisPressedMouseMove.time&&e.Mc(t.localX)}Mf(t){this.Sf(t)}xf(){const t=this.Vp.Qt();!t.Et().Ki()&&this.wm&&(this.wm=!1,this.Vp.N().handleScale.axisPressedMouseMove.time&&t.kc())}cf(t){const e=this.Vp.Qt();!e.Et().Ki()&&this.Vp.N().handleScale.axisPressedMouseMove.time&&e.yc(t.localX)}_f(t){this.cf(t)}vf(){this.wm=!1;const t=this.Vp.Qt();t.Et().Ki()&&!this.Vp.N().handleScale.axisPressedMouseMove.time||t.kc()}ff(){this.vf()}Xd(){this.Vp.N().handleScale.axisDoubleClickReset.time&&this.Vp.Qt().cn()}qd(){this.Xd()}sf(){this.Vp.Qt().N().handleScale.axisPressedMouseMove.time&&this.vv(1)}Bf(){this.vv(0)}Gf(){return this.Op}ym(){return this.gm}km(t,e,i){El(this.Op,t)||(this.Op=t,this.Up=!0,this.Gp.resizeCanvasElement(t),this.Jp.resizeCanvasElement(t),this.Up=!1,this.jf.style.width=`${t.width}px`,this.jf.style.height=`${t.height}px`,this.gm.p(t)),null!==this.pm&&this.pm.hv($l({width:e,height:t.height})),null!==this.vm&&this.vm.hv($l({width:i,height:t.height}))}Tm(){const t=this.Rm();return Math.ceil(t.S+t.C+t.P+t.A+t.V+t.Dm)}yt(){this.Vp.Qt().Et().Da()}Jf(){return this.Gp.bitmapSize}Qf(t,e,i,s){const o=this.Jf();if(o.width>0&&o.height>0&&(t.drawImage(this.Gp.canvasElement,e,i),s)){const s=this.Jp.canvasElement;t.drawImage(s,e,i)}}lv(t){if(0===t)return;const e={colorSpace:this.Ps.colorSpace};if(1!==t){this.Gp.applySuggestedBitmapSize();const i=Ll(this.Gp,e);null!==i&&(i.useBitmapCoordinateSpace(t=>{this._v(t),this.uv(t),this.Vm(i,lu)}),this.dv(i),this.Vm(i,nu)),null!==this.pm&&this.pm.lv(t),null!==this.vm&&this.vm.lv(t)}this.Jp.applySuggestedBitmapSize();const i=Ll(this.Jp,e);null!==i&&(i.useBitmapCoordinateSpace(({context:t,bitmapSize:e})=>{t.clearRect(0,0,e.width,e.height)}),this.Bm([...this.Vp.Qt().js(),this.Vp.Qt().uc()],i),this.Vm(i,au))}Vm(t,e){const i=this.Vp.Qt().js();for(const s of i)Kd(e,e=>jd(e,t,!1,void 0),s,void 0);for(const s of i)Kd(e,e=>Gd(e,t,!1,void 0),s,void 0)}_v({context:t,bitmapSize:e}){uh(t,0,0,e.width,e.height,this.Vp.Qt().Wc())}uv({context:t,bitmapSize:e,verticalPixelRatio:i}){if(this.Vp.N().timeScale.borderVisible){t.fillStyle=this.Im();const s=Math.max(1,Math.floor(this.Rm().S*i));t.fillRect(0,0,e.width,s)}}dv(t){const e=this.Vp.Qt().Et(),i=e.Da();if(!i||0===i.length)return;const s=this.o_.maxTickMarkWeight(i),o=this.Rm(),r=e.N();r.borderVisible&&r.ticksVisible&&t.useBitmapCoordinateSpace(({context:t,horizontalPixelRatio:e,verticalPixelRatio:s})=>{t.strokeStyle=this.Im(),t.fillStyle=this.Im();const r=Math.max(1,Math.floor(e)),n=Math.floor(.5*e);t.beginPath();const a=Math.round(o.C*s);for(let s=i.length;s--;){const o=Math.round(i[s].coord*e);t.rect(o-n,0,r,a)}t.fill()}),t.useMediaCoordinateSpace(({context:t})=>{const e=o.S+o.C+o.A+o.P/2;t.textAlign="center",t.textBaseline="middle",t.fillStyle=this.H(),t.font=this.ev();for(const o of i)if(o.weight<s){const i=o.needAlignCoordinate?this.Em(t,o.coord,o.label):o.coord;t.fillText(o.label,i,e)}this.Vp.N().timeScale.allowBoldLabels&&(t.font=this.Am());for(const o of i)if(o.weight>=s){const i=o.needAlignCoordinate?this.Em(t,o.coord,o.label):o.coord;t.fillText(o.label,i,e)}})}Em(t,e,i){const s=this.Fp.Vi(t,i),o=s/2,r=Math.floor(e-o)+.5;return r<0?e+=Math.abs(0-r):r+s>this.Op.width&&(e-=Math.abs(this.Op.width-(r+s))),e}Bm(t,e){const i=this.Rm();for(const s of t)for(const t of s.cs())t.Tt().nt(e,i)}Im(){return this.Vp.N().timeScale.borderColor}H(){return this.Ps.textColor}F(){return this.Ps.fontSize}ev(){return Zl(this.F(),this.Ps.fontFamily)}Am(){return Zl(this.F(),this.Ps.fontFamily,"bold")}Rm(){null===this.M&&(this.M={S:1,L:NaN,A:NaN,V:NaN,Ji:NaN,C:5,P:NaN,k:"",Gi:new Lh,Dm:0});const t=this.M,e=this.ev();if(t.k!==e){const i=this.F();t.P=i,t.k=e,t.A=3*i/12,t.V=3*i/12,t.Ji=9*i/12,t.L=0,t.Dm=4*i/12,t.Gi.Bn()}return this.M}vv(t){this.jf.style.cursor=1===t?"ew-resize":"default"}xm(){const t=this.Vp.Qt(),e=t.N();e.leftPriceScale.visible||null===this.pm||(this.Mm.removeChild(this.pm.Zf()),this.pm.m(),this.pm=null),e.rightPriceScale.visible||null===this.vm||(this.bm.removeChild(this.vm.Zf()),this.vm.m(),this.vm=null);const i={Bc:this.Vp.Qt().Bc()},s=()=>e.leftPriceScale.borderVisible&&t.Et().N().borderVisible,o=()=>t.Wc();e.leftPriceScale.visible&&null===this.pm&&(this.pm=new ou("left",e,i,s,o),this.Mm.appendChild(this.pm.Zf())),e.rightPriceScale.visible&&null===this.vm&&(this.vm=new ou("right",e,i,s,o),this.bm.appendChild(this.vm.Zf()))}}const cu=!!Pd&&!!navigator.userAgentData&&navigator.userAgentData.brands.some(t=>t.brand.includes("Chromium"))&&!!Pd&&(navigator?.userAgentData?.platform?"Windows"===navigator.userAgentData.platform:navigator.userAgent.toLowerCase().indexOf("win")>=0);class du{constructor(t,e,i){var s;this.zm=[],this.Lm=[],this.Om=0,this.il=0,this.Mo=0,this.Nm=0,this.Fm=0,this.Wm=null,this.Hm=!1,this.xv=new Ul,this.Cv=new Ul,this.Xu=new Ul,this.Um=null,this.$m=null,this.Dp=t,this.Ps=e,this.o_=i,this.kp=document.createElement("div"),this.kp.classList.add("tv-lightweight-charts"),this.kp.style.overflow="hidden",this.kp.style.direction="ltr",this.kp.style.width="100%",this.kp.style.height="100%",(s=this.kp).style.userSelect="none",s.style.webkitUserSelect="none",s.style.msUserSelect="none",s.style.MozUserSelect="none",s.style.webkitTapHighlightColor="transparent",this.qm=document.createElement("table"),this.qm.setAttribute("cellspacing","0"),this.kp.appendChild(this.qm),this.Ym=this.jm.bind(this),uu(this.Ps)&&this.Km(!0),this.ts=new ud(this.Gu.bind(this),this.Ps,i),this.Qt().cc().i(this.Xm.bind(this),this),this.Zm=new hu(this,this.o_),this.qm.appendChild(this.Zm.Zf());const o=e.autoSize&&this.Gm();let r=this.Ps.width,n=this.Ps.height;if(o||0===r||0===n){const e=t.getBoundingClientRect();r=r||e.width,n=n||e.height}this.Jm(r,n),this.Qm(),t.appendChild(this.kp),this.tw(),this.ts.Et().Iu().i(this.ts.Ih.bind(this.ts),this),this.ts.Vo().i(this.ts.Ih.bind(this.ts),this)}Qt(){return this.ts}N(){return this.Ps}$f(){return this.zm}iw(){return this.Zm}m(){this.Km(!1),0!==this.Om&&window.cancelAnimationFrame(this.Om),this.ts.cc().u(this),this.ts.Et().Iu().u(this),this.ts.Vo().u(this),this.ts.m();for(const t of this.zm)this.qm.removeChild(t.Zf()),t.Xv().u(this),t.Zv().u(this),t.m();this.zm=[];for(const t of this.Lm)this.sw(t);this.Lm=[],Bl(this.Zm).m(),null!==this.kp.parentElement&&this.kp.parentElement.removeChild(this.kp),this.Xu.m(),this.xv.m(),this.Cv.m(),this.nw()}Jm(t,e,i=!1){if(this.il===e&&this.Mo===t)return;const s=function(t){const e=Math.floor(t.width),i=Math.floor(t.height);return $l({width:e-e%2,height:i-i%2})}($l({width:t,height:e}));this.il=s.height,this.Mo=s.width;const o=this.il+"px",r=this.Mo+"px";Bl(this.kp).style.height=o,Bl(this.kp).style.width=r,this.qm.style.height=o,this.qm.style.width=r,i?this.ew(zh.gn(),performance.now()):this.ts.Ih()}lv(t){void 0===t&&(t=zh.gn());for(let e=0;e<this.zm.length;e++)this.zm[e].lv(t.en(e).tn);this.Ps.timeScale.visible&&this.Zm.lv(t.nn())}hr(t){const e=uu(this.Ps);this.ts.hr(t);const i=uu(this.Ps);i!==e&&this.Km(i),t.layout?.panes&&this.rw(),this.tw(),this.hw(t)}Xv(){return this.xv}Zv(){return this.Cv}cc(){return this.Xu}aw(t=!1){null!==this.Wm&&(this.ew(this.Wm,performance.now()),this.Wm=null);const e=this.lw(null),i=document.createElement("canvas");i.width=e.width,i.height=e.height;const s=Bl(i.getContext("2d"));return this.lw(s,t),i}ow(t){return"left"===t&&!this._w()||"right"===t&&!this.uw()||0===this.zm.length?0:Bl("left"===t?this.zm[0].nm():this.zm[0].rm()).av()}cw(){return this.Ps.autoSize&&null!==this.Um}ip(){return this.kp}dw(t){this.$m=t,this.$m?this.ip().style.setProperty("cursor",t):this.ip().style.removeProperty("cursor")}fw(){return this.$m}pw(t){return Nl(this.zm[t]).Gf()}rw(){this.Lm.forEach(t=>{t.yt()})}hw(t){(void 0!==t.autoSize||!this.Um||void 0===t.width&&void 0===t.height)&&(t.autoSize&&!this.Um&&this.Gm(),!1===t.autoSize&&null!==this.Um&&this.nw(),t.autoSize||void 0===t.width&&void 0===t.height||this.Jm(t.width||this.Mo,t.height||this.il))}lw(t,e){let i=0,s=0;const o=this.zm[0],r=(i,s)=>{let o=0;for(let r=0;r<this.zm.length;r++){const n=this.zm[r],a=Bl("left"===i?n.nm():n.rm()),l=a.Jf();if(null!==t&&a.Qf(t,s,o,e),o+=l.height,r<this.zm.length-1){const e=this.Lm[r],i=e.Jf();null!==t&&e.Qf(t,s,o),o+=i.height}}};this._w()&&(r("left",0),i+=Bl(o.nm()).Jf().width);for(let o=0;o<this.zm.length;o++){const r=this.zm[o],n=r.Jf();if(null!==t&&r.Qf(t,i,s,e),s+=n.height,o<this.zm.length-1){const e=this.Lm[o],r=e.Jf();null!==t&&e.Qf(t,i,s),s+=r.height}}i+=o.Jf().width,this.uw()&&(r("right",i),i+=Bl(o.rm()).Jf().width);const n=(e,i,s)=>{Bl("left"===e?this.Zm.Cm():this.Zm.Pm()).Qf(Bl(t),i,s)};if(this.Ps.timeScale.visible){const i=this.Zm.Jf();if(null!==t){let r=0;this._w()&&(n("left",r,s),r=Bl(o.nm()).Jf().width),this.Zm.Qf(t,r,s,e),r+=i.width,this.uw()&&n("right",r,s)}s+=i.height}return $l({width:i,height:s})}mw(){let t=0,e=0,i=0;for(const s of this.zm)this._w()&&(e=Math.max(e,Bl(s.nm()).nv(),this.Ps.leftPriceScale.minimumWidth)),this.uw()&&(i=Math.max(i,Bl(s.rm()).nv(),this.Ps.rightPriceScale.minimumWidth)),t+=s.Bo();e=Ld(e),i=Ld(i);const s=this.Mo,o=this.il,r=Math.max(s-e-i,0),n=1*this.Lm.length,a=this.Ps.timeScale.visible;let l=a?Math.max(this.Zm.Tm(),this.Ps.timeScale.minimumHeight):0;var h;l=(h=l)+h%2;const c=n+l,d=o<c?0:o-c,u=d/t;let p=0;const f=window.devicePixelRatio||1;for(let t=0;t<this.zm.length;++t){const s=this.zm[t];s.Lv(this.ts.$s()[t]);let o=0,n=0;n=t===this.zm.length-1?Math.ceil((d-p)*f)/f:Math.round(s.Bo()*u*f)/f,o=Math.max(n,2),p+=o,s.hv($l({width:r,height:o})),this._w()&&s.Jv(e,"left"),this.uw()&&s.Jv(i,"right"),s.ap()&&this.ts.dc(s.ap(),o)}this.Zm.km($l({width:a?r:0,height:l}),a?e:0,a?i:0),this.ts.Eo(r),this.Nm!==e&&(this.Nm=e),this.Fm!==i&&(this.Fm=i)}Km(t){t?this.kp.addEventListener("wheel",this.Ym,{passive:!1}):this.kp.removeEventListener("wheel",this.Ym)}ww(t){switch(t.deltaMode){case t.DOM_DELTA_PAGE:return 120;case t.DOM_DELTA_LINE:return 32}return cu?1/window.devicePixelRatio:1}jm(t){if(!(0!==t.deltaX&&this.Ps.handleScroll.mouseWheel||0!==t.deltaY&&this.Ps.handleScale.mouseWheel))return;const e=this.ww(t),i=e*t.deltaX/100,s=-e*t.deltaY/100;if(t.cancelable&&t.preventDefault(),0!==s&&this.Ps.handleScale.mouseWheel){const e=Math.sign(s)*Math.min(1,Math.abs(s)),i=t.clientX-this.kp.getBoundingClientRect().left;this.Qt().bc(i,e)}0!==i&&this.Ps.handleScroll.mouseWheel&&this.Qt().Sc(-80*i)}ew(t,e){const i=t.nn();3===i&&this.gw(),3!==i&&2!==i||(this.Mw(t),this.bw(t,e),this.Zm.yt(),this.zm.forEach(t=>{t.Nv()}),3===this.Wm?.nn()&&(this.Wm.vn(t),this.gw(),this.Mw(this.Wm),this.bw(this.Wm,e),t=this.Wm,this.Wm=null)),this.lv(t)}bw(t,e){for(const i of t.pn())this.mn(i,e)}Mw(t){const e=this.ts.$s();for(let i=0;i<e.length;i++)t.en(i).sn&&e[i].Go()}mn(t,e){const i=this.ts.Et();switch(t.an){case 0:i.Au();break;case 1:i.zu(t.Wt);break;case 2:i.dn(t.Wt);break;case 3:i.fn(t.Wt);break;case 4:i.Su();break;case 5:t.Wt.Ru(e)||i.fn(t.Wt.Du(e))}}Gu(t){null!==this.Wm?this.Wm.vn(t):this.Wm=t,this.Hm||(this.Hm=!0,this.Om=window.requestAnimationFrame(t=>{if(this.Hm=!1,this.Om=0,null!==this.Wm){const e=this.Wm;this.Wm=null,this.ew(e,t);for(const i of e.pn())if(5===i.an&&!i.Wt.Ru(t)){this.Qt()._n(i.Wt);break}}}))}gw(){this.Qm()}sw(t){this.qm.removeChild(t.Zf()),t.m()}Qm(){const t=this.ts.$s(),e=t.length,i=this.zm.length;for(let t=e;t<i;t++){const t=Nl(this.zm.pop());this.qm.removeChild(t.Zf()),t.Xv().u(this),t.Zv().u(this),t.m();const e=this.Lm.pop();void 0!==e&&this.sw(e)}for(let s=i;s<e;s++){const e=new su(this,t[s]);if(e.Xv().i(this.Sw.bind(this,e),this),e.Zv().i(this.xw.bind(this,e),this),this.zm.push(e),s>0){const t=new Nd(this,s-1,s);this.Lm.push(t),this.qm.insertBefore(t.Zf(),this.Zm.Zf())}this.qm.insertBefore(e.Zf(),this.Zm.Zf())}for(let i=0;i<e;i++){const e=t[i],s=this.zm[i];s.ap()!==e?s.Lv(e):s.zv()}this.tw(),this.mw()}Cw(t,e,i,s){const o=new Map;let r;if(null!==t&&this.ts.js().forEach(e=>{const i=e.Xs().Fr(t);null!==i&&o.set(e,i)}),null!==t){const e=this.ts.Et().ss(t)?.originalTime;void 0!==e&&(r=e)}const n=this.Qt().ac(),a=null!==n&&n.n_ instanceof xc?n.n_:void 0,l=null!==n&&void 0!==n.e_?n.e_.Kn:void 0,h=this.Pw(s);return{yw:r,Re:t??void 0,kw:e??void 0,Tw:-1!==h?h:void 0,Rw:a,Dw:o,Vw:l,Bw:i??void 0}}Pw(t){let e=-1;if(t)e=this.zm.indexOf(t);else{const t=this.Qt().uc().Us();null!==t&&(e=this.Qt().$s().indexOf(t))}return e}Sw(t,e,i,s){this.xv.p(()=>this.Cw(e,i,s,t))}xw(t,e,i,s){this.Cv.p(()=>this.Cw(e,i,s,t))}Xm(t,e,i){this.dw(this.Qt().ac()?.h_??null),this.Xu.p(()=>this.Cw(t,e,i))}tw(){const t=this.Ps.timeScale.visible?"":"none";this.Zm.Zf().style.display=t}_w(){return this.zm[0].ap().Wo().N().visible}uw(){return this.zm[0].ap().Ho().N().visible}Gm(){return"ResizeObserver"in window&&(this.Um=new ResizeObserver(t=>{const e=t[t.length-1];e&&this.Jm(e.contentRect.width,e.contentRect.height)}),this.Um.observe(this.Dp,{box:"border-box"}),!0)}nw(){null!==this.Um&&this.Um.disconnect(),this.Um=null}}function uu(t){return Boolean(t.handleScroll.mouseWheel||t.handleScale.mouseWheel)}function pu(t,e,i,s){const o=i.value,r={Re:e,wt:t,Wt:[o,o,o,o],yw:s};return void 0!==i.color&&(r.R=i.color),r}function fu(t,e,i,s){const o=i.value,r={Re:e,wt:t,Wt:[o,o,o,o],yw:s};return void 0!==i.lineColor&&(r.vt=i.lineColor),void 0!==i.topColor&&(r.mr=i.topColor),void 0!==i.bottomColor&&(r.wr=i.bottomColor),r}function mu(t,e,i,s){const o=i.value,r={Re:e,wt:t,Wt:[o,o,o,o],yw:s};return void 0!==i.topLineColor&&(r.gr=i.topLineColor),void 0!==i.bottomLineColor&&(r.Mr=i.bottomLineColor),void 0!==i.topFillColor1&&(r.br=i.topFillColor1),void 0!==i.topFillColor2&&(r.Sr=i.topFillColor2),void 0!==i.bottomFillColor1&&(r.Cr=i.bottomFillColor1),void 0!==i.bottomFillColor2&&(r.Pr=i.bottomFillColor2),r}function gu(t,e,i,s){const o={Re:e,wt:t,Wt:[i.open,i.high,i.low,i.close],yw:s};return void 0!==i.color&&(o.R=i.color),o}function bu(t,e,i,s){const o={Re:e,wt:t,Wt:[i.open,i.high,i.low,i.close],yw:s};return void 0!==i.color&&(o.R=i.color),void 0!==i.borderColor&&(o.Ht=i.borderColor),void 0!==i.wickColor&&(o.vr=i.wickColor),o}function vu(t,e,i,s,o){const r=Nl(o)(i),n=Math.max(...r),a=Math.min(...r),l=r[r.length-1],h=[l,n,a,l],{time:c,color:d,...u}=i;return{Re:e,wt:t,Wt:h,yw:s,se:u,R:d}}function yu(t){return void 0!==t.Wt}function wu(t,e){return void 0!==e.customValues&&(t.Iw=e.customValues),t}function _u(t){return(e,i,s,o,r,n)=>function(t,e){return e?e(t):function(t){return void 0===t.open&&void 0===t.value}(t)}(s,n)?wu({wt:e,Re:i,yw:o},s):wu(t(e,i,s,o,r),s)}function xu(t){return{Candlestick:_u(bu),Bar:_u(gu),Area:_u(fu),Baseline:_u(mu),Histogram:_u(pu),Line:_u(pu),Custom:_u(vu)}[t]}function ku(t){return{Re:0,Ew:new Map,Hh:t}}function Cu(t,e){if(void 0!==t&&0!==t.length)return{Aw:e.key(t[0].wt),zw:e.key(t[t.length-1].wt)}}function Su(t){let e;return t.forEach(t=>{void 0===e&&(e=t.yw)}),Nl(e)}class zu{constructor(t){this.Lw=new Map,this.Ow=new Map,this.Nw=new Map,this.Fw=[],this.o_=t}m(){this.Lw.clear(),this.Ow.clear(),this.Nw.clear(),this.Fw=[]}Ww(t,e){let i=0!==this.Lw.size,s=!1;const o=this.Ow.get(t);if(void 0!==o)if(1===this.Ow.size)i=!1,s=!0,this.Lw.clear();else for(const e of this.Fw)e.pointData.Ew.delete(t)&&(s=!0);let r=[];if(0!==e.length){const i=e.map(t=>t.time),o=this.o_.createConverterToInternalObj(e),n=xu(t.Rr()),a=t.ca(),l=t.fa();r=e.map((e,r)=>{const h=o(e.time),c=this.o_.key(h);let d=this.Lw.get(c);void 0===d&&(d=ku(h),this.Lw.set(c,d),s=!0);const u=n(h,d.Re,e,i[r],a,l);return d.Ew.set(t,u),u})}i&&this.Hw(),this.Uw(t,r);let n=-1;if(s){const t=[];this.Lw.forEach(e=>{t.push({timeWeight:0,time:e.Hh,pointData:e,originalTime:Su(e.Ew)})}),t.sort((t,e)=>this.o_.key(t.time)-this.o_.key(e.time)),n=this.$w(t)}return this.qw(t,n,function(t,e,i){const s=Cu(t,i),o=Cu(e,i);if(void 0!==s&&void 0!==o)return{Yw:!1,zh:s.zw>=o.zw&&s.Aw>=o.Aw}}(this.Ow.get(t),o,this.o_))}Ac(t){return this.Ww(t,[])}jw(t,e,i){const s=e;!function(t){void 0===t.yw&&(t.yw=t.time)}(s),this.o_.preprocessData(e);const o=this.o_.createConverterToInternalObj([e])(e.time),r=this.Nw.get(t);if(!i&&void 0!==r&&this.o_.key(o)<this.o_.key(r))throw new Error(`Cannot update oldest data, last time=${r}, new time=${o}`);let n=this.Lw.get(this.o_.key(o));if(i&&void 0===n)throw new Error("Cannot update non-existing data point when historicalUpdate is true");const a=void 0===n;void 0===n&&(n=ku(o),this.Lw.set(this.o_.key(o),n));const l=xu(t.Rr()),h=t.ca(),c=t.fa(),d=l(o,n.Re,e,s.yw,h,c);n.Ew.set(t,d),i?this.Kw(t,d,n.Re):this.Xw(t,d);const u={zh:yu(d),Yw:i};if(!a)return this.qw(t,-1,u);const p={timeWeight:0,time:n.Hh,pointData:n,originalTime:Su(n.Ew)},f=tc(this.Fw,this.o_.key(p.time),(t,e)=>this.o_.key(t.time)<e);this.Fw.splice(f,0,p);for(let t=f;t<this.Fw.length;++t)$u(this.Fw[t].pointData,t);return this.o_.fillWeightsForPoints(this.Fw,f),this.qw(t,f,u)}Zw(t,e){const i=this.Ow.get(t);if(void 0===i||e<=0)return[[],this.Gw()];e=Math.min(e,i.length);const s=i.splice(-e).reverse();0===i.length?this.Nw.delete(t):this.Nw.set(t,i[i.length-1].wt);for(const e of s){const i=this.Lw.get(this.o_.key(e.wt));if(i&&(i.Ew.delete(t),0===i.Ew.size)){this.Lw.delete(this.o_.key(i.Hh)),this.Fw.splice(i.Re,1);for(let t=i.Re;t<this.Fw.length;++t)$u(this.Fw[t].pointData,t)}}return[s,this.qw(t,this.Fw.length-1,{Yw:!1,zh:!1})]}Xw(t,e){let i=this.Ow.get(t);void 0===i&&(i=[],this.Ow.set(t,i));const s=0!==i.length?i[i.length-1]:null;null===s||this.o_.key(e.wt)>this.o_.key(s.wt)?yu(e)&&i.push(e):yu(e)?i[i.length-1]=e:i.splice(-1,1),this.Nw.set(t,e.wt)}Kw(t,e,i){const s=this.Ow.get(t);if(void 0===s)return;const o=tc(s,i,(t,e)=>t.Re<e);yu(e)?s[o]=e:s.splice(o,1)}Uw(t,e){0!==e.length?(this.Ow.set(t,e.filter(yu)),this.Nw.set(t,e[e.length-1].wt)):(this.Ow.delete(t),this.Nw.delete(t))}Hw(){for(const t of this.Fw)0===t.pointData.Ew.size&&this.Lw.delete(this.o_.key(t.time))}$w(t){let e=-1;for(let i=0;i<this.Fw.length&&i<t.length;++i){const s=this.Fw[i],o=t[i];if(this.o_.key(s.time)!==this.o_.key(o.time)){e=i;break}o.timeWeight=s.timeWeight,$u(o.pointData,i)}if(-1===e&&this.Fw.length!==t.length&&(e=Math.min(this.Fw.length,t.length)),-1===e)return-1;for(let i=e;i<t.length;++i)$u(t[i].pointData,i);return this.o_.fillWeightsForPoints(t,e),this.Fw=t,e}Jw(){if(0===this.Ow.size)return null;let t=0;return this.Ow.forEach(e=>{0!==e.length&&(t=Math.max(t,e[e.length-1].Re))}),t}qw(t,e,i){const s=this.Gw();if(-1!==e)this.Ow.forEach((e,o)=>{s.Oo.set(o,{se:e,Qw:o===t?i:void 0})}),this.Ow.has(t)||s.Oo.set(t,{se:[],Qw:i}),s.Et.tg=this.Fw,s.Et.ig=e;else{const e=this.Ow.get(t);s.Oo.set(t,{se:e||[],Qw:i})}return s}Gw(){return{Oo:new Map,Et:{_u:this.Jw()}}}}function $u(t,e){t.Re=e,t.Ew.forEach(t=>{t.Re=e})}function Eu(t,e){return t.wt<e}function Mu(t,e){return e<t.wt}class Pu{constructor(t,e,i){this.sg=!0,this.ng=!0,this.eg=!0,this.rg=[],this.hg=null,this.Jn=t,this.Qn=e,this.ag=i}yt(t){this.sg=!0,"data"===t&&(this.ng=!0),"options"===t&&(this.eg=!0)}Tt(){return this.Jn.Vt()?(this.lg(),null===this.hg?null:this.og):null}_g(){this.rg=this.rg.map(t=>({...t,...this.Jn.Rh().Dr(t.wt)}))}ug(){this.hg=null}lg(){this.ng&&(this.cg(),this.ng=!1),this.eg&&(this._g(),this.eg=!1),this.sg&&(this.dg(),this.sg=!1)}dg(){const t=this.Jn.Ft(),e=this.Qn.Et();if(this.ug(),e.Ki()||t.Ki())return;const i=e.Pe();if(null===i)return;if(0===this.Jn.Xs().zr())return;const s=this.Jn.zt();null!==s&&(this.hg=function(t,e,i){const s=e.Uh(),o=e.bi(),r=tc(t,s,Eu),n=ec(t,o,Mu);if(!i)return{from:r,to:n};let a=r,l=n;return r>0&&r<t.length&&t[r].wt>=s&&(a=r-1),n>0&&n<t.length&&t[n-1].wt<=o&&(l=n+1),{from:a,to:l}}(this.rg,i,this.ag),this.fg(t,e,s.Wt),this.pg())}}class Tu{constructor(t,e){this.vg=t,this.Yi=e}nt(t,e,i){this.vg.draw(t,this.Yi,e,i)}}class Au extends Pu{constructor(t,e,i){super(t,e,!1),this.sh=i,this.og=new Tu(this.sh.renderer(),e=>{const i=t.zt();return null===i?null:t.Ft().Nt(e,i.Wt)})}da(t){return this.sh.priceValueBuilder(t)}pa(t){return this.sh.isWhitespace(t)}cg(){const t=this.Jn.Rh();this.rg=this.Jn.Xs().Hr().map(e=>({wt:e.Re,_t:NaN,...t.Dr(e.Re),mg:e.se}))}fg(t,e){e.uu(this.rg,Jl(this.hg))}pg(){this.sh.update({bars:this.rg.map(Lu),barSpacing:this.Qn.Et().mu(),visibleRange:this.hg},this.Jn.N())}}function Lu(t){return{x:t._t,time:t.wt,originalData:t.mg,barColor:t.cr}}const Du={color:"#2196f3"},Ou=(t,e,i)=>{const s=Hl(i);return new Au(t,e,s)};function Iu(t){const e={value:t.Wt[3],time:t.yw};return void 0!==t.Iw&&(e.customValues=t.Iw),e}function Vu(t){const e=Iu(t);return void 0!==t.R&&(e.color=t.R),e}function Fu(t){const e=Iu(t);return void 0!==t.vt&&(e.lineColor=t.vt),void 0!==t.mr&&(e.topColor=t.mr),void 0!==t.wr&&(e.bottomColor=t.wr),e}function Ru(t){const e=Iu(t);return void 0!==t.gr&&(e.topLineColor=t.gr),void 0!==t.Mr&&(e.bottomLineColor=t.Mr),void 0!==t.br&&(e.topFillColor1=t.br),void 0!==t.Sr&&(e.topFillColor2=t.Sr),void 0!==t.Cr&&(e.bottomFillColor1=t.Cr),void 0!==t.Pr&&(e.bottomFillColor2=t.Pr),e}function Nu(t){const e={open:t.Wt[0],high:t.Wt[1],low:t.Wt[2],close:t.Wt[3],time:t.yw};return void 0!==t.Iw&&(e.customValues=t.Iw),e}function Bu(t){const e=Nu(t);return void 0!==t.R&&(e.color=t.R),e}function Hu(t){const e=Nu(t),{R:i,Ht:s,vr:o}=t;return void 0!==i&&(e.color=i),void 0!==s&&(e.borderColor=s),void 0!==o&&(e.wickColor=o),e}function Uu(t){return{Area:Fu,Line:Vu,Baseline:Ru,Histogram:Vu,Bar:Bu,Candlestick:Hu,Custom:Wu}[t]}function Wu(t){const e=t.yw;return{...t.se,time:e}}const Yu={vertLine:{color:"#9598A1",width:1,style:3,visible:!0,labelVisible:!0,labelBackgroundColor:"#131722"},horzLine:{color:"#9598A1",width:1,style:3,visible:!0,labelVisible:!0,labelBackgroundColor:"#131722"},mode:1},qu={vertLines:{color:"#D6DCDE",style:0,visible:!0},horzLines:{color:"#D6DCDE",style:0,visible:!0}},ju={background:{type:"solid",color:"#FFFFFF"},textColor:"#191919",fontSize:12,fontFamily:Xl,panes:{enableResize:!0,separatorColor:"#E0E3EB",separatorHoverColor:"rgba(178, 181, 189, 0.2)"},attributionLogo:!0,colorSpace:"srgb",colorParsers:[]},Gu={autoScale:!0,mode:0,invertScale:!1,alignLabels:!0,borderVisible:!0,borderColor:"#2B2B43",entireTextOnly:!1,visible:!1,ticksVisible:!1,scaleMargins:{bottom:.1,top:.2},minimumWidth:0,ensureEdgeTickMarksVisible:!1},Ku={rightOffset:0,barSpacing:6,minBarSpacing:.5,maxBarSpacing:0,fixLeftEdge:!1,fixRightEdge:!1,lockVisibleTimeRangeOnResize:!1,rightBarStaysOnScroll:!1,borderVisible:!0,borderColor:"#2B2B43",visible:!0,timeVisible:!1,secondsVisible:!0,shiftVisibleRangeOnNewBar:!0,allowShiftVisibleRangeOnWhitespaceReplacement:!1,ticksVisible:!1,uniformDistribution:!1,minimumHeight:0,allowBoldLabels:!0,ignoreWhitespaceIndices:!1};function Qu(){return{addDefaultPane:!0,width:0,height:0,autoSize:!1,layout:ju,crosshair:Yu,grid:qu,overlayPriceScales:{...Gu},leftPriceScale:{...Gu,visible:!1},rightPriceScale:{...Gu,visible:!0},timeScale:Ku,localization:{locale:Pd?navigator.language:"",dateFormat:"dd MMM 'yy"},handleScroll:{mouseWheel:!0,pressedMouseMove:!0,horzTouchDrag:!0,vertTouchDrag:!0},handleScale:{axisPressedMouseMove:{time:!0,price:!0},axisDoubleClickReset:{time:!0,price:!0},mouseWheel:!0,pinch:!0},kineticScroll:{mouse:!1,touch:!0},trackingMode:{exitMode:1}}}class Ju{constructor(t,e,i){this.Hf=t,this.wg=e,this.gg=i??0}applyOptions(t){this.Hf.Qt().oc(this.wg,t,this.gg)}options(){return this.Yi().N()}width(){return Sh(this.wg)?this.Hf.ow(this.wg):0}setVisibleRange(t){this.setAutoScale(!1),this.Yi().Fl(new Yh(t.from,t.to))}getVisibleRange(){let t,e,i=this.Yi().Qe();if(null===i)return null;if(this.Yi().Ja()){const s=this.Yi().fo(),o=pd(s);i=Rc(i,this.Yi().tl()),t=Number((Math.round(i.$e()/s)*s).toFixed(o)),e=Number((Math.round(i.qe()/s)*s).toFixed(o))}else t=i.$e(),e=i.qe();return{from:t,to:e}}setAutoScale(t){this.applyOptions({autoScale:t})}Yi(){return Bl(this.Hf.Qt()._c(this.wg,this.gg)).Ft}}class Xu{constructor(t,e,i,s){this.Hf=t,this.Pt=i,this.Mg=e,this.bg=s}getHeight(){return this.Pt.$t()}setHeight(t){const e=this.Hf.Qt(),i=e.Uc(this.Pt);e.vc(i,t)}getStretchFactor(){return this.Pt.Bo()}setStretchFactor(t){this.Pt.Io(t),this.Hf.Qt().Ih()}paneIndex(){return this.Hf.Qt().Uc(this.Pt)}moveTo(t){const e=this.paneIndex();e!==t&&(Rl(t>=0&&t<this.Hf.$f().length,"Invalid pane index"),this.Hf.Qt().wc(e,t))}getSeries(){return this.Pt.Oo().map(t=>this.Mg(t))??[]}getHTMLElement(){const t=this.Hf.$f();return t&&0!==t.length&&t[this.paneIndex()]?t[this.paneIndex()].Zf():null}attachPrimitive(t){this.Pt._a(t),t.attached&&t.attached({chart:this.bg,requestUpdate:()=>this.Pt.Qt().Ih()})}detachPrimitive(t){this.Pt.ua(t)}priceScale(t){if(null===this.Pt.Do(t))throw new Error(`Cannot find price scale with id: ${t}`);return new Ju(this.Hf,t,this.paneIndex())}setPreserveEmptyPane(t){this.Pt.zo(t)}preserveEmptyPane(){return this.Pt.Lo()}addCustomSeries(t,e={},i=0){return this.bg.addCustomSeries(t,e,i)}addSeries(t,e={}){return this.bg.addSeries(t,e,this.paneIndex())}}const Zu={color:"#FF0000",price:0,lineStyle:2,lineWidth:1,lineVisible:!0,axisLabelVisible:!0,title:"",axisLabelColor:"",axisLabelTextColor:""};class tp{constructor(t){this.ir=t}applyOptions(t){this.ir.hr(t)}options(){return this.ir.N()}Sg(){return this.ir}}class ep{constructor(t,e,i,s,o,r){this.xg=new Ul,this.Jn=t,this.Cg=e,this.Pg=i,this.o_=o,this.bg=s,this.yg=r}m(){this.xg.m()}priceFormatter(){return this.Jn.ea()}priceToCoordinate(t){const e=this.Jn.zt();return null===e?null:this.Jn.Ft().Nt(t,e.Wt)}coordinateToPrice(t){const e=this.Jn.zt();return null===e?null:this.Jn.Ft().Ts(t,e.Wt)}barsInLogicalRange(t){if(null===t)return null;const e=new od(new ed(t.from,t.to)).y_(),i=this.Jn.Xs();if(i.Ki())return null;const s=i.Fr(e.Uh(),1),o=i.Fr(e.bi(),-1),r=Bl(i.Lr()),n=Bl(i.Ks());if(null!==s&&null!==o&&s.Re>o.Re)return{barsBefore:t.from-r,barsAfter:n-t.to};const a={barsBefore:null===s||s.Re===r?t.from-r:s.Re-r,barsAfter:null===o||o.Re===n?n-t.to:n-o.Re};return null!==s&&null!==o&&(a.from=s.yw,a.to=o.yw),a}setData(t){this.o_,this.Jn.Rr(),this.Cg.kg(this.Jn,t),this.Tg("full")}update(t,e=!1){this.Jn.Rr(),this.Cg.Rg(this.Jn,t,e),this.Tg("update")}pop(t=1){const e=this.Cg.Dg(this.Jn,t);0!==e.length&&this.Tg("update");const i=Uu(this.seriesType());return e.map(t=>i(t))}dataByIndex(t,e){const i=this.Jn.Xs().Fr(t,e);return null===i?null:Uu(this.seriesType())(i)}data(){const t=Uu(this.seriesType());return this.Jn.Xs().Hr().map(e=>t(e))}subscribeDataChanged(t){this.xg.i(t)}unsubscribeDataChanged(t){this.xg._(t)}applyOptions(t){this.Jn.hr(t)}options(){return Kl(this.Jn.N())}priceScale(){return this.Pg.priceScale(this.Jn.Ft().ma(),this.getPane().paneIndex())}createPriceLine(t){const e=Wl(Kl(Zu),t),i=this.Jn.Oh(e);return new tp(i)}removePriceLine(t){this.Jn.Nh(t.Sg())}priceLines(){return this.Jn.Fh().map(t=>new tp(t))}seriesType(){return this.Jn.Rr()}lastValueData(t){const e=this.Jn.ye(t);return e.ke?{noData:!0}:{noData:!1,price:e.gt,color:e.R}}attachPrimitive(t){this.Jn._a(t),t.attached&&t.attached({chart:this.bg,series:this,requestUpdate:()=>this.Jn.Qt().Ih(),horzScaleBehavior:this.o_})}detachPrimitive(t){this.Jn.ua(t),t.detached&&t.detached(),this.Jn.Qt().Ih()}getPane(){const t=this.Jn,e=Bl(this.Jn.Qt().Hn(t));return this.yg(e)}moveToPane(t){this.Jn.Qt().Nc(this.Jn,t)}seriesOrder(){const t=this.Jn.Qt().Hn(this.Jn);return null===t?-1:t.Oo().indexOf(this.Jn)}setSeriesOrder(t){const e=this.Jn.Qt().Hn(this.Jn);null!==e&&e.Qo(this.Jn,t)}Tg(t){this.xg.v()&&this.xg.p(t)}}class ip{constructor(t,e,i){this.Vg=new Ul,this.z_=new Ul,this.gm=new Ul,this.ts=t,this.uh=t.Et(),this.Zm=e,this.uh.Vu().i(this.Bg.bind(this)),this.uh.Bu().i(this.Ig.bind(this)),this.Zm.ym().i(this.Eg.bind(this)),this.o_=i}m(){this.uh.Vu().u(this),this.uh.Bu().u(this),this.Zm.ym().u(this),this.Vg.m(),this.z_.m(),this.gm.m()}scrollPosition(){return this.uh.gu()}scrollToPosition(t,e){e?this.uh.Tu(t,1e3):this.ts.fn(t)}scrollToRealTime(){this.uh.ku()}getVisibleRange(){const t=this.uh.nu();return null===t?null:{from:t.from.originalTime,to:t.to.originalTime}}setVisibleRange(t){const e={from:this.o_.convertHorzItemToInternal(t.from),to:this.o_.convertHorzItemToInternal(t.to)},i=this.uh.au(e);this.ts.Lc(i)}getVisibleLogicalRange(){const t=this.uh.su();return null===t?null:{from:t.Uh(),to:t.bi()}}setVisibleLogicalRange(t){Rl(t.from<=t.to,"The from index cannot be after the to index."),this.ts.Lc(t)}resetTimeScale(){this.ts.cn()}fitContent(){this.ts.Au()}logicalToCoordinate(t){const e=this.ts.Et();return e.Ki()?null:e.qt(t)}coordinateToLogical(t){return this.uh.Ki()?null:this.uh.cu(t)}timeToIndex(t,e){const i=this.o_.convertHorzItemToInternal(t);return this.uh.Q_(i,e)}timeToCoordinate(t){const e=this.timeToIndex(t,!1);return null===e?null:this.uh.qt(e)}coordinateToTime(t){const e=this.ts.Et(),i=e.cu(t),s=e.ss(i);return null===s?null:s.originalTime}width(){return this.Zm.Gf().width}height(){return this.Zm.Gf().height}subscribeVisibleTimeRangeChange(t){this.Vg.i(t)}unsubscribeVisibleTimeRangeChange(t){this.Vg._(t)}subscribeVisibleLogicalRangeChange(t){this.z_.i(t)}unsubscribeVisibleLogicalRangeChange(t){this.z_._(t)}subscribeSizeChange(t){this.gm.i(t)}unsubscribeSizeChange(t){this.gm._(t)}applyOptions(t){this.uh.hr(t)}options(){return{...Kl(this.uh.N()),barSpacing:this.uh.mu()}}Bg(){this.Vg.v()&&this.Vg.p(this.getVisibleRange())}Ig(){this.z_.v()&&this.z_.p(this.getVisibleLogicalRange())}Eg(t){this.gm.p(t.width,t.height)}}function sp(t){return function(t){if(Gl(t.handleScale)){const e=t.handleScale;t.handleScale={axisDoubleClickReset:{time:e,price:e},axisPressedMouseMove:{time:e,price:e},mouseWheel:e,pinch:e}}else if(void 0!==t.handleScale){const{axisPressedMouseMove:e,axisDoubleClickReset:i}=t.handleScale;Gl(e)&&(t.handleScale.axisPressedMouseMove={time:e,price:e}),Gl(i)&&(t.handleScale.axisDoubleClickReset={time:i,price:i})}const e=t.handleScroll;Gl(e)&&(t.handleScroll={horzTouchDrag:e,vertTouchDrag:e,mouseWheel:e,pressedMouseMove:e})}(t),t}class op{constructor(t,e,i){this.Ag=new Map,this.zg=new Map,this.Lg=new Ul,this.Og=new Ul,this.Ng=new Ul,this.qu=new WeakMap,this.Fg=new zu(e);const s=void 0===i?Kl(Qu()):Wl(Kl(Qu()),sp(i));this.Wg=e,this.Hf=new du(t,s,e),this.Hf.Xv().i(t=>{this.Lg.v()&&this.Lg.p(this.Hg(t()))},this),this.Hf.Zv().i(t=>{this.Og.v()&&this.Og.p(this.Hg(t()))},this),this.Hf.cc().i(t=>{this.Ng.v()&&this.Ng.p(this.Hg(t()))},this);const o=this.Hf.Qt();this.Ug=new ip(o,this.Hf.iw(),this.Wg)}remove(){this.Hf.Xv().u(this),this.Hf.Zv().u(this),this.Hf.cc().u(this),this.Ug.m(),this.Hf.m(),this.Ag.clear(),this.zg.clear(),this.Lg.m(),this.Og.m(),this.Ng.m(),this.Fg.m()}resize(t,e,i){this.autoSizeActive()||this.Hf.Jm(t,e,i)}addCustomSeries(t,e={},i=0){const s=(t=>({type:"Custom",isBuiltIn:!1,defaultOptions:{...Du,...t.defaultOptions()},$g:Ou,qg:t}))(Hl(t));return this.Yg(s,e,i)}addSeries(t,e={},i=0){return this.Yg(t,e,i)}removeSeries(t){const e=Nl(this.Ag.get(t)),i=this.Fg.Ac(e);this.Hf.Qt().Ac(e),this.jg(i),this.Ag.delete(t),this.zg.delete(e)}kg(t,e){this.jg(this.Fg.Ww(t,e))}Rg(t,e,i){this.jg(this.Fg.jw(t,e,i))}Dg(t,e){const[i,s]=this.Fg.Zw(t,e);return 0!==i.length&&this.jg(s),i}subscribeClick(t){this.Lg.i(t)}unsubscribeClick(t){this.Lg._(t)}subscribeCrosshairMove(t){this.Ng.i(t)}unsubscribeCrosshairMove(t){this.Ng._(t)}subscribeDblClick(t){this.Og.i(t)}unsubscribeDblClick(t){this.Og._(t)}priceScale(t,e=0){return new Ju(this.Hf,t,e)}timeScale(){return this.Ug}applyOptions(t){this.Hf.hr(sp(t))}options(){return this.Hf.N()}takeScreenshot(t=!1,e=!1){let i,s;try{e||(i=this.Hf.Qt().N().crosshair.mode,this.Hf.hr({crosshair:{mode:2}})),s=this.Hf.aw(t)}finally{e||void 0===i||this.Hf.Qt().hr({crosshair:{mode:i}})}return s}addPane(t=!1){const e=this.Hf.Qt().$c();return e.zo(t),this.Kg(e)}removePane(t){this.Hf.Qt().fc(t)}swapPanes(t,e){this.Hf.Qt().mc(t,e)}autoSizeActive(){return this.Hf.cw()}chartElement(){return this.Hf.ip()}panes(){return this.Hf.Qt().$s().map(t=>this.Kg(t))}paneSize(t=0){const e=this.Hf.pw(t);return{height:e.height,width:e.width}}setCrosshairPosition(t,e,i){const s=this.Ag.get(i);if(void 0===s)return;const o=this.Hf.Qt().Hn(s);null!==o&&this.Hf.Qt().Rc(t,e,o)}clearCrosshairPosition(){this.Hf.Qt().Dc(!0)}horzBehaviour(){return this.Wg}Yg(t,e={},i=0){Rl(void 0!==t.$g),function(t){if(void 0===t||"custom"===t.type)return;const e=t;void 0!==e.minMove&&void 0===e.precision&&(e.precision=pd(e.minMove))}(e.priceFormat),"Candlestick"===t.type&&function(t){void 0!==t.borderColor&&(t.borderUpColor=t.borderColor,t.borderDownColor=t.borderColor),void 0!==t.wickColor&&(t.wickUpColor=t.wickColor,t.wickDownColor=t.wickColor)}(e);const s=Wl(Kl(Dl),Kl(t.defaultOptions),e),o=t.$g,r=new xc(this.Hf.Qt(),t.type,s,o,t.qg);this.Hf.Qt().Ic(r,i);const n=new ep(r,this,this,this,this.Wg,t=>this.Kg(t));return this.Ag.set(n,r),this.zg.set(r,n),n}jg(t){const e=this.Hf.Qt();e.Vc(t.Et._u,t.Et.tg,t.Et.ig),t.Oo.forEach((t,e)=>e.ht(t.se,t.Qw)),e.Et().K_(),e.vu()}Xg(t){return Nl(this.zg.get(t))}Hg(t){const e=new Map;t.Dw.forEach((t,i)=>{const s=i.Rr(),o=Uu(s)(t);if("Custom"!==s)Rl(function(t){return function(t){return void 0!==t.open}(t)||function(t){return void 0!==t.value}(t)}(o));else{const t=i.fa();Rl(!t||!1===t(o))}e.set(this.Xg(i),o)});const i=void 0!==t.Rw&&this.zg.has(t.Rw)?this.Xg(t.Rw):void 0;return{time:t.yw,logical:t.Re,point:t.kw,paneIndex:t.Tw,hoveredSeries:i,hoveredObjectId:t.Vw,seriesData:e,sourceEvent:t.Bw}}Kg(t){let e=this.qu.get(t);return e||(e=new Xu(this.Hf,t=>this.Xg(t),t,this),this.qu.set(t,e)),e}}function rp(t,e,i){const s=function(t){if(jl(t)){const e=document.getElementById(t);return Rl(null!==e,`Cannot find element in DOM with id=${t}`),e}return t}(t),o=new op(s,e,i);return e.setOptions(o.options()),o}class np extends Pu{constructor(t,e){super(t,e,!0)}fg(t,e,i){e.uu(this.rg,Jl(this.hg)),t.Ul(this.rg,i,Jl(this.hg))}Zg(t,e){return{wt:t,gt:e,_t:NaN,ut:NaN}}cg(){const t=this.Jn.Rh();this.rg=this.Jn.Xs().Hr().map(e=>{const i=e.Wt[3];return this.Gg(e.Re,i,t)})}}const ap=6;function lp(t,e){return{_t:t._t-e._t,ut:t.ut-e.ut}}function hp(t,e){return{_t:t._t/e,ut:t.ut/e}}function cp(t,e,i){const s=Math.max(0,e-1),o=Math.min(t.length-1,i+1);var r,n;return[(r=t[e],n=hp(lp(t[i],t[s]),ap),{_t:r._t+n._t,ut:r.ut+n.ut}),lp(t[i],hp(lp(t[o],t[e]),ap))]}function dp(t,e){const i=t.context;i.strokeStyle=e,i.stroke()}class up extends rh{constructor(){super(...arguments),this.rt=null}ht(t){this.rt=t}et(t){if(null===this.rt)return;const{ot:e,lt:i,Jg:s,Qg:o,ct:r,Xt:n,tM:a}=this.rt;if(null===i)return;const l=t.context;l.lineCap="butt",l.lineWidth=r*t.verticalPixelRatio,Vl(l,n),l.lineJoin="round";const h=this.iM.bind(this);void 0!==o&&function(t,e,i,s,o,r,n){if(0===e.length||s.from>=e.length||s.to<=0)return;const{context:a,horizontalPixelRatio:l,verticalPixelRatio:h}=t,c=e[s.from];let d=r(t,c),u=c;if(s.to-s.from<2){const e=o/2;a.beginPath();const i={_t:c._t-e,ut:c.ut},s={_t:c._t+e,ut:c.ut};a.moveTo(i._t*l,i.ut*h),a.lineTo(s._t*l,s.ut*h),n(t,d,i,s)}else{const o=(e,i)=>{n(t,d,u,i),a.beginPath(),d=e,u=i};let p=u;a.beginPath(),a.moveTo(c._t*l,c.ut*h);for(let n=s.from+1;n<s.to;++n){p=e[n];const s=r(t,p);switch(i){case 0:a.lineTo(p._t*l,p.ut*h);break;case 1:a.lineTo(p._t*l,e[n-1].ut*h),s!==d&&(o(s,p),a.lineTo(p._t*l,e[n-1].ut*h)),a.lineTo(p._t*l,p.ut*h);break;case 2:{const[t,i]=cp(e,n-1,n);a.bezierCurveTo(t._t*l,t.ut*h,i._t*l,i.ut*h,p._t*l,p.ut*h);break}}1!==i&&s!==d&&(o(s,p),a.moveTo(p._t*l,p.ut*h))}(u!==p||u===p&&1===i)&&n(t,d,u,p)}}(t,e,o,i,s,h,dp),a&&function(t,e,i,s,o){if(s.to-s.from<=0)return;const{horizontalPixelRatio:r,verticalPixelRatio:n,context:a}=t;let l=null;const h=Math.max(1,Math.floor(r))%2/2,c=i*n+h;for(let i=s.to-1;i>=s.from;--i){const s=e[i];if(s){const e=o(t,s);e!==l&&(a.beginPath(),null!==l&&a.fill(),a.fillStyle=e,l=e);const i=Math.round(s._t*r)+h,d=s.ut*n;a.moveTo(i,d),a.arc(i,d,c,0,2*Math.PI)}}a.fill()}(t,e,a,i,h)}}class pp extends up{iM(t,e){return e.vt}}class fp extends np{constructor(){super(...arguments),this.og=new pp}Gg(t,e,i){return{...this.Zg(t,e),...i.Dr(t)}}pg(){const t=this.Jn.N(),e={ot:this.rg,Xt:t.lineStyle,Qg:t.lineVisible?t.lineType:void 0,ct:t.lineWidth,tM:t.pointMarkersVisible?t.pointMarkersRadius||t.lineWidth/2+2:void 0,lt:this.hg,Jg:this.Qn.Et().mu()};this.og.ht(e)}}const mp={type:"Line",isBuiltIn:!0,defaultOptions:{color:"#2196f3",lineStyle:0,lineWidth:3,lineType:0,lineVisible:!0,crosshairMarkerVisible:!0,crosshairMarkerRadius:4,crosshairMarkerBorderColor:"",crosshairMarkerBorderWidth:2,crosshairMarkerBackgroundColor:"",lastPriceAnimation:0,pointMarkersVisible:!1},$g:(t,e)=>new fp(t,e)};function gp(){const t=zl("div.gs-header"),e=zl("div.gs-panel",zl("div.gs-section-title",zl("sl-icon",{name:"graph-up-arrow"}),"Global Stats"),zl("div.gs-stats",zl("div.gs-stat",zl("div.value",{"data-field":"holders"},"—"),zl("div.label","Total Unique Holders")),zl("div.gs-stat",zl("div.value",{"data-field":"floor"},"—"),zl("div.label","Floor Price (ETH)")))),i=zl("div.gs-panel",zl("div.gs-section-title",zl("sl-icon",{name:"activity"}),"Trend"),zl("sl-tab-group",{activation:"manual",style:"margin-bottom:8px;"},zl("sl-tab",{slot:"nav",panel:"holders",active:!0},"Holders"),zl("sl-tab",{slot:"nav",panel:"floor"},"Floor Price"),zl("sl-tab-panel",{name:"holders",active:!0}),zl("sl-tab-panel",{name:"floor"})),zl("div.gs-chart-wrap"),zl("div.gs-sub",'Plots the "stats" array as a time series.')),s=(zl("div.gs-panel",zl("div.gs-section-title",zl("sl-icon",{name:"info"}),"About The Gods"),zl("div",{class:"gs-about"},"Explore the trend of unique holders and the floor price for The Gods NFT collection.")),zl("div.gs-grid",e,i)),o=zl("section.gods-stats-dash",t,s),r=i.querySelector(".gs-chart-wrap"),n=i.querySelector("sl-tab-group");let a=null,l=null,h="numOwners",c=[];function d(){const t=document.documentElement;return t.classList.contains("sl-theme-dark")||t.classList.contains("dark")||window.matchMedia?.("(prefers-color-scheme: dark)").matches}function u(t,e){a||(a=function(t,e){return rp(t,new Md,Md.ld(e))}(r,{autoSize:!0,height:360,layout:{background:{color:d()?"rgba(20,23,29,1)":"rgba(250,250,250,1)"},textColor:d()?"rgba(230,230,230,0.65)":"rgba(60,60,60,0.75)"},grid:{vertLines:{color:d()?"rgba(230,230,230,0.08)":"rgba(0,0,0,0.06)"},horzLines:{color:d()?"rgba(230,230,230,0.08)":"rgba(0,0,0,0.06)"}},timeScale:{timeVisible:!0,secondsVisible:!1}}),l=a.addSeries(mp,{color:"#7C3AED"})),h=t;const i=e.map(e=>({time:Math.floor(new Date(e.time).getTime()/1e3),value:"numOwners"===t?e.num_owners:e.floor_price}));l.setData(i),a.timeScale().fitContent()}return(async()=>{try{const{stats:t,current:i}=await async function(){const t=await fetch("https://api.gaia.cc/gods-stats",{method:"GET",headers:{"Content-Type":"application/json"}});if(!t.ok)throw new Error("Failed to fetch /gods-stats");return t.json()}(),s=e.querySelector('[data-field="holders"]'),o=e.querySelector('[data-field="floor"]');s.textContent=null!=i?.num_owners?String(i.num_owners):"—",o.textContent=null!=i?.floor_price?String(i.floor_price):"—",c=t??[],u("numOwners",c),n.addEventListener("sl-tab-show",t=>{const e=t.detail.name;"holders"===e&&"numOwners"!==h&&u("numOwners",c),"floor"===e&&"floorPrice"!==h&&u("floorPrice",c)})}catch(t){o.append(zl("sl-alert",{variant:"danger",open:!0},"Failed to load The Gods stats."))}})(),o}const bp=document.getElementById("dashboard-container");bp&&bp.appendChild(function(){zl("div.header",zl("sl-icon",{name:"activity"}),zl("h2",{style:"margin:0;"},"Gaia Protocol Dashboard")),zl("sl-card",{class:"overview"},zl("div.section-title",zl("sl-icon",{name:"info"}),"Overview"),zl("div.body","A quick view of key metrics and collection status across Gaia Protocol."));const t=zl("div.gods-section-header",zl("sl-icon",{name:"person-square"}),zl("h3","The Gods (NFT)")),e=zl("sl-card",{class:"gods"},t,gp()),i=zl("div.grid",e);return zl("main.gaia-dashboard",zl("div.container",i))}())})();